...
(function() {
    ...
    function Za(f, t, l) {
        "millisecond" === l ? f.setMilliseconds(f.getMilliseconds() + 1 * t) : "second" === l ? f.setSeconds(f.getSeconds() + 1 * t) : "minute" === l ? f.setMinutes(f.getMinutes() + 1 * t) : "hour" === l ? f.setHours(f.getHours() + 1 * t) : "day" === l ? f.setDate(f.getDate() + 1 * t) : "week" === l ? f.setDate(f.getDate() + 7 * t) : "month" === l ? f.setMonth(f.getMonth() + 1 * t) : "year" === l && f.setFullYear(f.getFullYear() + 1 * t);
        return f
    }
    ...
    function gb(f) {
        if (ua.fSDec) f[X("`eeDwdouMhrudods")](X("e`u`@ohl`uhnoHuds`uhnoDoe"), function() {
            ua._fTWm && ua._fTWm(f)
        })
    }
    ...
    function G(f, t, xa, r, T) {
        ...
        r.push([f, t, xa, T]);
        return f.addEventListener ? (f.addEventListener(t, xa, T), xa) : f.attachEvent ? (r = function(t) {
            t = t || window.event;
            ...
            xa.call(f, t)
        }, f.attachEvent("on" + t, r), r) : !1
    }

    function ib(f) {
        if (f._menuButton) f.exportEnabled ? (J(f._menuButton, {
            backgroundColor: f.toolbar.itemBackgroundColor,
            color: f.toolbar.fontColor
        }), Ma(f._menuButton), sa(f, f._menuButton, "menu"), 0 >= navigator.userAgent.search("MSIE") && f._menuButton.childNodes[0] && J(f._menuButton.childNodes[0], {
            ...
            G(f._menuButton, "touchstart", function(f) {
                t = !0
            }, f.allDOMEventHandlers);
            G(f._menuButton, "click", function() {
                "none" !== f._dropdownMenu.style.display || f._dropDownCloseTime && 500 >= (new Date).getTime() - f._dropDownCloseTime.getTime() || (f._dropdownMenu.style.display = "block", f._menuButton.blur(), f._dropdownMenu.focus())
            }, f.allDOMEventHandlers, !0);
            G(f._menuButton, "mousemove", function() {
                t || (J(f._menuButton, {
                    backgroundColor: f.toolbar.itemBackgroundColorOnHover,
                    color: f.toolbar.fontColorOnHover
                }), 0 >= navigator.userAgent.search("MSIE") && J(f._menuButton.childNodes[0], {
                    WebkitFilter: "invert(100%)",
                    filter: "invert(100%)"
                }))
            }, f.allDOMEventHandlers, !0);
            G(f._menuButton, "mouseout", function() {
                t || (J(f._menuButton, {
                    backgroundColor: f.toolbar.itemBackgroundColor,
                    color: f.toolbar.fontColor
                }), 0 >= navigator.userAgent.search("MSIE") && J(f._menuButton.childNodes[0], {
        ...
        if (f.exportEnabled && f._dropdownMenu) {
            ...
            for (var l = f._dropdownMenu.childNodes, M = [f._cultureInfo.printText, f._cultureInfo.saveJPGText, f._cultureInfo.savePNGText], T = 0; T < M.length; T++) J(l[T], {
                backgroundColor: f.toolbar.itemBackgroundColor,
                color: f.toolbar.fontColor
            }), l[T].innerHTML = M[T]
        } else !f._dropdownMenu && (f.exportEnabled && r) && (t = !1, f._dropdownMenu = document.createElement("div"), f._dropdownMenu.setAttribute("tabindex", -1), l = f.theme && -1 !== f.theme.indexOf("dark") ? "black" : "#888888", J(f._dropdownMenu, {
            position: "absolute",
            zIndex: 1,
            userSelect: "none",
            MozUserSeelct: "none",
            ...
            backgroundColor: f.toolbar.itemBackgroundColor,
            boxShadow: "2px 2px 10px " + l
        }), f._dropdownMenu.style.display = "none", f._toolBar.appendChild(f._dropdownMenu), G(f._dropdownMenu, "blur", function() {
            va(f._dropdownMenu);
            f._dropDownCloseTime = new Date
        }, f.allDOMEventHandlers, !0), l = document.createElement("div"), J(l, {
            padding: "12px 8px 12px 8px"
        }), l.innerHTML = f._cultureInfo.printText, l.style.backgroundColor = f.toolbar.itemBackgroundColor, l.style.color = f.toolbar.fontColor, f._dropdownMenu.appendChild(l), G(l, "touchstart", function(f) {
            t = !0
        }, f.allDOMEventHandlers), G(l, "mousemove", function() {
            t || (this.style.backgroundColor = f.toolbar.itemBackgroundColorOnHover, this.style.color = f.toolbar.fontColorOnHover)
        }, f.allDOMEventHandlers, !0), G(l, "mouseout", function() {
            t || (this.style.backgroundColor = f.toolbar.itemBackgroundColor, this.style.color = f.toolbar.fontColor)
        }, f.allDOMEventHandlers, !0), G(l, "click", function() {
            f.print();
            va(f._dropdownMenu)
        }, f.allDOMEventHandlers, !0), l = document.createElement("div"), J(l, {
            padding: "12px 8px 12px 8px"
        }), l.innerHTML = f._cultureInfo.saveJPGText, l.style.backgroundColor = f.toolbar.itemBackgroundColor, l.style.color = f.toolbar.fontColor, f._dropdownMenu.appendChild(l), G(l, "touchstart", function(f) {
            t = !0
        }, f.allDOMEventHandlers), G(l, "mousemove", function() {
            t || (this.style.backgroundColor = f.toolbar.itemBackgroundColorOnHover, this.style.color = f.toolbar.fontColorOnHover)
        }, f.allDOMEventHandlers, !0), G(l, "mouseout", function() {
            ...
            padding: "12px 8px 12px 8px"
        }), l.innerHTML = f._cultureInfo.savePNGText, l.style.backgroundColor = f.toolbar.itemBackgroundColor, l.style.color = f.toolbar.fontColor, f._dropdownMenu.appendChild(l), G(l, "touchstart", function(f) {
            t = !0
        }, f.allDOMEventHandlers), G(l, "mousemove", function() {
            t || (this.style.backgroundColor = f.toolbar.itemBackgroundColorOnHover, this.style.color = f.toolbar.fontColorOnHover)
        }, f.allDOMEventHandlers, !0), G(l, "mouseout", function() {
    ...
    function Na(f, t, xa, M) {
        r && cb ? (M = !l(M) && M ? f.getContext("2d", {
            willReadFrequently: !0
        }) : f.getContext("2d"), Oa = M.webkitBackingStorePixelRatio || M.mozBackingStorePixelRatio || M.msBackingStorePixelRatio || M.oBackingStorePixelRatio || M.backingStorePixelRatio || 1, ia = Ta / Oa, f.width = t * ia, f.height = xa * ia, Ta !== Oa && (f.style.width = t + "px", f.style.height = xa + "px", M.scale(ia, ia))) : (f.width = t, f.height = xa)
    }
    ...
    function jb(f) {
        if (!kb) {
            ...
            if (f.creditHref && f.creditText) {
                f._creditLink || (f._creditLink = document.createElement("a"), f._creditLink.setAttribute("class", "canvasjs-chart-credit"), f._creditLink.setAttribute("title", "JavaScript Charts"), J(f._creditLink, {
                    outline: "none",
                    margin: "0px",
                    position: "absolute",
                    right: "2px",
                ...
                if (0 === f.renderCount || t || l) f._creditLink.setAttribute("href", f.creditHref), f._creditLink.innerHTML = f.creditText;
    ...
    function sa(f, t, l) {
        t.getAttribute("state") || (t.style.backgroundColor = f.toolbar.itemBackgroundColor, t.style.color = f.toolbar.fontColor, t.style.border = "none", J(t, {
            WebkitUserSelect: "none",
            MozUserSelect: "none",
            msUserSelect: "none",
            userSelect: "none"
        }));
        t.getAttribute("state") !== l && (t.setAttribute("state", l), t.setAttribute("type", "button"), J(t, {
            padding: "5px 12px",
            cursor: "pointer",
            "float": "left",
            width: "40px",
            ...
            lineHeight: "0"
        }), t.innerHTML = "<img src='" + lb[l].image + "' alt='" + f._cultureInfo[l + "Text"] + "' />", J(t.childNodes[0], {
            height: "95%",
            pointerEvents: "none"
        }));
    ...
    function Y(f, t, r, M, T) {
        ...
        f = {};
        this.theme && l(this.parent) && l(t) && l(M) ? f = l(this.predefinedThemes[this.theme]) ? this.predefinedThemes.light1 : this.predefinedThemes[this.theme] : this.parent && (this.parent.themeOptions && this.parent.themeOptions[t]) && (null === M ? f = this.parent.themeOptions[t] : 0 < this.parent.themeOptions[t].length && (M = Math.min(this.parent.themeOptions[t].length - 1, M), f = this.parent.themeOptions[t][M]));
        this.themeOptions = f;
        this.options = r ? r : {
            _isPlaceholder: !0
        };
    ...
    function Aa(f, t) {
        ...
        if (l(this.options.margin) && f.options.subtitles)
            for (var r = f.options.subtitles, M = 0; M < r.length; M++)
                if ((l(r[M].horizontalAlign) && "center" === this.horizontalAlign || r[M].horizontalAlign === this.horizontalAlign) && (l(r[M].verticalAlign) && "top" === this.verticalAlign || r[M].verticalAlign === this.verticalAlign) && !r[M].dockInsidePlotArea === !this.dockInsidePlotArea) {
                    this.margin = 0;
                    break
                }
    ...
    var hb = function() {
        ...
        ha = function(f, l, r) {
            ...
            for (var R = 0; z && R < z.length; R++)
                if (l = z[R], "." === l && 0 > I) I = R;
                    ...
                    0 > I ? (N.push(l), "#" === l || "0" === l ? U++ : "," === l && G++) : (Q.push(l), "#" !== l && "0" !== l || J++)
                } S && (l = Math.floor(f), z = -Math.floor(Math.log(f) / Math.LN10 + 1), Y = 0 === f ? 0 : 0 === l ? -(U + z) : ob(l).length - U, A /= Math.pow(10, Y));
            0 > I && (I = R);
            A = (f * A).toFixed(J);
            l = A.split(".");
            A = (l[0] + "").split("");
            f = (l[1] + "").split("");
            A && "0" === A[0] && A.shift();
            for (S = z = R = J = I = 0; 0 < N.length;)
                if (l = N.pop(), "#" === l || "0" === l)
                    if (I++, I === U) {
                        var aa = A,
                            A = [];
                        if ("0" === l)
                            for (l = U - J - (aa ? aa.length : 0); 0 < l;) aa.unshift("0"), l--;
                        for (; 0 < aa.length;) r = aa.pop() + r, S++, 0 === S % z && (R === G && 0 < aa.length) && (r = w + r)
                    } else 0 < A.length ? (r = A.pop() + r, J++, S++) : "0" === l && (r = "0" + r, J++, S++), 0 === S % z && (R === G && 0 < A.length) && (r = w + r);
            else "E" !== l[0] && "e" !== l[0] || "0" !== l[l.length - 1] || !/[eE][+-]*[0]+/.test(l) ? "," === l ? (R++, z = S, S = 0, 0 < A.length && (r = w + r)) : r = 1 < l.length && ('"' === l[0] && '"' === l[l.length - 1] || "'" === l[0] && "'" === l[l.length - 1]) ? l.slice(1, l.length - 1) + r : l + r : (l = 0 > Y ? l.replace("+", "").replace("-", "") : l.replace("-", ""), r += l.replace(/[0]+/, function(a) {
                return $(Y, a.length)
            }));
            w = "";
            for (N = !1; 0 < Q.length;) l = Q.shift(), "#" === l || "0" === l ? 0 < f.length && 0 !== Number(f.join("")) ? (w += f.shift(), N = !0) : "0" === l && (w += "0", N = !0) : 1 < l.length && ('"' === l[0] && '"' === l[l.length - 1] || "'" === l[0] && "'" === l[l.length - 1]) ? w += l.slice(1, l.length - 1) : "E" !== l[0] && "e" !== l[0] || "0" !== l[l.length - 1] || !/[eE][+-]*[0]+/.test(l) ? w += l : (l = 0 > Y ? l.replace("+", "").replace("-", "") : l.replace("-", ""), w += l.replace(/[0]+/, function(a) {
                return $(Y, a.length)
            }));
            r += (N ? T : "") + w;
            return M ? "-" + r : r
        ...
        Oa = 1,
        ia = cb ? Ta / Oa : 1,
        da = function(f, l, r, M, w, z, A, I, S, N, U, Q, J) {
            ...
            f.restore();
            !0 === S && (f.save(), f.beginPath(), f.moveTo(l, r), f.lineTo(l + G, r + G), f.lineTo(M - G, r + G), f.lineTo(M, r), f.closePath(), A = f.createLinearGradient((M + l) / 2, r + G, (M + l) / 2, r), A.addColorStop(0, z), A.addColorStop(1, "rgba(255, 255, 255, .4)"), f.fillStyle = A, f.fill(), f.restore());
            !0 === N && (f.save(), f.beginPath(), f.moveTo(l, w), f.lineTo(l + G, w - G), f.lineTo(M - G, w - G), f.lineTo(M, w), f.closePath(), A = f.createLinearGradient((M + l) / 2, w - G, (M + l) / 2, w), A.addColorStop(0, z), A.addColorStop(1, "rgba(255, 255, 255, .4)"), f.fillStyle = A, f.fill(), f.restore());
            !0 === U && (f.save(), f.beginPath(), f.moveTo(l, r), f.lineTo(l + G, r + G), f.lineTo(l + G, w - G), f.lineTo(l, w), f.closePath(), A = f.createLinearGradient(l + G, (w + r) / 2, l, (w + r) / 2), A.addColorStop(0, z), A.addColorStop(1, "rgba(255, 255, 255, 0.1)"), f.fillStyle = A, f.fill(), f.restore());
            !0 === Q && (f.save(), f.beginPath(), f.moveTo(M, r), f.lineTo(M - G, r + G), f.lineTo(M - G, w - G), f.lineTo(M, w), A = f.createLinearGradient(M - G, (w + r) / 2, M, (w + r) / 2), A.addColorStop(0, z), A.addColorStop(1, "rgba(255, 255, 255, 0.1)"), f.fillStyle = A, A.addColorStop(0, z), A.addColorStop(1, "rgba(255, 255, 255, 0.1)"), f.fillStyle = A, f.fill(), f.closePath(), f.restore())
        },
        X = function(f) {
            for (var l = "", r = 0; r < f.length; r++) l += String.fromCharCode(Math.ceil(f.length / 57 / 5) ^ f.charCodeAt(r));
            return l
        },
        kb = window && (window[X("mnb`uhno")] && window[X("mnb`uhno")].href && window[X("mnb`uhno")].href.indexOf && (-1 !== window[X("mnb`uhno")].href.indexOf(X("b`ow`rkr/bnl")) || -1 !== window[X("mnb`uhno")].href.indexOf(X("gdonqhy/bnl")) || -1 !== window[X("mnb`uhno")].href.indexOf(X("gheemd")))) && -1 === window[X("mnb`uhno")].href.indexOf(X("gheemd")),
        lb = {
            reset: {
    ...
    Y.prototype.set = function(f, l, r) {
        ...
        if ("options" === f) this.createUserOptions(l);
            ...
            window.console && (w.publicProperties && w.publicProperties.hasOwnProperty(f) && "readOnly" === w.publicProperties[f] ? window.console.log('Property "' + f + '" is read-only.') : window.console.log('Property "' + f + "\" doesn't exist. Please check for typo."));
            return
        }
    ...
    Y.prototype.createUserOptions = function(f) {
        if ("undefined" !== typeof f || this.options._isPlaceholder)
            if (this.parent && this.parent.options._isPlaceholder && this.parent.createUserOptions(), this.isOptionsInArray) {
                ...
                l[r] = this.options
            } else this.options = "undefined" === typeof f ? {} : f, this.parent && (f = this.parent.options, this.optionsName ? l = this.optionsName : (l = this._defaultsKey) && 0 !== l.length ? (r = l.charAt(0).toLowerCase(), 1 < l.length && (r = r.concat(l.slice(1))), l = r) : l = void 0, f[l] = this.options)
    };
    ...
    Y.prototype.updateOption = function(f) {
        ...
        var r = pa[this._defaultsKey],
            ...
            I = this._index;
        this.theme && l(this.parent) && l(T) && l(I) ? w = l(this.predefinedThemes[this.theme]) ? this.predefinedThemes.light1 : this.predefinedThemes[this.theme] : this.parent && this.parent.themeOptions && (this.options.theme ? "Chart" === this._defaultsKey && Pa[this.options.theme] ? w = Pa[this.options.theme] : stockThemes[this.options.theme] && (w = stockThemes[this.options.theme][T]) : this.parent.themeOptions[T] && (null === I ? w = this.parent.themeOptions[T] : 0 < this.parent.themeOptions[T].length && (w = Math.min(this.parent.themeOptions[T].length - 1, I), w = this.parent.themeOptions[T][w])));
        this.themeOptions = w;
    ...
    Y.prototype.addEventListener = function(f, l, r) {
        f && l && (this._eventListeners[f] = this._eventListeners[f] || [], this._eventListeners[f].push({
            context: r || this,
            eventHandler: l
        }))
    };
    ...
    ka.prototype.render = function(l) {
        if (0 !== this.fontSize) {
            ...
            for (w = 0; w < this._wrappedText.lines.length; w++) I = this._wrappedText.lines[w], "right" === this.textAlign ? z = this.width - I.width - this.rightPadding : "left" === this.textAlign ? z = this.leftPadding : "center" === this.textAlign && (z = (this.width - (this.leftPadding + this.rightPadding)) / 2 - I.width / 2 + this.leftPadding), this.ctx.fillText(I.text, z, T), T += I.height;
            this.ctx.font = r;
            l && this.ctx.restore()
        }
    };
    ...
    Aa.prototype.setLayout = function() {
        if (this.text) {
            ...
            f.layoutManager.registerSpace(S, {
                width: this.width + ("left" === S || "right" === S ? this.margin + 2 : 0),
                height: this.height + ("top" === S || "bottom" === S ? this.margin + 2 : 0)
            });
            this.bounds = {
                x1: w,
                y1: z,
    ...
    w = Ra.Chart = function() {
        ...
        function t(a, d, c) {
            ...
            (this.container = "string" === typeof this._containerId ? document.getElementById(this._containerId) : this._containerId) ? (this.container.innerHTML = "", d = a = 0, a = this.options.width ? this.width : 0 < this.container.clientWidth ? this.container.clientWidth : this.width, d = c && c.height ? c.height : this.options.height ? this.height : 0 < this.container.clientHeight ? this.container.clientHeight : this.height, this.width = a, this.height = d, this.x1 = this.y1 = 0, this.x2 = this.width, this.y2 = this.height, this.selectedColorSet = "undefined" !== typeof Ba[this.colorSet] ? Ba[this.colorSet] : Ba.colorSet1, this._canvasJSContainer = document.createElement("div"), this._canvasJSContainer.setAttribute("class", "canvasjs-chart-container"), this._canvasJSContainer.style.position = "relative", this._canvasJSContainer.style.textAlign = "left", this._canvasJSContainer.style.cursor = "auto", this._canvasJSContainer.style.direction = "ltr", r || (this._canvasJSContainer.style.height = "0px"), this.container.appendChild(this._canvasJSContainer), this.canvas = ta(a, d), this._preRenderCanvas = ta(a, d), this.canvas.style.position = "absolute", this.canvas.style.WebkitUserSelect = "none", this.canvas.style.MozUserSelect = "none", this.canvas.style.msUserSelect = "none", this.canvas.style.userSelect = "none", this.canvas.getContext && (this._canvasJSContainer.appendChild(this.canvas), this.ctx = this.canvas.getContext("2d"), this.ctx.textBaseline = "top", za(this.ctx), this._preRenderCtx = this._preRenderCanvas.getContext("2d"), this._preRenderCtx.textBaseline = "top", za(this._preRenderCtx), r ? this.plotArea.ctx = this.ctx : (this.plotArea.canvas = ta(a, d), this.plotArea.canvas.style.position = "absolute", this.plotArea.canvas.setAttribute("class", "plotAreaCanvas"), this._canvasJSContainer.appendChild(this.plotArea.canvas), this.plotArea.ctx = this.plotArea.canvas.getContext("2d")), this.overlaidCanvas = ta(a, d), this.overlaidCanvas.style.position = "absolute", this.overlaidCanvas.style.webkitTapHighlightColor = "transparent", this.overlaidCanvas.style.WebkitUserSelect = "none", this.overlaidCanvas.style.MozUserSelect = "none", this.overlaidCanvas.style.msUserSelect = "none", this.overlaidCanvas.style.userSelect = "none", this.overlaidCanvas.getContext && (this._canvasJSContainer.appendChild(this.overlaidCanvas), this.overlaidCanvasCtx = this.overlaidCanvas.getContext("2d"), this.overlaidCanvasCtx.textBaseline = "top", za(this.overlaidCanvasCtx)), this._eventManager = new ga(this), this.windowResizeHandler = G(window, "resize", function() {
                ...
                b._mouseEventHandler(a)
            }, this.allDOMEventHandlers), G(this.overlaidCanvas, "mouseup", function(a) {
                b._mouseEventHandler(a)
            ...
            }, this.allDOMEventHandlers), G(this.overlaidCanvas, window.navigator.msPointerEnabled ? "MSPointerMove" : "touchmove", function(a) {
                b._touchEventHandler(a)
        ...
        function z(a, d, c, b, e, h, q, u, E, k) {
            ...
            a.beginPath();
            E && 0 < u.thickness ? (a.moveTo(b - q.thickness / 2, Math.round((c + e) / 2) - n), a.lineTo(d + q.thickness / 2, Math.round((c + e) / 2) - n)) : 0 < u.thickness && (a.moveTo(Math.round((d + b) / 2) - n, c + q.thickness / 2), a.lineTo(Math.round((d + b) / 2) - n, e - q.thickness / 2));
            a.stroke();
        ...
        t.prototype._updateOptions = function() {
            ...
            if (this.stockChart && this.stockChart.options && this.stockChart.options.toolbar && !this.options.toolbar)
                for (var d in this.stockChart.options.toolbar) this.toolbar[d] = this.stockChart.options.toolbar[d];
                    ...
                    if (!this.data[d].axisYType || "primary" === this.data[d].axisYType)
                        if (this.options.axisY && 0 < this.options.axisY.length) {
                            if (!this.axisY.length)
                                for (var c = 0; c < this.options.axisY.length; c++) "normal" === this.plotInfo.axisPlacement ? this._axes.push(this.axisY[c] = new A(this, "axisY", this.options.axisY[c], c, "axisY", "left")) : "xySwapped" === this.plotInfo.axisPlacement && this._axes.push(this.axisY[c] = new A(this, "axisY", this.options.axisY[c], c, "axisY", "bottom"));
                    ...
                    if ("secondary" === this.data[d].axisYType)
                        if (this.options.axisY2 && 0 < this.options.axisY2.length) {
                            if (!this.axisY2.length)
                                for (c = 0; c < this.options.axisY2.length; c++) "normal" === this.plotInfo.axisPlacement ? this._axes.push(this.axisY2[c] = new A(this, "axisY2", this.options.axisY2[c], c, "axisY", "right")) : "xySwapped" === this.plotInfo.axisPlacement && this._axes.push(this.axisY2[c] = new A(this, "axisY2", this.options.axisY2[c], c, "axisY", "top"));
                    ...
                    if (!this.data[d].axisXType || "primary" === this.data[d].axisXType)
                        if (this.options.axisX && 0 < this.options.axisX.length) {
                            if (!this.axisX.length)
                                for (c = 0; c < this.options.axisX.length; c++) "normal" === this.plotInfo.axisPlacement ? this._axes.push(this.axisX[c] = new A(this, "axisX", this.options.axisX[c], c, "axisX", "bottom")) : "xySwapped" === this.plotInfo.axisPlacement && this._axes.push(this.axisX[c] = new A(this, "axisX", this.options.axisX[c], c, "axisX", "left"));
                    ...
                    if ("secondary" === this.data[d].axisXType)
                        if (this.options.axisX2 && 0 < this.options.axisX2.length) {
                            if (!this.axisX2.length)
                                for (c = 0; c < this.options.axisX2.length; c++) "normal" === this.plotInfo.axisPlacement ? this._axes.push(this.axisX2[c] = new A(this, "axisX2", this.options.axisX2[c], c, "axisX", "top")) : "xySwapped" === this.plotInfo.axisPlacement && this._axes.push(this.axisX2[c] = new A(this, "axisX2", this.options.axisX2[c], c, "axisX", "right"));
        ...
        t.prototype.renderElements = function() {
            if (this.height && this.width) {
                ...
                if (0 < c.length) m.disableToolTip = !0, m._animator.animate(200, m.animationDuration, function(a) {
                    ...
                    for (var e = 0; e < c.length; e++) E = c[e], 1 > a && "undefined" !== typeof E.startTimePercent ? a >= E.startTimePercent && E.animationCallback(E.easingFunction(a - E.startTimePercent, 0, 1, 1 - E.startTimePercent), E) : E.animationCallback(E.easingFunction(a, 0, 1, 1), E);
        ...
        t.prototype.categoriseDataSeries = function() {
            for (var a = "", d = 0; d < this.data.length; d++)
                ...
                for (c = this.plotInfo.plotTypes[d], q = a = 0; q < c.plotUnits.length; q++) c.plotUnits[q].previousDataSeriesCount = a, a += c.plotUnits[q].dataSeriesIndexes.length
        };
                ...
                for (var d = a.axisY.dataInfo, c = a.axisX.dataInfo, b, e, h = !1, q = 0; q < a.dataSeriesIndexes.length; q++) {
                    ...
                    for (E = 0; E < u.dataPoints.length; E++) {
                        ...
                        if (0 < E) {
                            ...
                            null !== e && null !== u.dataPoints[E - 1].y && (a.axisY.logarithmic ? (l = e / u.dataPoints[E - 1].y, 1 > l && (l = 1 / l), d.minDiff > l && 1 !== l && (d.minDiff = l)) : (l = e - u.dataPoints[E - 1].y, 0 > l && (l *= -1), d.minDiff > l && 0 !== l && (d.minDiff = l)))
                        }
                        if (b < p && !k) null !== e && (n = b);
                        else {
                            if (!k && (k = !0, 0 < E)) {
            ...
            if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) {
                for (var d = a.axisY.dataInfo, c = a.axisX.dataInfo, b, e, h = !1, q = [], u = [], E = Infinity, k = -Infinity, m = {}, n = 0; n < a.dataSeriesIndexes.length; n++) {
                    var p = this.data[a.dataSeriesIndexes[n]],
                        ...
                        f = !1,
                        y;
                    if ("normal" === p.axisPlacement || "xySwapped" === p.axisPlacement) var s = a.axisX.sessionVariables.newViewportMinimum ? a.axisX.sessionVariables.newViewportMinimum : a.axisX.options && a.axisX.options.viewportMinimum ? a.axisX.options.viewportMinimum : a.axisX.options && a.axisX.options.minimum ? a.axisX.options.minimum : -Infinity,
                    ...
                    for (g = 0; g < p.dataPoints.length; g++) {
                        ...
                        if (0 < g) {
                            ...
                            null !== e && null !== p.dataPoints[g - 1].y && (a.axisY.logarithmic ? 0 < e && (v = e / p.dataPoints[g - 1].y, 1 > v && (v = 1 / v), d.minDiff > v && 1 !== v && (d.minDiff = v)) : (v = e - p.dataPoints[g - 1].y, 0 > v && (v *= -1), d.minDiff > v && 0 !== v && (d.minDiff = v)))
                        }
                        if (b < s && !D) null !== p.dataPoints[g].y && (y = b);
                            ...
                            b < c.viewPortMin && (c.viewPortMin = b);
                            b > c.viewPortMax && (c.viewPortMax = b);
                            null === p.dataPoints[g].y ? c.viewPortMin === b && y < b && (c.viewPortMin = y) : (m[b] = (m[b] || 0) + p.dataPoints[g].y, p.dataPointEOs[g].cumulativeY = m[b], a.yTotals[b] = (a.yTotals[b] ? a.yTotals[b] : 0) + e, a.yAbsTotals[b] = (a.yAbsTotals[b] ? a.yAbsTotals[b] : 0) + Math.abs(e), 0 <= e ? q[b] ? q[b] += e : (q[b] = e, E = Math.min(e, E)) : u[b] ? u[b] += e : (u[b] = e, k = Math.max(e, k)))
                        }
                    }
                    a.axisY.scaleBreaks && (a.axisY.scaleBreaks.autoCalculate && 1 <= a.axisY.scaleBreaks.maxNumberOfAutoBreaks) && (d.dataPointYPositiveSums ? (d.dataPointYPositiveSums.push.apply(d.dataPointYPositiveSums, q), d.dataPointYNegativeSums.push.apply(d.dataPointYPositiveSums, u)) : (d.dataPointYPositiveSums = q, d.dataPointYNegativeSums = u));
                    p.axisX.valueType = p.xValueType = h ? "dateTime" : "number"
                }
                for (g in q) q.hasOwnProperty(g) && !isNaN(g) && (a = q[g], a < d.min && (d.min = Math.min(a, E)), a > d.max && (d.max = a), g < c.viewPortMin || g > c.viewPortMax || (a < d.viewPortMin && (d.viewPortMin = Math.min(a, E)), a > d.viewPortMax && (d.viewPortMax = a)));
                for (g in u) u.hasOwnProperty(g) && !isNaN(g) && (a = u[g], a < d.min && (d.min = a), a > d.max && (d.max = Math.max(a, k)), g < c.viewPortMin || g > c.viewPortMax || (a < d.viewPortMin && (d.viewPortMin = a), a > d.viewPortMax && (d.viewPortMax = Math.max(a, k))))
            }
        };
            ...
            if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) {
                for (var d = a.axisY.dataInfo, c = a.axisX.dataInfo, b, e, h = !1, q = !1, u = !1, E = {}, k = [], m = 0; m < a.dataSeriesIndexes.length; m++) {
                    var n = this.data[a.dataSeriesIndexes[m]],
                        ...
                        f = !1,
                        x;
                    if ("normal" === n.axisPlacement || "xySwapped" === n.axisPlacement) var y = a.axisX.sessionVariables.newViewportMinimum ? a.axisX.sessionVariables.newViewportMinimum : a.axisX.options && a.axisX.options.viewportMinimum ? a.axisX.options.viewportMinimum : a.axisX.options && a.axisX.options.minimum ? a.axisX.options.minimum : -Infinity,
                    ...
                    for (p = 0; p < n.dataPoints.length; p++) {
                        ...
                        if (0 < p) {
                            ...
                            l(e) || null === n.dataPoints[p - 1].y || (a.axisY.logarithmic ? 0 < e && (r = e / n.dataPoints[p - 1].y, 1 > r && (r = 1 / r), d.minDiff > r && 1 !== r && (d.minDiff = r)) : (r = e - n.dataPoints[p - 1].y, 0 > r && (r *= -1), d.minDiff > r && 0 !== r && (d.minDiff = r)))
                        }
                        if (b < y && !g) null !== e && (x = b);
                        else {
                            if (!g && (g = !0, 0 < p)) {
                            ...
                            b < c.viewPortMin && (c.viewPortMin = b);
                            b > c.viewPortMax && (c.viewPortMax = b);
                            null === e ? c.viewPortMin === b && x < b && (c.viewPortMin = x) : (E[b] = (E[b] || 0) + n.dataPoints[p].y, n.dataPointEOs[p].cumulativeY = E[b], a.yTotals[b] = (a.yTotals[b] ? a.yTotals[b] : 0) + e, a.yAbsTotals[b] = (a.yAbsTotals[b] ? a.yAbsTotals[b] : 0) + Math.abs(e), 0 <= e ? q = !0 : 0 > e && (u = !0), k[b] = k[b] ? k[b] + Math.abs(e) : Math.abs(e))
                        }
                    }
                ...
                for (var d = a.axisY.dataInfo, c = a.axisX.dataInfo, b, e, h = !1, q = 0; q < a.dataSeriesIndexes.length; q++) {
                    ...
                    for (l = 0; l < u.dataPoints.length; l++)
                        if ("undefined" === typeof u.dataPoints[l].x && (u.dataPoints[l].x = l + (a.axisX.logarithmic ? 1 : 0)), u.dataPoints[l].x.getTime ? (h = !0, b = u.dataPoints[l].x.getTime()) : b = u.dataPoints[l].x, e = u.dataPoints[l].y, b < c.min && (c.min = b), b > c.max && (c.max = b), u.dataPointEOs[l].cumulativeSum < d.min && (d.min = u.dataPointEOs[l].cumulativeSum), u.dataPointEOs[l].cumulativeSum > d.max && (d.max = u.dataPointEOs[l].cumulativeSum), 0 < l && (a.axisX.logarithmic ? (n = b / u.dataPoints[l - 1].x, 1 > n && (n = 1 / n), c.minDiff > n && 1 !== n && (c.minDiff = n)) : (n = b - u.dataPoints[l - 1].x, 0 > n && (n *= -1), c.minDiff > n && 0 !== n && (c.minDiff = n)), null !== e && null !== u.dataPoints[l - 1].y && (a.axisY.logarithmic ? (e = u.dataPointEOs[l].cumulativeSum / u.dataPointEOs[l - 1].cumulativeSum, 1 > e && (e = 1 / e), d.minDiff > e && 1 !== e && (d.minDiff = e)) : (e = u.dataPointEOs[l].cumulativeSum - u.dataPointEOs[l - 1].cumulativeSum, 0 > e && (e *= -1), d.minDiff > e && 0 !== e && (d.minDiff = e)))), !(b < p) || k) {
                            ...
                            b < c.viewPortMin && (c.viewPortMin = b);
                            b > c.viewPortMax && (c.viewPortMax = b);
                            0 < l && (u.dataPointEOs[l - 1].cumulativeSum < d.viewPortMin && (d.viewPortMin = u.dataPointEOs[l - 1].cumulativeSum), u.dataPointEOs[l - 1].cumulativeSum > d.viewPortMax && (d.viewPortMax = u.dataPointEOs[l - 1].cumulativeSum));
        ...
        t.prototype.calculateAutoBreaks = function() {
                        ...
                        for (var g = a.axisY.dataInfo, d = a.axisX.dataInfo, h, q = d.min, k = d.max, m = g.min, n = g.max, d = d._dataRanges, g = g._dataRanges, p, u = 0, E = 0; E < a.dataSeriesIndexes.length; E++) {
                            ...
                            if (!(4 > f.dataPoints.length))
                                for (u = 0; u < f.dataPoints.length; u++)
                                    if (b && (p = (k + 1 - q) * Math.max(parseFloat(a.axisX.scaleBreaks.collapsibleThreshold) || 10, 10) / 100, h = f.dataPoints[u].x.getTime ? f.dataPoints[u].x.getTime() : f.dataPoints[u].x, p = Math.floor((h - q) / p), h < d[p].min && (d[p].min = h), h > d[p].max && (d[p].max = h)), c) {
                ...
                if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length) && a.axisX.scaleBreaks && a.axisX.scaleBreaks.autoCalculate && 1 <= a.axisX.scaleBreaks.maxNumberOfAutoBreaks)
                    for (var b = a.axisX.dataInfo, c = b.min, g = b.max, d = b._dataRanges, h, q = 0, k = 0; k < a.dataSeriesIndexes.length; k++) {
                        ...
                        if (!(4 > m.dataPoints.length))
                            for (q = 0; q < m.dataPoints.length; q++) h = (g + 1 - c) * Math.max(parseFloat(a.axisX.scaleBreaks.collapsibleThreshold) || 10, 10) / 100, b = m.dataPoints[q].x.getTime ? m.dataPoints[q].x.getTime() : m.dataPoints[q].x, h = Math.floor((b - c) / h), b < d[h].min && (d[h].min = b), b > d[h].max && (d[h].max = b)
                    }
            }
            for (var b, e = this, h = !1, q = 0; q < this._axes.length; q++)
                ...
                for (q = 0; q < this.plotInfo.plotTypes.length; q++)
                    for (h = this.plotInfo.plotTypes[q], u = 0; u < h.plotUnits.length; u++) b = h.plotUnits[u], "line" === b.type || "stepLine" === b.type || "spline" === b.type || "column" === b.type || "area" === b.type || "stepArea" === b.type || "splineArea" === b.type || "bar" === b.type || "bubble" === b.type || "scatter" === b.type || "candlestick" === b.type || "ohlc" === b.type || "rangeColumn" === b.type || "rangeBar" === b.type || "rangeArea" === b.type || "rangeSplineArea" === b.type || "waterfall" === b.type || "error" === b.type || "boxAndWhisker" === b.type ? d(b) : 0 <= b.type.indexOf("stacked") && c(b);
                        ...
                        if (this._axes[q].scaleBreaks.customBreaks)
                            for (u = 0; u < this._axes[q].scaleBreaks.customBreaks.length; u++)
                                for (b = 0; b < h.length; b++)
                                    if (this._axes[q].scaleBreaks.customBreaks[u].startValue <= h[b].start && h[b].start <= this._axes[q].scaleBreaks.customBreaks[u].endValue || this._axes[q].scaleBreaks.customBreaks[u].startValue <= h[b].start && h[b].start <= this._axes[q].scaleBreaks.customBreaks[u].endValue || h[b].start <= this._axes[q].scaleBreaks.customBreaks[u].startValue && this._axes[q].scaleBreaks.customBreaks[u].startValue <= h[b].end || h[b].start <= this._axes[q].scaleBreaks.customBreaks[u].endValue && this._axes[q].scaleBreaks.customBreaks[u].endValue <= h[b].end) h.splice(b, 1), b--;
                        h.sort(function(a, b) {
                            return b.diff - a.diff
                        });
                        for (u = 0; u < Math.min(h.length, this._axes[q].scaleBreaks.maxNumberOfAutoBreaks); u++) b = a(h[u].start, h[u].end, this._axes[q].logarithmic ? this._axes[q].dataInfo.max / this._axes[q].dataInfo.min : this._axes[q].dataInfo.max - this._axes[q].dataInfo.min, this._axes[q].logarithmic), this._axes[q].scaleBreaks.autoBreaks.push(new fa(this, "autoBreaks", b, u, ++this._eventManager.lastObjectId, this._axes[q].scaleBreaks)), this._axes[q].scaleBreaks._appliedBreaks.push(this._axes[q].scaleBreaks.autoBreaks[this._axes[q].scaleBreaks.autoBreaks.length - 1]);
        ...
        t.prototype._dispatchRangeEvent = function(a, d) {
            ...
            for (var e = 0; e < b.length; e++)
                if (l(c[b[e]]) && (c[b[e]] = []), "axisY" === b[e])
                    for (var h = 0; h < this.axisY.length; h++) c[b[e]].push({
                ...
                for (h = 0; h < this.axisY2.length; h++) c[b[e]].push({
                    viewportMinimum: this[b[e]][h].sessionVariables.newViewportMinimum,
                    viewportMaximum: this[b[e]][h].sessionVariables.newViewportMaximum
                });
            else if ("axisX" === b[e])
                for (h = 0; h < this.axisX.length; h++) c[b[e]].push({
                    viewportMinimum: this[b[e]][h].sessionVariables.newViewportMinimum,
                    viewportMaximum: this[b[e]][h].sessionVariables.newViewportMaximum
                });
            else if ("axisX2" === b[e])
                for (h = 0; h < this.axisX2.length; h++) c[b[e]].push({
                    viewportMinimum: this[b[e]][h].sessionVariables.newViewportMinimum,
                    viewportMaximum: this[b[e]][h].sessionVariables.newViewportMaximum
                });
                        ...
                        for (h = 0; h < this._events.length; h++)
                            if (this._events[h].hasOwnProperty(b))
                                if (e = this._events[h], q = e.bounds, c.x >= q.x1 && c.x <= q.x2 && c.y >= q.y1 && c.y <= q.y2) {
                                    ...
                                    "mousedown" === b && !0 === e.capture ? (t.capturedEventParam = e, this.overlaidCanvas.setCapture ? this.overlaidCanvas.setCapture() : document.documentElement.addEventListener("mouseup", this._mouseEventHandler, !1)) : "mouseup" === b && (e.chart.overlaidCanvas.releaseCapture ? e.chart.overlaidCanvas.releaseCapture() : document.documentElement.removeEventListener("mouseup", this._mouseEventHandler, !1));
                                    break
                                } else e = null;
        ...
        t.prototype._plotAreaMouseUp = function(a, d) {
            ...
            if ("none" !== this.plotInfo.axisPlacement) {
                ...
                if (this.axisX && 0 < this.axisX.length)
                    for (q = 0; q < this.axisX.length; q++) this.axisX[q].crosshair && this.axisX[q].crosshair.enabled && this.axisX[q].renderCrosshair(a, d);
                if (this.axisX2 && 0 < this.axisX2.length)
                    for (q = 0; q < this.axisX2.length; q++) this.axisX2[q].crosshair && this.axisX2[q].crosshair.enabled && this.axisX2[q].renderCrosshair(a, d);
                if (this.axisY && 0 < this.axisY.length)
                    for (q = 0; q < this.axisY.length; q++) this.axisY[q].crosshair && this.axisY[q].crosshair.enabled && this.axisY[q].renderCrosshair(a, d);
                if (this.axisY2 && 0 < this.axisY2.length)
                    for (q = 0; q < this.axisY2.length; q++) this.axisY2[q].crosshair && this.axisY2[q].crosshair.enabled && this.axisY2[q].renderCrosshair(a, d);
                if (this.axisX && 0 < this.axisX.length)
                    for (q = 0; q < this.axisX.length; q++) this.axisX[q].crosshair && this.axisX[q].crosshair.enabled && this.axisX[q].crosshair.renderLabel();
                if (this.axisX2 && 0 < this.axisX2.length)
                    for (q = 0; q < this.axisX2.length; q++) this.axisX2[q].crosshair && this.axisX2[q].crosshair.enabled && this.axisX2[q].crosshair.renderLabel();
                if (this.axisY && 0 < this.axisY.length)
                    for (q = 0; q < this.axisY.length; q++) this.axisY[q].crosshair && this.axisY[q].crosshair.enabled && this.axisY[q].crosshair.renderLabel();
                if (this.axisY2 && 0 < this.axisY2.length)
                    for (q = 0; q < this.axisY2.length; q++) this.axisY2[q].crosshair && this.axisY2[q].crosshair.enabled && this.axisY2[q].crosshair.renderLabel()
            }
        };
        t.prototype._plotAreaMouseMove = function(a, d) {
            if (this.isDrag && "none" !== this.plotInfo.axisPlacement) {
                ...
                if ((!e || 2 < Math.abs(c) || !h || 2 < Math.abs(b)) && (this.panEnabled || this.zoomEnabled))
                    ...
                    this.validateRegion(b, u, e ? a : this.plotArea.x2 - this.plotArea.x1, h ? d : this.plotArea.y2 - this.plotArea.y1, "xy" !== this.zoomType).isValid && (this.resetOverlayedCanvas(), this.overlaidCanvasCtx.fillStyle = "#99B2B5");
        ...
        t.prototype.validateRegion = function(a, d, c, b, e) {
            e = e || !1;
            for (var h = 0 <= this.zoomType.indexOf("x"), q = 0 <= this.zoomType.indexOf("y"), u = !1, l = [], k = [], m = [], n = 0; n < this._axes.length; n++)("axisX" === this._axes[n].type && h || "axisY" === this._axes[n].type && q) && k.push(this._axes[n]);
            for (q = 0; q < k.length; q++) {
                var n = k[q],
                    h = !1,
                    p = n.convertPixelToValue({
                        x: a,
                        y: d
                    }),
                ...
                if (p > g) var f = g,
                    ...
                    p = f;
                if (n.scaleBreaks)
                    for (f = 0; !h && f < n.scaleBreaks._appliedBreaks.length; f++) h = n.scaleBreaks._appliedBreaks[f].startValue <= p && n.scaleBreaks._appliedBreaks[f].endValue >= g;
                if (isFinite(n.dataInfo.minDiff))
                    if (f = n.getApparentDifference(p, g, null, !0), !(h || !(this.panEnabled && n.scaleBreaks && n.scaleBreaks._appliedBreaks.length) && (n.logarithmic && f < Math.pow(n.dataInfo.minDiff, 3) || !n.logarithmic && f < 3 * Math.abs(n.dataInfo.minDiff)) || p < n.minimum || g > n.maximum)) l.push(n), m.push({
                        val1: p,
                        val2: g
                    }), u = !0;
                    else if (!e) {
        ...
        t.prototype.renderIndexLabels = function(a) {
            ...
            for (a = 0; a < this._indexLabels.length; a++) {
                var m = this._indexLabels[a],
                    ...
                    p, g, u = ma("indexLabelFontColor", m.dataPoint, m.dataSeries),
                ...
                var t = m.dataPoint.indexLabelFormatter ? m.dataPoint.indexLabelFormatter(W) : m.dataPoint.indexLabel ? this.replaceKeywordsWithValue(m.dataPoint.indexLabel, m.dataPoint, m.dataSeries, null, m.indexKeyword) : m.dataSeries.indexLabelFormatter ? m.dataSeries.indexLabelFormatter(W) : m.dataSeries.indexLabel ? this.replaceKeywordsWithValue(m.dataSeries.indexLabel, m.dataPoint, m.dataSeries, null, m.indexKeyword) : null;
                if (null !== t && "" !== t) {
                    ...
                    if ("stackedarea100" === n) {
                        ...
                        if (m.dataPoint.x < z.viewportMinimum || m.dataPoint.x > z.viewportMaximum || (0 < m.dataPoint.y.length ? Math.max.apply(null, m.dataPoint.y) : m.dataPoint.y) < K.viewportMinimum || (0 < m.dataPoint.y.length ? Math.max.apply(null, m.dataPoint.y) : m.dataPoint.y) > K.viewportMaximum) continue
                    ...
                    if ("normal" === this.plotInfo.axisPlacement) {
                        ...
                        if ("inside" !== v) e = c.y1, h = c.y2, 0 < w ? (g = m.point.y + x._lineHeight / 2 - k - u - b, g < e && (g = "auto" === v ? Math.max(m.point.y, e) + x._lineHeight / 2 + u + b : e + x._lineHeight / 2 + u + b, L = g + ("horizontal" === W ? k - x._lineHeight / 2 : 0) > m.point.y, !L || (0 <= n.indexOf("line") || 0 <= n.indexOf("area")) || (g -= b))) : (g = m.point.y + x._lineHeight / 2 + u + b, g > h - k + x._lineHeight / 2 - u && (g = "auto" === v ? Math.min(m.point.y, h) + x._lineHeight / 2 - k - u - b : h + x._lineHeight / 2 - k - u - b, L = g - ("horizontal" === W ? x._lineHeight / 2 : k) < m.point.y, !L || (0 <= n.indexOf("line") || 0 <= n.indexOf("area")) || (g += b)));
                        else {
                            Math.max(m.bounds.y1, c.y1);
                            h = Math.min(m.bounds.y2, c.y2) - k + x._lineHeight / 2;
                            b = 0 <= n.indexOf("range") || "error" === n ? 0 < w ? Math.max(m.bounds.y1, c.y1) + x._lineHeight / 2 + u : Math.min(m.bounds.y2, c.y2) + x._lineHeight / 2 - k - u : (Math.max(m.bounds.y1, c.y1) + Math.min(m.bounds.y2, c.y2)) / 2 - k / 2 + x._lineHeight / 2;
                            if (0 < w) {
                                if (g = b, "bubble" === n || "scatter" === n) g = m.point.y - k / 2 + x._lineHeight / 2, k > m.bounds.y2 - m.bounds.y1 && (g -= k / 2 + u), 0 > g - x._lineHeight / 2 && (g += Math.abs(g - x._lineHeight / 2) <= (m.bounds.y2 - m.bounds.y1) / 2 + u ? Math.abs(g - x._lineHeight / 2) : (m.bounds.y2 - m.bounds.y1) / 2 + u)
                            } else g = Math.min(m.point.y, b), g > h - k - u && ("bubble" === n || "scatter" === n) && (g = Math.min(m.point.y + u, c.y2 - k - u));
                            g = Math.min(g, h)
                        }
                    } else 0 <= n.indexOf("line") || 0 <= n.indexOf("area") || 0 <= n.indexOf("scatter") ? (v = "auto", q = 4) : 0 <= n.indexOf("stacked") ? "auto" === v && (v = "inside") : "bubble" === n && (v = "inside"), g = m.point.y + x._lineHeight / 2 - k / 2, "inside" !== v ? (h = c.x1, e = c.x2, 0 > w ? (p = m.point.x - f + ("horizontal" === W ? 0 : x._lineHeight / 2) - q - b, ("horizontal" === W ? p : p - x._lineHeight / 2) < h && (p = "auto" === v ? Math.max(m.point.x, h) + ("horizontal" === W ? 0 : x._lineHeight / 2) + u + b : h + ("horizontal" === W ? 0 : x._lineHeight / 2) + q, (L = p + f - ("horizontal" === W ? 0 : x._lineHeight / 2) > m.point.x) && (p -= b))) : (p = m.point.x + ("horizontal" === W ? 0 : x._lineHeight / 2) + q + b, ("horizontal" === W ? p : p - x._lineHeight / 2) > e - f - q - b && (p = "auto" === v ? Math.min(m.point.x, e) - ("horizontal" === W ? f : f - x._lineHeight / 2) - q - b : e - f - q + ("horizontal" === W ? 0 : x._lineHeight / 2), (L = p - ("horizontal" === W ? 0 : x._lineHeight / 2) < m.point.x) && (p += b)))) : (h = Math.max(m.bounds.x1, c.x1), Math.min(m.bounds.x2, c.x2), b = 0 <= n.indexOf("range") || "error" === n ? 0 > w ? Math.max(m.bounds.x1, c.x1) : Math.min(m.bounds.x2, c.x2) - f - q + ("horizontal" === W ? 0 : x._lineHeight / 2) : (Math.max(m.bounds.x1, c.x1) + Math.min(m.bounds.x2, c.x2)) / 2 - f / 2 + ("horizontal" === W ? 0 : x._lineHeight / 2), p = 0 > w ? b : Math.min(m.point.x, b), p = Math.max(p, h + ("horizontal" === W ? 0 : x._lineHeight / 2 + u)));
                    "vertical" === W && (g += k - x._lineHeight / 2, 0 <= "ohlc candlestick boxandwhisker column rangecolumn stackedcolumn stackedcolumn100 error".split(" ").indexOf(n) && (L = 0 < w ? g + ("horizontal" === W ? k - x._lineHeight / 2 : 0) > m.point.y : g - ("horizontal" === W ? x._lineHeight / 2 : k) < m.point.y), "bubble" === n || "scatter" === n) && (p += x._lineHeight / 2 - D / 2);
                    x.x = p;
                    x.y = g;
                    x.render(!0);
                    C && ("inside" !== v && (0 > n.indexOf("bar") && ("error" !== n || !m.axisSwapped) && m.point.x > c.x1 && m.point.x < c.x2 || !L) && (-1 === "ohlc candlestick boxandwhisker column rangecolumn stackedcolumn stackedcolumn100 error".split(" ").indexOf(n) && ("error" !== n || m.axisSwapped) && m.point.y > c.y1 && m.point.y < c.y2 || !L)) && (d.lineWidth = C, d.strokeStyle = s ? s : "gray", d.setLineDash && d.setLineDash(I(y, C)), d.beginPath(), d.moveTo(m.point.x, m.point.y), 0 <= n.indexOf("bar") || "error" === n && m.axisSwapped ? d.lineTo(p + (0 < m.direction ? 0 : f) + ("vertical" === W ? -x._lineHeight / 2 : 0), g + ("vertical" === W ? -k / 2 : k / 2 - x._lineHeight / 2)) : 0 <= n.indexOf("column") || "error" === n && !m.axisSwapped ? d.lineTo(p + f / 2 - ("horizontal" === W ? 0 : x._lineHeight / 2), g + ("vertical" === W ? g - k < m.point.y ? 0 : -k : (g - x._lineHeight / 2 < m.point.y ? k : 0) - x._lineHeight / 2)) : 0 <= n.indexOf("waterfall") ? d.lineTo(p + f / 2 - ("horizontal" === W ? 0 : x._lineHeight / 2), "vertical" === W ? 0 < w && g < m.point.y ? g : 0 > w && g - k > m.point.y ? g - k : m.point.y : 0 < w && g + k - x._lineHeight / 2 < m.point.y ? g + k - x._lineHeight / 2 : 0 > w && g - x._lineHeight / 2 > m.point.y ? g - x._lineHeight / 2 : m.point.y) : d.lineTo(p + f / 2 - ("horizontal" === W ? 0 : x._lineHeight / 2), g + ("vertical" === W ? g - k < m.point.y ? 0 : -k : (g + k - x._lineHeight / 2 < m.point.y ? k : 0) - x._lineHeight / 2)), d.stroke())
                }
            }
            d = {
                source: d,
                        ...
                        for (var W = !1, s = 0; s < m.length; s++)
                            if (C = m[s].getTime ? m[s].x.getTime() : m[s].x, !(C < a.axisX.dataInfo.viewPortMin || C > a.axisX.dataInfo.viewPortMax && (!k.connectNullData || !W)))
                                if ("number" !== typeof m[s].y) 0 < s && !(k.connectNullData || W || y) && (c.stroke(), r && b.stroke()), W = !0;
                                    ...
                                    s < m.length - 1 && (x !== (m[s].lineColor || f) || n !== (m[s].lineDashType || k.lineDashType)) && (c.stroke(), c.beginPath(), c.moveTo(C, v), x = m[s].lineColor || f, c.strokeStyle = x, c.setLineDash && (m[s].lineDashType ? (n = m[s].lineDashType, c.setLineDash(I(n, k.lineThickness))) : (n = k.lineDashType, c.setLineDash(g))));
                                    0 !== m[s].markerSize && (0 < m[s].markerSize || 0 < k.markerSize) && (t = k.getMarkerProperties(s, C, v, c), h.push(t), B = U(B), r && h.push({
                                        x: C,
                                        y: v,
                                        ctx: b,
                                        type: t.type,
            ...
            function d(a) {
                ...
                if (0 < a.length) {
                    ...
                    for (var c = 0; c < a.length - 3; c += 3)
                        if (b.bezierCurveTo(a[c + 1].x, a[c + 1].y, a[c + 2].x, a[c + 2].y, a[c + 3].x, a[c + 3].y), r && e.bezierCurveTo(a[c + 1].x, a[c + 1].y, a[c + 2].x, a[c + 2].y, a[c + 3].x, a[c + 3].y), 0 < c && 0 === c % 3E3 || a[c + 3].newStrokeStyle || a[c + 3].newLineDashArray) b.stroke(), b.beginPath(), b.moveTo(a[c + 3].x, a[c + 3].y), a[c + 3].newStrokeStyle && (b.strokeStyle = a[c + 3].newStrokeStyle), a[c + 3].newLineDashArray && b.setLineDash(a[c + 3].newLineDashArray), r && (e.stroke(), e.beginPath(), e.moveTo(a[c + 3].x, a[c + 3].y));
                    b.stroke();
                    r && e.stroke()
                }
            }
                    ...
                    if (0 < m.length)
                        for (C = !1, y = 0; y < m.length; y++)
                            if (s = m[y].getTime ? m[y].x.getTime() : m[y].x, !(s < a.axisX.dataInfo.viewPortMin || s > a.axisX.dataInfo.viewPortMax && (!k.connectNullData || !C)))
                                if ("number" !== typeof m[y].y) 0 < y && !C && (k.connectNullData ? b.setLineDash && (0 < v.length && (k.options.nullDataLineDashType || !m[y - 1].lineDashType)) && (v[v.length - 1].newLineDashArray = p, n = k.nullDataLineDashType) : (d(v), v = [])), C = !0;
                                else {
                                    ...
                                    y < m.length - 1 && (x !== (m[y].lineColor || f) || n !== (m[y].lineDashType || k.lineDashType)) && (x = m[y].lineColor || f, v[v.length - 1].newStrokeStyle = x, b.setLineDash && (m[y].lineDashType ? (n = m[y].lineDashType, v[v.length - 1].newLineDashArray = I(n, k.lineThickness)) : (n = k.lineDashType, v[v.length - 1].newLineDashArray = g)));
        ...
        t.prototype.renderColumn = function(a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var b = null,
                    e = this.plotArea,
                    h = 0,
                    q, u, l, k = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0),
                    ...
                    if (0 < f.length)
                        for (var x = 5 < n && g.bevelEnabled ? !0 : !1, h = 0; h < f.length; h++)
                            if (f[h].getTime ? l = f[h].x.getTime() : l = f[h].x, !(l < a.axisX.dataInfo.viewPortMin || l > a.axisX.dataInfo.viewPortMax) && "number" === typeof f[h].y) {
                                ...
                                (f[h].indexLabel || g.indexLabel || f[h].indexLabelFormatter || g.indexLabelFormatter) && this._indexLabels.push({
                                    chartType: "column",
                                    dataPoint: f[h],
                                    dataSeries: g,
                                    point: {
        ...
        t.prototype.renderStackedColumn = function(a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var b = null,
                    ...
                    l = [],
                    k = 0,
                    m, n, p = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0),
                    ...
                    if (0 < s.length) {
                        ...
                        for (k = 0; k < s.length; k++)
                            if (b = s[k].x.getTime ? s[k].x.getTime() : s[k].x, !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof s[k].y) {
                                ...
                                var v = m + f << 0,
                                    t;
                                if (a.axisY.logarithmic || a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 < s[k].y) u[b] = s[k].y + (u[b] ? u[b] : 0), 0 < u[b] && (n = a.axisY.convertValueToPixel(u[b]), t = "undefined" !== typeof h[b] ? h[b] : p, h[b] = n);
                                else if (a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 >= s[k].y) l[b] = s[k].y + (l[b] ? l[b] : 0), t = a.axisY.convertValueToPixel(l[b]), n = "undefined" !== typeof q[b] ? q[b] : p, q[b] = t;
                        ...
                        for (var C = 5 < f && y.bevelEnabled ? !0 : !1, k = 0; k < s.length; k++)
                            if (b = s[k].x.getTime ? s[k].x.getTime() : s[k].x, !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof s[k].y) {
                                ...
                                if (a.axisY.logarithmic || a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 < s[k].y) {
                                    ...
                                    t = h[b] ? h[b] : p;
                                    h[b] = n
                                } else if (a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 >= s[k].y) l[b] = n + ("undefined" !== typeof l[b] ? l[b] : 0), t = a.axisY.convertValueToPixel(l[b]), n = q[b] ? q[b] : p, q[b] = t;
                    ...
                    if (0 < s.length) {
                        ...
                        for (k = 0; k < s.length; k++)
                            if (b = s[k].x.getTime ? s[k].x.getTime() : s[k].x, !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof s[k].y) {
                                ...
                                var v = n + D << 0,
                                    t;
                                if (a.axisY.logarithmic || a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 < s[k].y) l[b] = s[k].y + (l[b] ? l[b] : 0), 0 < l[b] && (t = h[b] ? h[b] : p, h[b] = m = a.axisY.convertValueToPixel(l[b]));
        ...
        t.prototype.renderArea = function(a) {
            ...
            function b() {
                w && (0 < g.lineThickness && h.stroke(), a.axisY.logarithmic || 0 >= a.axisY.viewportMinimum && 0 <= a.axisY.viewportMaximum ? t = v : 0 > a.axisY.viewportMaximum ? t = l.y1 : 0 < a.axisY.viewportMinimum && (t = v), h.lineTo(y, t), h.lineTo(w.x, t), h.closePath(), h.globalAlpha = g.fillOpacity, h.fill(), h.globalAlpha = 1, r && (q.lineTo(y, t), q.lineTo(w.x, t), q.closePath(), q.fill()), h.beginPath(), h.moveTo(y, s), q.beginPath(), q.moveTo(y, s), w = {
                    x: y,
                    y: s
                })
            }
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var n = 0; n < a.dataSeriesIndexes.length; n++) {
                    ...
                    d = !0;
                    var x = 0,
                        y, s, C, v = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0),
                        t, w = null;
                    if (0 < D.length) {
                        ...
                        for (var ca = !0; x < D.length; x++)
                            if (C = D[x].x.getTime ? D[x].x.getTime() : D[x].x, !(C < a.axisX.dataInfo.viewPortMin || C > a.axisX.dataInfo.viewPortMax && (!g.connectNullData || !ca)))
                                if ("number" !== typeof D[x].y) g.connectNullData || (ca || d) || b(), ca = !0;
                                    ...
                                    d || ca ? (!d && g.connectNullData ? (h.setLineDash && (g.options.nullDataLineDashType || c === g.lineDashType && g.lineDashType !== g.nullDataLineDashType) && (d = y, c = s, y = m.x, s = m.y, b(), h.moveTo(m.x, m.y), y = d, s = c, w = m, c = g.nullDataLineDashType, h.setLineDash(K)), h.lineTo(y, s), r && q.lineTo(y, s)) : (h.beginPath(), h.moveTo(y, s), r && (q.beginPath(), q.moveTo(y, s)), w = {
                                        x: y,
                                        y: s
                                    }), ca = d = !1) : (h.lineTo(y, s), r && q.lineTo(y, s), 0 == x % 250 && b());
                                    m = {
                                        x: y,
                                        y: s
                                    };
                                    x < D.length - 1 && (A !== (D[x].lineColor || z) || c !== (D[x].lineDashType || g.lineDashType)) && (b(), A = D[x].lineColor || z, h.strokeStyle = A, h.setLineDash && (D[x].lineDashType ? (c = D[x].lineDashType, h.setLineDash(I(c, g.lineThickness))) : (c = g.lineDashType, h.setLineDash(L))));
                                    ...
                                    0 !== D[x].markerSize && (0 < D[x].markerSize || 0 < g.markerSize) && (C = g.getMarkerProperties(x, y, s, h), f.push(C), ba = U(ba), r && f.push({
                                        x: y,
                                        y: s,
                                        ctx: q,
                                        type: C.type,
                                    ...
                                    (D[x].indexLabel || g.indexLabel || D[x].indexLabelFormatter || g.indexLabelFormatter) && this._indexLabels.push({
                                        chartType: "area",
                                        dataPoint: D[x],
                                        dataSeries: g,
                                        point: {
                                        ...
                                        direction: 0 > D[x].y === a.axisY.reversed ? 1 : -1,
                                        color: B
                                    })
                                } b();
                        aa.drawMarkers(f)
        ...
        t.prototype.renderSplineArea = function(a) {
                ...
                if (0 < c.length) {
                    if (0 < m.lineThickness) {
                        ...
                        for (var g = 0; g < c.length - 3; g += 3)
                            if (b.bezierCurveTo(c[g + 1].x, c[g + 1].y, c[g + 2].x, c[g + 2].y, c[g + 3].x, c[g + 3].y), r && e.bezierCurveTo(c[g + 1].x, c[g + 1].y, c[g + 2].x, c[g + 2].y, c[g + 3].x, c[g + 3].y), c[g + 3].newStrokeStyle || c[g + 3].newLineDashArray) b.stroke(), b.beginPath(), b.moveTo(c[g + 3].x, c[g + 3].y), c[g + 3].newStrokeStyle && (b.strokeStyle = c[g + 3].newStrokeStyle), c[g + 3].newLineDashArray && b.setLineDash(c[g + 3].newLineDashArray);
                        b.stroke()
                    }
                    b.beginPath();
                    b.moveTo(c[0].x, c[0].y);
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var f = 0; f < a.dataSeriesIndexes.length; f++) {
                    ...
                    var q = [],
                        p = 0,
                        g, D, x = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0),
                        y, s = null,
                        C = [];
                    if (0 < n.length) {
                        ...
                        for (D = !1; p < n.length; p++)
                            if (g = n[p].x.getTime ? n[p].x.getTime() : n[p].x, !(g < a.axisX.dataInfo.viewPortMin || g > a.axisX.dataInfo.viewPortMax && (!m.connectNullData || !D)))
                                if ("number" !== typeof n[p].y) 0 < p && !D && (m.connectNullData ? b.setLineDash && (0 < C.length && (m.options.nullDataLineDashType || !n[p - 1].lineDashType)) && (C[C.length - 1].newLineDashArray = z, B = m.nullDataLineDashType) : (d(), C = [])), D = !0;
                                else {
                                    ...
                                    p < n.length - 1 && (Ya !== (n[p].lineColor || t) || B !== (n[p].lineDashType || m.lineDashType)) && (Ya = n[p].lineColor || t, C[C.length - 1].newStrokeStyle = Ya, b.setLineDash && (n[p].lineDashType ? (B = n[p].lineDashType, C[C.length - 1].newLineDashArray = I(B, m.lineThickness)) : (B = m.lineDashType, C[C.length - 1].newLineDashArray = A)));
                    ...
                    if (0 < D.length) {
                        ...
                        for (; x < D.length; x++)
                            if (C = D[x].x.getTime ? D[x].x.getTime() : D[x].x, !(C < a.axisX.dataInfo.viewPortMin || C > a.axisX.dataInfo.viewPortMax && (!g.connectNullData || !c))) {
                                var ba = s;
                                "number" !== typeof D[x].y ? (g.connectNullData || (c || d) || b(), c = !0) : (y = a.axisX.convertValueToPixel(C), s = a.axisY.convertValueToPixel(D[x].y), d || c ? (!d && g.connectNullData ? (h.setLineDash && (g.options.nullDataLineDashType || K === g.lineDashType && g.lineDashType !== g.nullDataLineDashType) && (d = y, c = s, y = m.x, s = m.y, b(), h.moveTo(m.x, m.y), y = d, s = c, w = m, K = g.nullDataLineDashType, h.setLineDash(L)), h.lineTo(y, ba), h.lineTo(y, s), r && (q.lineTo(y, ba), q.lineTo(y, s))) : (h.beginPath(), h.moveTo(y, s), r && (q.beginPath(), q.moveTo(y, s)), w = {
                                    x: y,
                                    y: s
                                }), c = d = !1) : (h.lineTo(y, ba), r && q.lineTo(y, ba), h.lineTo(y, s), r && q.lineTo(y, s), 0 == x % 250 && b()), m = {
                                    x: y,
                                    y: s
                                }, x < D.length - 1 && (A !== (D[x].lineColor || z) || K !== (D[x].lineDashType || g.lineDashType)) && (b(), A = D[x].lineColor || z, h.strokeStyle = A, h.setLineDash && (D[x].lineDashType ? (K = D[x].lineDashType, h.setLineDash(I(K, g.lineThickness))) : (K = g.lineDashType, h.setLineDash(ca)))), C = g.dataPointIds[x], this._eventManager.objectMap[C] = {
                                    id: C,
                                    objectType: "dataPoint",
                                    dataSeriesIndex: p,
                                    dataPointIndex: x,
                                    x1: y,
                                    y1: s
                                }, 0 !== D[x].markerSize && (0 < D[x].markerSize || 0 < g.markerSize) && (ba = g.getMarkerProperties(x, y, s, h), f.push(ba), C = U(C), r && f.push({
                                    x: y,
                                    y: s,
                                    ctx: q,
                                    type: ba.type,
                ...
                for (t = 0; t < a.dataSeriesIndexes.length; t++) {
                    ...
                    if (0 < m.length) {
                        ...
                        for (var ba = !0, p = 0; p < m.length; p++) {
                            var h = m[p],
                                ea = null,
                                ea = 0 <= B.dataPointIndexes[h] ? z[B.dataPointIndexes[h]] : {
                                    x: h,
                                    y: null
                                };
                            if (!(h < a.axisX.dataInfo.viewPortMin || h > a.axisX.dataInfo.viewPortMax && (!B.connectNullData || !ba)))
                                if ("number" !== typeof ea.y) B.connectNullData || (ba || C) || d(), ba = !0;
                                    ...
                                    f[h] = x - D;
                                    C || ba ? (!C && B.connectNullData ? (b.setLineDash && (B.options.nullDataLineDashType || v === B.lineDashType && B.lineDashType !== B.nullDataLineDashType) && (C = k.pop(), v = k[k.length - 1], d(), b.moveTo(s.x, s.y), k.push(v), k.push(C), v = B.nullDataLineDashType, b.setLineDash(L)), b.lineTo(g, D), r && y.lineTo(g, D)) : (b.beginPath(), b.moveTo(g, D), r && (y.beginPath(), y.moveTo(g, D))), ba = C = !1) : (b.lineTo(g, D), r && y.lineTo(g, D), 0 == p % 250 && (d(), b.moveTo(g, D), r && y.moveTo(g, D), k.push({
                                        x: g,
                                        y: x - na
                                    })));
                                    s = {
                                    ...
                                    p < z.length - 1 && (K !== (z[p].lineColor || A) || v !== (z[p].lineDashType || B.lineDashType)) && (d(), b.beginPath(), b.moveTo(g, D), k.push({
                                        x: g,
                                        y: x - na
                                    }), K = z[p].lineColor || A, b.strokeStyle = K, b.setLineDash && (z[p].lineDashType ? (v = z[p].lineDashType, b.setLineDash(I(v, B.lineThickness))) : (v = B.lineDashType, b.setLineDash(ca))));
                                    ...
                                    0 <= B.dataPointIndexes[h] && 0 !== ea.markerSize && (0 < ea.markerSize || 0 < B.markerSize) && (na = B.getMarkerProperties(B.dataPointIndexes[h], g, D, b), q.push(na), h = U(la), r && q.push({
                                        x: g,
                                        y: D,
                                        ctx: y,
                                        type: na.type,
        ...
        t.prototype.renderStackedArea100 = function(a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var e = null,
                    ...
                    n = [],
                    p = 0,
                    g, D, x, y, s, C = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0),
                        ...
                        for (var ba = !0, p = 0; p < m.length; p++) {
                            ...
                            if (!(h < a.axisX.dataInfo.viewPortMin || h > a.axisX.dataInfo.viewPortMax && (!B.connectNullData || !ba)))
                                if ("number" !== typeof ea.y) B.connectNullData || (ba || y) || d(), ba = !0;
                                    ...
                                    f[h] = C - D;
                                    y || ba ? (!y && B.connectNullData ? (b.setLineDash && (B.options.nullDataLineDashType || s === B.lineDashType && B.lineDashType !== B.nullDataLineDashType) && (y = k.pop(), s = k[k.length - 1], d(), b.moveTo(x.x, x.y), k.push(s), k.push(y), s = B.nullDataLineDashType, b.setLineDash(L)), b.lineTo(g, D), r && v.lineTo(g, D)) : (b.beginPath(), b.moveTo(g, D), r && (v.beginPath(), v.moveTo(g, D))), ba = y = !1) : (b.lineTo(g, D), r && v.lineTo(g, D), 0 == p % 250 && (d(), b.moveTo(g, D), r && v.moveTo(g, D), k.push({
                                        x: g,
                                        y: C - la
                                    })));
                                    x = {
                                    ...
                                    p < z.length - 1 && (K !== (z[p].lineColor || A) || s !== (z[p].lineDashType || B.lineDashType)) && (d(), b.beginPath(), b.moveTo(g, D), k.push({
                                        x: g,
                                        y: C - la
                                    }), K = z[p].lineColor || A, b.strokeStyle = K, b.setLineDash && (z[p].lineDashType ? (s = z[p].lineDashType, b.setLineDash(I(s, B.lineThickness))) : (s = B.lineDashType, b.setLineDash(ca))));
                                    if (0 <= B.dataPointIndexes[h]) {
                                    ...
                                    0 <= B.dataPointIndexes[h] && 0 !== ea.markerSize && (0 < ea.markerSize || 0 < B.markerSize) && (la = B.getMarkerProperties(B.dataPointIndexes[h], g, D, b), l.push(la), h = U(F), r && l.push({
                                        x: g,
                                        y: D,
                                        ctx: v,
                                        type: la.type,
        ...
        t.prototype.renderBubble = function(a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var l = -Infinity, f = Infinity, k = 0; k < a.dataSeriesIndexes.length; k++)
                    for (var m = a.dataSeriesIndexes[k], n = this.data[m], p = n.dataPoints, g = 0, e = 0; e < p.length; e++) h = p[e].getTime ? h = p[e].x.getTime() : h = p[e].x, h < a.axisX.dataInfo.viewPortMin || h > a.axisX.dataInfo.viewPortMax || "undefined" === typeof p[e].z || (g = p[e].z, g > l && (l = g), g < f && (f = g));
                        ...
                        for (var n = 0, p = 0, e = 0; e < m.length; e++)
                            if (h = m[e].getTime ? h = m[e].x.getTime() : h = m[e].x, !(h < a.axisX.dataInfo.viewPortMin || h > a.axisX.dataInfo.viewPortMax) && "number" === typeof m[e].y) {
                                ...
                                Math.sqrt((n - h) * (n - h) + (p - q) * (p - q)) < Math.min(g.size, 5) && m.length > Math.min(this.plotArea.width, this.plotArea.height) || (n = k.dataPointIds[e], this._eventManager.objectMap[n] = {
                                    ...
                                    x1: h,
                                    y1: q
                                }, n = U(n), r && aa.drawMarker(g.x, g.y, this._eventManager.ghostCtx, g.type, g.size, n, n, g.borderThickness), (m[e].indexLabel || k.indexLabel || m[e].indexLabelFormatter || k.indexLabelFormatter) && this._indexLabels.push({
                                    chartType: "scatter",
                                    dataPoint: m[e],
                                    dataSeries: k,
                                    point: {
        ...
        t.prototype.renderCandlestick = function(a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var e = null,
                    ...
                    q = this.plotArea,
                    f = 0,
                    E, k, m, n, p, g, e = this.options.dataPointMinWidth ? this.dataPointMinWidth : this.options.dataPointWidth ? this.dataPointWidth : 1,
                ...
                for (var x = 0; x < a.dataSeriesIndexes.length; x++) {
                    ...
                    if (0 < C.length)
                        for (var v = 5 < D && s.bevelEnabled ? !0 : !1, f = 0; f < C.length; f++)
                            if (C[f].getTime ? g = C[f].x.getTime() : g = C[f].x, !(g < a.axisX.dataInfo.viewPortMin || g > a.axisX.dataInfo.viewPortMax) && !l(C[f].y) && C[f].y.length && "number" === typeof C[f].y[0] && "number" === typeof C[f].y[1] && "number" === typeof C[f].y[2] && "number" === typeof C[f].y[3]) {
                                ...
                                "candlestick" === s.type ? (c.moveTo(E - z, m), c.lineTo(E - z, Math.min(k, p)), c.stroke(), c.moveTo(E - z, Math.max(k, p)), c.lineTo(E - z, n), c.stroke(), da(c, t, Math.min(k, p), w, Math.max(k, p), C[f].y[0] <= C[f].y[3] ? s.risingColor : h, B, e, v, v, !1, !1, s.fillOpacity), r && (e = U(A), b.strokeStyle = e, b.moveTo(E - z, m), b.lineTo(E - z, Math.min(k, p)), b.stroke(), b.moveTo(E - z, Math.max(k, p)), b.lineTo(E - z, n), b.stroke(), da(b, t, Math.min(k, p), w, Math.max(k, p), e, 0, null, !1, !1, !1, !1))) : "ohlc" === s.type && (c.moveTo(E - z, m), c.lineTo(E - z, n), c.stroke(), c.beginPath(), c.moveTo(E, k), c.lineTo(t, k), c.stroke(), c.beginPath(), c.moveTo(E, p), c.lineTo(w, p), c.stroke(), r && (e = U(A), b.strokeStyle = e, b.moveTo(E - z, m), b.lineTo(E - z, n), b.stroke(), b.beginPath(), b.moveTo(E, k), b.lineTo(t, k), b.stroke(), b.beginPath(), b.moveTo(E, p), b.lineTo(w, p), b.stroke()));
        ...
        t.prototype.renderBoxAndWhisker = function(a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var e = null,
                    h = this.plotArea,
                    q = 0,
                    f, E, k, m, n, p, g, e = this.options.dataPointMinWidth ? this.dataPointMinWidth : this.options.dataPointWidth ? this.dataPointWidth : 1,
                ...
                for (var x = !1, x = !!a.axisY.reversed, y = 0; y < a.dataSeriesIndexes.length; y++) {
                    ...
                    if (0 < v.length)
                        for (var w = 5 < D && t.bevelEnabled ? !0 : !1, q = 0; q < v.length; q++)
                            if (v[q].getTime ? g = v[q].x.getTime() : g = v[q].x, !(g < a.axisX.dataInfo.viewPortMin || g > a.axisX.dataInfo.viewPortMax) && !l(v[q].y) && v[q].y.length && "number" === typeof v[q].y[0] && "number" === typeof v[q].y[1] && "number" === typeof v[q].y[2] && "number" === typeof v[q].y[3] && "number" === typeof v[q].y[4] && 5 === v[q].y.length) {
                                ...
                                var z = f - D / 2 << 0,
                                    ...
                                    S = v[q].stemDashType ? v[q].stemDashType : t.stemDashType,
                                    Q = v[q].lineColor ? v[q].lineColor : v[q].color ? t.lineColor ? t.lineColor : v[q].color : t.lineColor ? t.lineColor : e,
                                ...
                                c.save();
                                0 < la && (c.beginPath(), c.strokeStyle = na, c.lineWidth = la, c.setLineDash && c.setLineDash(I(S, la)), c.moveTo(f - F, k), c.lineTo(f - F, E), c.stroke(), c.moveTo(f - F, n), c.lineTo(f - F, m), c.stroke());
                                c.restore();
                                ...
                                c.stroke();
                                c.save();
                                0 < J && (c.beginPath(), c.globalAlpha = 1, c.setLineDash && c.setLineDash(I(T, J)), c.strokeStyle = Q, c.lineWidth = J, c.moveTo(z, p - P), c.lineTo(B, p - P), c.stroke());
                                c.restore();
                                c.save();
                                0 < L && (c.beginPath(), c.setLineDash && c.setLineDash(I(ca, L)), c.strokeStyle = K, c.lineWidth = L, c.moveTo(f - ba / 2 << 0, n - ea), c.lineTo(f + ba / 2 << 0, n - ea), c.stroke(), c.moveTo(f - ba / 2 << 0, E + ea), c.lineTo(f + ba / 2 << 0, E + ea), c.stroke());
                                c.restore();
                                r && (e = U(O), b.strokeStyle = e, b.lineWidth = la, 0 < la && (b.moveTo(f - G - F, k), b.lineTo(f - G - F, Math.max(E, n)), b.stroke(), b.moveTo(f - G - F, Math.min(E, n)), b.lineTo(f - G - F, m), b.stroke()), da(b, z, Math.max(k, m), B, Math.min(k, m), e, 0, null, !1, !1, !1, !1), 0 < L && (b.beginPath(), b.lineWidth = L, b.moveTo(f + ba / 2, n - ea), b.lineTo(f - ba / 2, n - ea), b.stroke(), b.moveTo(f + ba / 2, E + ea), b.lineTo(f - ba / 2, E + ea), b.stroke()));
                                (v[q].indexLabel || t.indexLabel || v[q].indexLabelFormatter || t.indexLabelFormatter) && this._indexLabels.push({
                                    chartType: t.type,
                                    dataPoint: v[q],
                                    dataSeries: t,
                                    point: {
        ...
        t.prototype.renderRangeColumn = function(a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var b = null,
                    e = this.plotArea,
                    h = 0,
                    q, f, E, h = this.options.dataPointMinWidth ? this.dataPointMinWidth : this.options.dataPointWidth ? this.dataPointWidth : 1;
                ...
                for (var m = 0; m < a.dataSeriesIndexes.length; m++) {
                    ...
                    if (0 < g.length)
                        for (var t = 5 < k && p.bevelEnabled ? !0 : !1, h = 0; h < g.length; h++)
                            if (g[h].getTime ? E = g[h].x.getTime() : E = g[h].x, !(E < a.axisX.dataInfo.viewPortMin || E > a.axisX.dataInfo.viewPortMax) && !l(g[h].y) && g[h].y.length && "number" === typeof g[h].y[0] && "number" === typeof g[h].y[1]) {
        ...
        t.prototype.renderError = function(a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var e = null,
                    ...
                    q = this.plotArea,
                    f = 0,
                    E, k, m, n, p, g, t, x = a.axisX.dataInfo.minDiff;
                ...
                for (var C = 0; C < a.dataSeriesIndexes.length; C++) {
                    var v = a.dataSeriesIndexes[C],
                        w = this.data[v],
                        A = w.dataPoints,
                        B = l(w._linkedSeries) ? !1 : w._linkedSeries.type.match(/(bar|column)/ig) && w._linkedSeries.visible ? !0 : !1,
                        I = 0;
                    if (B)
                        for (e = w._linkedSeries.id, s = 0; s < e; s++) !this.data[s].type.match(/(bar|column)/ig) || !this.data[s].visible || this.data[s].type.match(/(stacked)/ig) && I || (this.data[s].type.match(/(range)/ig) && (h = !0), I++);
                    ...
                    h && (f = this.options.dataPointMaxWidth ? this.dataPointMaxWidth : this.options.dataPointWidth ? this.dataPointWidth : b ? Math.min(0.15 * this.height, 0.9 * (this.plotArea.height / (B ? y : 1))) << 0 : 0.03 * this.width);
                    ...
                    if (0 < A.length)
                        for (var G = w._colorSet, f = 0; f < A.length; f++) {
                            ...
                            if (!(t < a.axisX.dataInfo.viewPortMin || t > a.axisX.dataInfo.viewPortMax) && !l(A[f].y) && A[f].y.length && "number" === typeof A[f].y[0] && "number" === typeof A[f].y[1]) {
                                ...
                                b ? n = ca : g = ca;
                                b ? (p = a.axisX.reversed ? k + (B ? y : 1) * s / 2 - (B ? I - 1 : 0) * s << 0 : k - (B ? y : 1) * s / 2 + (B ? I - 1 : 0) * s << 0, g = a.axisX.reversed ? p - s << 0 : p + s << 0) : (m = a.axisX.reversed ? E + (B ? y : 1) * s / 2 - (B ? I - 1 : 0) * s << 0 : E - (B ? y : 1) * s / 2 + (B ? I - 1 : 0) * s << 0, n = a.axisX.reversed ? m - s << 0 : m + s << 0);
                                !b && p > g && (ca = p, p = g, g = ca);
                                b && m > n && (ca = m, m = n, n = ca);
                                ca = w.dataPointIds[f];
                                ...
                                if (A[f].indexLabel || w.indexLabel || A[f].indexLabelFormatter || w.indexLabelFormatter) this._indexLabels.push({
                                    chartType: "error",
                                    dataPoint: A[f],
                                    dataSeries: w,
                                    indexKeyword: 0,
                                    point: {
                                        x: b ? A[f].y[1] >= A[f].y[0] ? m : n : m + (n - m) / 2,
                                        y: b ? p + (g - p) / 2 : A[f].y[1] >= A[f].y[0] ? g : p
                                    },
                                    ...
                                    indexKeyword: 1,
                                    point: {
                                        x: b ? A[f].y[1] >= A[f].y[0] ? n : m : m + (n - m) / 2,
                                        y: b ? p + (g - p) / 2 : A[f].y[1] >= A[f].y[0] ? p : g
                                    },
                                    direction: A[f].y[1] >= A[f].y[0] ? 1 : -1,
                                    bounds: {
                                        x1: b ? Math.min(m, n) : m,
        ...
        t.prototype.renderRangeBar = function(a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var b = null,
                    e = this.plotArea,
                    h = 0,
                    q, f, E, k, h = this.options.dataPointMinWidth ? this.dataPointMinWidth : this.options.dataPointWidth ? this.dataPointWidth : 1;
                ...
                for (var n = 0; n < a.dataSeriesIndexes.length; n++) {
                    ...
                    if (0 < t.length) {
                        ...
                        for (h = 0; h < t.length; h++)
                            if (t[h].getTime ? k = t[h].x.getTime() : k = t[h].x, !(k < a.axisX.dataInfo.viewPortMin || k > a.axisX.dataInfo.viewPortMax) && !l(t[h].y) && t[h].y.length && "number" === typeof t[h].y[0] && "number" === typeof t[h].y[1]) {
                        ...
                        for (var K = !0; g < n.length; g++)
                            if (s = n[g].x.getTime ? n[g].x.getTime() : n[g].x, !(s < a.axisX.dataInfo.viewPortMin || s > a.axisX.dataInfo.viewPortMax && (!m.connectNullData || !K)))
                                if (null !== n[g].y && n[g].y.length && "number" === typeof n[g].y[0] && "number" === typeof n[g].y[1]) {
                                    ...
                                    p || K ? (m.connectNullData && !p ? (b.setLineDash && (m.options.nullDataLineDashType || B === m.lineDashType && m.lineDashType !== m.nullDataLineDashType) && (l[l.length - 1].newLineDashArray = J, B = m.nullDataLineDashType, b.setLineDash(G)), b.lineTo(t, x), r && e.lineTo(t, x), l.push({
                                        x: t,
                                        y1: x,
                                        y2: y
                                    })) : (b.beginPath(), b.moveTo(t, x), w = {
                                        x: t,
                                        y: x
                                    }, l = [], l.push({
                                        x: t,
                                        y1: x,
                                        y2: y
                                    }), r && (e.beginPath(), e.moveTo(t, x))), K = p = !1) : (b.lineTo(t, x), l.push({
                                        x: t,
                                        y1: x,
                                        y2: y
                                    }), r && e.lineTo(t, x), 0 == g % 250 && d());
                                    s = m.dataPointIds[g];
                                    this._eventManager.objectMap[s] = {
                                        id: s,
                                        objectType: "dataPoint",
                                    ...
                                    g < n.length - 1 && (A !== (n[g].lineColor || z) || B !== (n[g].lineDashType || m.lineDashType)) && (d(), A = n[g].lineColor || z, l[l.length - 1].newStrokeStyle = A, b.strokeStyle = A, b.setLineDash && (n[g].lineDashType ? (B = n[g].lineDashType, l[l.length - 1].newLineDashArray = I(B, m.lineThickness), b.setLineDash(l[l.length - 1].newLineDashArray)) : (B = m.lineDashType, l[l.length - 1].newLineDashArray = J, b.setLineDash(J))));
                ...
                if (0 < g.length) {
                    if (0 < k.lineThickness) {
                        ...
                        for (var d = 0; d < g.length - 3; d += 3) {
                            if (g[d].newStrokeStyle || g[d].newLineDashArray) b.stroke(), b.beginPath(), b.moveTo(g[d].x, g[d].y), g[d].newStrokeStyle && (b.strokeStyle = g[d].newStrokeStyle), g[d].newLineDashArray && b.setLineDash(g[d].newLineDashArray);
                    ...
                    if (0 < k.lineThickness) {
                        ...
                        for (var h = d = 0; d < g.length - 3; d += 3, h++) {
                            if (x[h].newStrokeStyle || x[h].newLineDashArray) b.stroke(), b.beginPath(), b.moveTo(g[d].x, g[d].y), x[h].newStrokeStyle && (b.strokeStyle = x[h].newStrokeStyle), x[h].newLineDashArray && b.setLineDash(x[h].newLineDashArray);
                            b.bezierCurveTo(g[d + 1].x, g[d + 1].y, g[d + 2].x, g[d + 2].y, g[d + 3].x, g[d + 3].y)
                        }
                        g = w(x, 2);
                        b.moveTo(g[0].x, g[0].y);
                        ...
                        for (g = !1; n < m.length; n++)
                            if (p = m[n].x.getTime ? m[n].x.getTime() : m[n].x, !(p < a.axisX.dataInfo.viewPortMin || p > a.axisX.dataInfo.viewPortMax && (!k.connectNullData || !g)))
                                if (null !== m[n].y && m[n].y.length && "number" === typeof m[n].y[0] && "number" === typeof m[n].y[1]) {
                                    ...
                                    n < m.length - 1 && (v !== (m[n].lineColor || C) || z !== (m[n].lineDashType || k.lineDashType)) && (v = m[n].lineColor || C, x[x.length - 1].newStrokeStyle = v, b.setLineDash && (m[n].lineDashType ? (z = m[n].lineDashType, x[x.length - 1].newLineDashArray = I(z, k.lineThickness)) : (z = k.lineDashType, x[x.length - 1].newLineDashArray = A)));
                                    ...
                                    g = !1
                                } else 0 < n && !g && (k.connectNullData ? b.setLineDash && (0 < x.length && (k.options.nullDataLineDashType || !m[n - 1].lineDashType)) && (x[x.length - 1].newLineDashArray = B, z = k.nullDataLineDashType) : (d(A, C), x = [], y = [])), g = !0;
                        d(A, C);
                        aa.drawMarkers(h)
                    }
                }
        ...
        t.prototype.renderWaterfall = function(a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var b = this._eventManager.ghostCtx,
                    ...
                    h = this.plotArea,
                    q = 0,
                    f, l, k, m, n = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0),
                    ...
                    if (0 < y.length)
                        for (var v = 5 < p && x.bevelEnabled ? !0 : !1, z = !1, A = null, B = null, q = 0; q < y.length; q++)
                            if (y[q].getTime ? m = y[q].x.getTime() : m = y[q].x, "number" !== typeof y[q].y) {
                                ...
                                var L, K = f;
                                L = "undefined" !== typeof y[q].isIntermediateSum && !0 === y[q].isIntermediateSum || "undefined" !== typeof y[q].isCumulativeSum && !0 === y[q].isCumulativeSum ? 0 < y[q].y ? l : k : 0 < y[q].y ? k : l;
                                0 < q && A && (!z || x.connectNullData) && (z && c.setLineDash && c.setLineDash(I(G, s)), c.beginPath(), c.moveTo(A, B - w), c.lineTo(K, L - w), 0 < s && c.stroke(), r && (b.beginPath(), b.moveTo(A, B - w), b.lineTo(K, L - w), 0 < s && b.stroke()));
                                z = !1;
                                A = J;
                                B = 0 < y[q].y ? l : k;
                                ...
                                (y[q].indexLabel || x.indexLabel || y[q].indexLabelFormatter || x.indexLabelFormatter) && this._indexLabels.push({
                                    chartType: "waterfall",
                                    dataPoint: y[q],
                                    dataSeries: x,
                                    point: {
        ...
        var X = function(a, d, c, b, e, h, q, f, l) {
            if (!(0 > c)) {
                ...
                a.save();
                a.globalAlpha = f;
                "pie" === e ? (a.beginPath(), a.moveTo(d.x, d.y), a.arc(d.x, d.y, c, h, q, !1), a.fillStyle = b, a.strokeStyle = "white", a.lineWidth = 2, a.closePath(), a.fill()) : "doughnut" === e && (a.beginPath(), a.arc(d.x, d.y, c, h, q, !1), 0 <= l && a.arc(d.x, d.y, l * c, q, h, !0), a.closePath(), a.fillStyle = b, a.strokeStyle = "white", a.lineWidth = 2, a.fill());
                a.globalAlpha = 1;
                a.restore()
            }
        };
            ...
            function d() {
                if (k && m) {
                    ...
                    for (var d = 0; d < m.length; d++) {
                        ...
                        if (k.indexLabelFormatter || h.indexLabelFormatter) u = {
                            chart: t.options,
                            dataSeries: k,
                            dataPoint: h,
                            total: n.total,
                        ...
                        n = h.indexLabelFormatter ? h.indexLabelFormatter(u) : h.indexLabel ? t.replaceKeywordsWithValue(h.indexLabel, h, k, d) : k.indexLabelFormatter ? k.indexLabelFormatter(u) : k.indexLabel ? t.replaceKeywordsWithValue(k.indexLabel, h, k, d) : h.label ? h.label : "";
                    ...
                    q = h = 0;
                    n = !1;
                    for (d = 0; d < m.length; d++) f = g[(c + d) % m.length], 1 < a && (f.midAngle > Math.PI / 2 - s && f.midAngle < Math.PI / 2 + s) && (h <= a / 2 && !n ? (f.hemisphere = "right", h++) : (f.hemisphere = "left", n = !0));
                    n = !1;
                    for (d = 0; d < m.length; d++) f = g[(e + d) % m.length], 1 < b && (f.midAngle > 3 * Math.PI / 2 - s && f.midAngle < 3 * Math.PI / 2 + s) && (q <= b / 2 && !n ? (f.hemisphere = "left", q++) : (f.hemisphere = "right", n = !0))
                }
            }
                        ...
                        for (var a = -1, c = -1, d = 0, h = !1, q = 0; q < m.length; q++)
                            if (h = !1, l = g[q], l.indexLabelText) {
                                ...
                                if (null !== f) {
                                    ...
                                    h && (0 < d && 0 <= a && 0 <= c) && (P(d, a, c), c = a = -1, d = 0)
                                }
                            } 0 < d && P(d, a, c)
                    })()
                }
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                if (0 !== z) {
                    ...
                    this.pieDoughnutClickHandler = function(a) {
                        t.isAnimating || !l(this.explodeOnClick) && !this.explodeOnClick || (a = a.dataPoint, a.exploded = a.exploded ? !1 : !0, 1 < this.dataPoints.length && t._animator.animate(0, 500, function(a) {
                            c(a, !0);
                            f();
                            t.dispatchEvent("dataAnimationIterationEnd", {
                                chart: t
                            });
                            t.dispatchEvent("dataAnimationEnd", {
                                chart: t
                            })
                        }))
                    };
                    ...
                    this._animator.animate(0, this.animatedRender ? this.animationDuration : 0, function(a) {
                        ...
                        1 <= a && t.dispatchEvent("dataAnimationEnd", {
                            chart: t
                        })
                    }, function() {
                        t.disableToolTip = !1;
        ...
        t.prototype.renderFunnel = function(a) {
            ...
            function c() {
                ...
                if (0 === h) return -1;
                for (var f = g[0] = 0, k = 0, l, m, b = b - a, f = !1, q = 0; q < C.length; q++) a = Math.abs(C[q].y) * d / h, f ? l = 0 == Number(c.toFixed(3)) ? 0 : a / c : (m = da * da * b * b - 4 * Math.abs(da) * a, 0 > m ? (m = c, f = (b + m) * (e - k) / 2, a -= f, l = e - k, k += e - k, l += 0 == m ? 0 : a / m, k += a / m, f = !0) : (l = (Math.abs(da) * b - Math.sqrt(m)) / 2, m = b - 2 * l / Math.abs(da), k += l, k > e && (k -= l, m = c, f = (b + m) * (e - k) / 2, a -= f, l = e - k, k += e - k, l += a / m, k += a / m, f = !0), b = m)), g.push(l);
                return g
            }

            function b() {
                if (s && C) {
                    for (var a, b, c, e, d, h, q, k, f, m, n, p, u, t, v, x, E, w = [], A = [], z = {
                            percent: null,
                            total: null
                        }, D = null, B = 0; B < C.length; B++) E = O[B], E = "undefined" !== typeof E.x5 ? (E.y2 + E.y4) / 2 : (E.y2 + E.y3) / 2, E = g(E).x2 + 1, w[B] = Q - (isNaN(E) ? 0 : E) - U;
                    E = 0.5 * U;
                    for (var B = 0, F = C.length - 1; B < C.length || 0 <= F; B++, F--) {
                        ...
                        v = s.dataPointIds[B];
                        y._eventManager.objectMap[v] = {
                            id: v,
                            objectType: "dataPoint",
                            dataPointIndex: B,
                            dataSeriesIndex: 0,
                            funnelSection: O[s.reversed ? C.length - 1 - B : B]
                        };
                        "inside" === s.indexLabelPlacement && (w[B] = B !== fa ? s.reversed ? O[B].x2 - O[B].x1 : O[B].x3 - O[B].x4 : O[B].x3 - O[B].x6, 20 > w[B] && (w[B] = B !== fa ? s.reversed ? O[B].x3 - O[B].x4 : O[B].x2 - O[B].x1 : O[B].x2 - O[B].x1, w[B] /= 2));
                        v = b.indexLabelMaxWidth ? b.indexLabelMaxWidth : s.options.indexLabelMaxWidth ? s.indexLabelMaxWidth : w[B];
                        if (v > w[B] || 0 > v) v = w[B];
                        A[B] = "inside" === s.indexLabelPlacement ? t ? Math.max(O[B].height, k) : 1.5 * k : !1;
                        ...
                        b = b.indexLabelFormatter ? b.indexLabelFormatter(D) : b.indexLabel ? y.replaceKeywordsWithValue(b.indexLabel, b, s, B) : s.indexLabelFormatter ? s.indexLabelFormatter(D) : s.indexLabel ? y.replaceKeywordsWithValue(s.indexLabel, b, s, B) : b.label ? b.label : "";
                        0 >= p && (p = 0);
            ...
            function e() {
                ...
                g = !1;
                c = 0;
                for (var h, q = Q - $ - U / 2, q = s.options.indexLabelMaxWidth ? s.indexLabelMaxWidth > q ? q : s.indexLabelMaxWidth : q, k = H.length - 1; 0 <= k; k--) {
                    h = C[H[k].id];
                    c = H[k];
                    e = c.textBlock;
                    b = (a = p(k) < O.length ? H[p(k)] : null) ? a.textBlock : null;
                    c = c.height;
                    a && e.y + c + ga > b.y && (g = !0);
            ...
            function h() {
                ...
                if ("inside" !== s.indexLabelPlacement)
                    ...
                    for (d = 0; d < O.length; d++) 0 == H[d].textBlock.text.length ? H[d].isDirty = !0 : (a = O[d], b = a.height, c = H[d].height, e = H[d].width, b >= c ? (b = d != fa ? (a.x4 + a.x3) / 2 - e / 2 : (a.x5 + a.x4) / 2 - e / 2, c = d != fa ? (a.y1 + a.y3) / 2 - c / 2 : (a.y1 + a.y4) / 2 - c / 2, H[d].textBlock.x = b, H[d].textBlock.y = c) : H[d].isDirty = !0)
            }
            ...
            function q() {
                function a(b, c) {
                    ...
                    d = f(b, e);
                    if (d >= c) return g.y += c, c;
                    if (b == O.length - 1) return 0 < d && (g.y += d), d;
                    d += a(e, c - d);
                    0 < d && (g.y += d);
                    return d
                }
                ...
                function b() {
                    ...
                    for (var q, f = 1; f < k; f++) {
                        e = f * g;
                        for (var m = H.length - 1; 0 <= m; m--) !H[m].isDirty && (H[m].textBlock.y < e && H[m].textBlock.y + H[m].height > e) && (q = p(m), !(q >= H.length - 1) && H[m].textBlock.y + H[m].height + ga > H[q].textBlock.y && (H[m].textBlock.y = H[m].textBlock.y + H[m].height - e > e - H[m].textBlock.y ? e + 1 : e - H[m].height - 1))
                    }
                ...
                for (var d, e, g, h, k, q, l = 1, m = 0; m < 2 * l; m++) {
                    for (var s = H.length - 1; 0 <= s && !(0 <= n(s) && n(s), g = H[s], h = g.textBlock, q = (k = p(s) < O.length ? H[p(s)] : null) ? k.textBlock : null, d = +g.height.toFixed(6), e = +h.y.toFixed(6), !g.isDirty && (k && e + d + ga > +q.y.toFixed(6)) && (d = h.y + d + ga - q.y, e = a(s, -d), e < d && (0 < e && (d -= e), e = a(p(s), d), e != d))); s--);
                    b()
                }
            }

            function f(a, b) {
                return (b < O.length ? H[b].textBlock.y : s.reversed ? V + z : ra + z) - (0 > a ? s.reversed ? ra - z : V - z : H[a].textBlock.y + H[a].height + ga)
            }

            function t(a, b, c) {
                var d, e, g, q = [],
                    f = z,
                    l = []; - 1 !== b && (0 <= X.indexOf(b) ? (e = X.indexOf(b), X.splice(e, 1)) : (X.push(b), X = X.sort(function(a, b) {
                    return a - b
                })));
                if (0 === X.length) q = ia;
                else {
                    e = z * (1 != X.length || 0 != X[0] && X[0] != O.length - 1 ? 2 : 1) / k();
                    for (var n = 0; n < O.length; n++) {
                        ...
                        q.push(ia[n] + d);
                        if (0 <= X.indexOf(n) || n < O.length && 0 <= X.indexOf(n + 1)) d += e
                    }
                }
                g = function() {
                    for (var a = [], b = 0; b < O.length; b++) a.push(q[b] - O[b].y1);
                    return a
                }();
                var p = {
                    ...
                    changeSection: function(a) {
                        for (var b, c, d = 0; d < O.length; d++) b = g[d], c = O[d], b *= a, "undefined" === typeof l[d] && (l[d] = 0), 0 > l && (l *= -1), c.y1 += b - l[d], c.y2 += b - l[d], c.y3 += b - l[d], c.y4 += b - l[d], c.y5 && (c.y5 += b - l[d], c.y6 += b - l[d]), l[d] = b
                    }
                };
                a._animator.animate(0, c, function(c) {
                    ...
                    for (e = 0; e < O.length; e++) pa(d, O[e], s.fillOpacity);
                    x(d);
            ...
            function m(a) {
                for (var b, c, d, e, h = 0; h < O.length; h++) e = 1 === H[h].lineThickness % 2 ? 0.5 : 0, c = ((O[h].y2 + O[h].y4) / 2 << 0) + e, b = g(c).x2 - 1, isNaN(b) && (Math.round(O[h].x1) === Math.round(O[h].x4) && Math.round(O[h].x2) === Math.round(O[h].x3)) && (b = O[h].x2), d = H[h].textBlock.x, e = (H[h].textBlock.y + H[h].height / 2 << 0) + e, H[h].isDirty || 0 == H[h].lineThickness || (a.strokeStyle = H[h].lineColor, a.lineWidth = H[h].lineThickness, a.setLineDash && a.setLineDash(I(H[h].lineDashType, H[h].lineThickness)), a.beginPath(), a.moveTo(b, c), a.lineTo(d, e), a.stroke())
            }
            ...
            function w(a) {
                for (var b = 0; b < O.length; b++) H[b].isDirty || (a && (H[b].textBlock.ctx = a), H[b].textBlock.y += H[b].textBlock._lineHeight / 2, H[b].textBlock.render(!0), H[b].textBlock.y -= H[b].textBlock._lineHeight / 2)
            }
            ...
            var y = this;
            if (!(0 >= a.dataSeriesIndexes.length)) {
                for (var s = this.data[a.dataSeriesIndexes[0]], C = s.dataPoints, v = this.plotArea, z = 0.025 * v.width, A = 0.01 * v.width, B = 0, G = v.height - 2 * z, J = Math.min(v.width - 2 * A, 2.8 * v.height), K = !1, L = 0; L < C.length; L++)
                    if (!K && ("undefined" !== typeof C[L].indexLabel && null !== C[L].indexLabel && 0 < C[L].indexLabel.toString().length) && (K = !0), !K && ("undefined" !== typeof C[L].label && null !== C[L].label && 0 < C[L].label.toString().length) && (K = !0), !K && "function" === typeof s.indexLabelFormatter || "function" === typeof C[L].indexLabelFormatter) K = !0;
                ...
                if (0 != s.length && (s.dataPoints && s.visible) && 0 !== C.length) {
                    ...
                    a = 75 * J / 100;
                    var U = 30 * (Q - a) / 100;
                    "funnel" === s.type ? (M = l(s.options.neckHeight) ? 0.35 * G : s.neckHeight, F = l(s.options.neckWidth) ? 0.25 * a : s.neckWidth, "string" === typeof M && M.match(/%$/) ? (M = parseInt(M), M = M * G / 100) : M = parseInt(M), "string" === typeof F && F.match(/%$/) ? (F = parseInt(F), F = F * a / 100) : F = parseInt(F), M > G ? M = G : 0 >= M && (M = 0), F > a ? F = a - 0.5 : 0 >= F && (F = 0)) : "pyramid" === s.type && (F = M = 0, s.reversed = s.reversed ? !1 : !0);
                    var A = L + a / 2,
                        Y = L,
                        $ = L + a,
                        V = s.reversed ? T : S,
                    ...
                    if (-1 !== J) {
                        if (s.reversed)
                            for (A.push(Z), F = J.length - 1; 0 < F; F--) Z += J[F], A.push(Math.round(Z));
                        else
                            for (F = 0; F < J.length; F++) Z += J[F], A.push(Math.round(Z));
                        if (s.reversed)
                            for (F = 0; F < J.length; F++) A[F] < Da ? (L.push(P), a.push(aa), fa = F) : (L.push((A[F] - V + da * Y) / da), a.push((A[F] - V + ha * $) / ha));
                        else
                            for (F = 0; F < J.length; F++) A[F] < Da ? (L.push((A[F] - V + da * Y) / da), a.push((A[F] - V + ha * $) / ha), fa = F) : (L.push(P), a.push(aa));
                        for (F = 0; F < J.length - 1; F++) Z = s.reversed ? C[C.length - 1 - F].color ? C[C.length - 1 - F].color : s._colorSet[(C.length - 1 - F) % s._colorSet.length] : C[F].color ? C[F].color : s._colorSet[F % s._colorSet.length], F === fa ? O.push({
                            x1: L[F],
                            y1: A[F],
                            x2: a[F],
                            y2: A[F],
                            ...
                            height: A[F + 1] - A[F],
                            color: Z
                        }), s.dataPointEOs[F] && O[F] && (s.dataPointEOs[F].sectionsofFunnel = O[F]);
                        var ga = 2,
                            H = [],
                            ja = !1,
                            X = [],
                        ...
                        if (K && s.visible && (b(), h(), "inside" !== s.indexLabelPlacement)) {
                            e();
                            q();
                            for (F = 0; F < C.length; F++) H[F].isDirty || (a = H[F].textBlock.x + H[F].width, a = (Q - a) / 2, 0 == F && (B = a), B > a && (B = a));
                            for (F = 0; F < O.length; F++) O[F].x1 += B, O[F].x2 += B, O[F].x3 += B, O[F].x4 += B, O[F].x5 && (O[F].x5 += B, O[F].x6 += B), H[F].textBlock.x += B
                        }
                        for (F = 0; F < O.length; F++) B = O[F], pa(N, B, s.fillOpacity), ia.push(B.y1);
                        x(N);
                        K && s.visible && ("inside" === s.indexLabelPlacement || y.animationEnabled || m(N), y.animationEnabled || w());
                        if (!K)
                            for (F = 0; F < C.length; F++) B = s.dataPointIds[F], a = {
                                id: B,
                                objectType: "dataPoint",
                                dataPointIndex: F,
                                dataSeriesIndex: 0,
                                funnelSection: O[s.reversed ? C.length - 1 - F : F]
        ...
        t.prototype.replaceKeywordsWithValue = function(a, d, c, b, e) {
            ...
            return a.replace(/\{.*?\}|"[^"]*"|'[^']*'/g, function(a) {
                ...
                g = g[a];
                null !== k && (g = g[k]);
                return "x" === a ? (c.axisX && "dateTime" === c.axisX.valueType || "dateTime" === c.xValueType || d.x && d.x.getTime) && !c.axisX.logarithmic ? Ca(g, d.xValueFormatString ? d.xValueFormatString : c.xValueFormatString ? c.xValueFormatString : c.xValueFormatString = h.axisX && h.axisX.autoValueFormatString ? h.axisX.autoValueFormatString : "DD MMM YY", h._cultureInfo) : ha(g, d.xValueFormatString ? d.xValueFormatString : c.xValueFormatString ? c.xValueFormatString : c.xValueFormatString = "#,##0.########", h._cultureInfo) : "y" === a ? ha(g, d.yValueFormatString ? d.yValueFormatString : c.yValueFormatString ? c.yValueFormatString : c.yValueFormatString = "#,##0.########", h._cultureInfo) : "z" === a ? ha(g, d.zValueFormatString ? d.zValueFormatString : c.zValueFormatString ? c.zValueFormatString : c.zValueFormatString = "#,##0.########", h._cultureInfo) : g
            })
        };
        oa(T, Y);
        T.prototype.setLayout = function() {
            ...
            var t = [],
                k = [];
            if ("top" === this.verticalAlign || "bottom" === this.verticalAlign) this.orientation = "horizontal", c = this.verticalAlign, h = this.maxWidth = null !== this.maxWidth ? this.maxWidth : d.width, q = this.maxHeight = null !== this.maxHeight ? this.maxHeight : 0.5 * d.height;
                    ...
                    if ("pie" !== n.type && "doughnut" !== n.type && "funnel" !== n.type && "pyramid" !== n.type) {
                        ...
                        for (var w = 0; w < n.dataPoints.length; w++) {
                            var v = n.dataPoints[w],
                                p = v.legendMarkerType ? v.legendMarkerType : n.legendMarkerType ? n.legendMarkerType : Q.getDefaultLegendMarker(n.type),
                                g = v.legendText ? v.legendText : n.legendText ? n.legendText : this.itemTextFormatter ? this.itemTextFormatter({
                                    chart: this.chart,
                                    legend: this.options,
                                    dataSeries: n,
                                    dataPoint: v
                                ...
                                s = v.legendMarkerBorderThickness ? v.legendMarkerBorderThickness : n.legendMarkerBorderThickness ? n.legendMarkerBorderThickness : v.markerBorderThickness || n.markerBorderThickness ? Math.max(1, Math.round(0.2 * x)) : 0,
                ...
                for (m = 0; m < t.length; m++) {
                    ...
                    if (!(0 >= q || "undefined" === typeof q || 0 >= r || "undefined" === typeof r))
                        if ("horizontal" === this.orientation) {
                            ...
                            if (!n || n.width + Math.round(p.textBlock.width + x + f + (0 === n.width ? 0 : this.horizontalSpacing) + ("line" === p.chartType || "spline" === p.chartType || "stepLine" === p.chartType ? 2 * 0.1 * this.lineHeight : 0)) > h) n = {
                                items: [],
                                width: 0
                            ...
                            p.textBlock.y = 0;
                            n.width += Math.round(p.textBlock.width + x + f + (0 === n.width ? 0 : this.horizontalSpacing) + ("line" === p.chartType || "spline" === p.chartType || "stepLine" === p.chartType ? 2 * 0.1 * this.lineHeight : 0));
                            n.items.push(p);
                            this.width = Math.max(n.width, this.width)
                        } else p.textBlock = new ka(this.ctx, {
                            x: 0,
                            y: 0,
                            maxWidth: v,
                            ...
                            fontStyle: this.fontStyle,
                            textBaseline: "middle"
                        }), p.textBlock.measureText(), null !== this.itemWidth && (p.textBlock.width = this.itemWidth - (x + f + ("line" === p.chartType || "spline" === p.chartType || "stepLine" === p.chartType ? 2 * 0.1 * this.lineHeight : 0))), this.height < q - this.lineHeight ? (n = {
                            items: [],
                            width: 0
                        }, k.push(n)) : (n = k[w], w = (w + 1) % k.length), n && (this.height += p.textBlock.height ? p.textBlock.height : this.lineHeight, p.textBlock.x = n.width, p.textBlock.y = 0, n.width += Math.round(p.textBlock.width + x + f + (0 === n.width ? 0 : this.horizontalSpacing) + ("line" === p.chartType || "spline" === p.chartType || "stepLine" === p.chartType ? 2 * 0.1 * this.lineHeight : 0)), n.items.push(p), this.width = Math.max(n.width, this.width))
                }
            ...
            this.items = t;
            for (m = 0; m < this.items.length; m++) p = t[m], p.id = ++this.chart._eventManager.lastObjectId, this.chart._eventManager.objectMap[p.id] = {
                id: p.id,
        ...
        T.prototype.render = function() {
            ...
            for (var f = 0, l = 0; l < q.length; l++) {
                for (var k = q[l], m = 0, n = 0; n < k.items.length; n++) {
                    ...
                    this.ctx.clip();
                    if ("line" === p.chartType || "stepLine" === p.chartType || "spline" === p.chartType) this.ctx.strokeStyle = p.lineColor, this.ctx.lineWidth = Math.ceil(this.lineHeight / 8), this.ctx.beginPath(), this.ctx.moveTo(g - 0.1 * this.lineHeight, t + this.lineHeight / 2), this.ctx.lineTo(g + 0.85 * this.lineHeight, t + this.lineHeight / 2), this.ctx.stroke(), r -= 0.1 * this.lineHeight;
                    ...
                    aa.drawMarker(g + h / 2, t + this.lineHeight / 2, this.ctx, p.markerType, "error" === p.chartType || "line" === p.chartType || "spline" === p.chartType ? p.markerSize / 2 : p.markerSize, p.markerColor, p.markerBorderColor, p.markerBorderThickness);
                    p.textBlock.x = g + c + h;
        ...
        Q.prototype.getDataPointAtX = function(a, d) {
            ...
            for (;;) {
                ...
                } else if (0 > m - e && m + e >= this.dataPoints.length) break; - 1 === q ? (e++, q = 1) : q = -1
            }
        ...
        Q.prototype.getDataPointAtXY = function(a, d, c) {
            ...
            for (;;) {
                    ...
                    if (p) {
                        switch (this.type) {
                            ...
                            case "doughnut":
                                ...
                                r < p.radius && r > y && (r = Math.atan2(d - x.y, a - x.x), 0 > r && (r += 2 * Math.PI), r = Number(((180 * (r / Math.PI) % 360 + 360) % 360).toFixed(12)), x = Number(((180 * (p.startAngle / Math.PI) % 360 + 360) % 360).toFixed(12)), y = Number(((180 * (p.endAngle / Math.PI) % 360 + 360) % 360).toFixed(12)), 0 === y && 1 < p.endAngle && (y = 360), x >= y && (0 !== g.y && !l(g.y)) && (y += 360, r < x && (r += 360)), r > x && r < y && (b.push({
                                    dataPoint: g,
                                    dataPointIndex: h,
                                    dataSeries: this,
                                    distance: 0
                            ...
                            case "pyramid":
                                r = p.funnelSection;
                                d > r.y1 && d < r.y4 && (r.y6 ? d > r.y6 ? (h = r.x6 + (r.x5 - r.x6) / (r.y5 - r.y6) * (d - r.y6), r = r.x3 + (r.x4 - r.x3) / (r.y4 - r.y3) * (d - r.y3)) : (h = r.x1 + (r.x6 - r.x1) / (r.y6 - r.y1) * (d - r.y1), r = r.x2 + (r.x3 - r.x2) / (r.y3 - r.y2) * (d - r.y2)) : (h = r.x1 + (r.x4 - r.x1) / (r.y4 - r.y1) * (d - r.y1), r = r.x2 + (r.x3 - r.x2) / (r.y3 - r.y2) * (d - r.y2)), a > h && a < r && (b.push({
                                    dataPoint: g,
                                    dataPointIndex: p.dataPointIndex,
                                    dataSeries: this,
                                    distance: 0
                ...
                } else if (0 > n - e && n + e >= this.dataPoints.length) break; - 1 === q ? (e++, q = 1) : q = -1
            }
            a = null;
        ...
        A.prototype.createLabels = function() {
            ...
            if ("axisX" !== this.type || "dateTime" !== this.valueType || this.logarithmic) {
                ...
                for (this.intervalStartPosition = this.getLabelStartPoint(new Date(this.viewportMinimum), this.intervalType, this.interval), e = Za(new Date(this.viewportMaximum), this.interval, this.intervalType), g = p, c = this.intervalStartPosition; c < e; Za(c, b, this.intervalType)) {
                    ...
                    if (h = Math.floor(0.9 * u), p = 0, !this.chart.panEnabled && 1 <= this._labels.length) {
                        ...
                        for (c = 0; c < this._labels.length; c++)
                            if (!this._labels[c].breaksLabelType) {
                                ...
                                for (var x, g = a.text.split(" "), b = 0; b < g.length; b++) m = g[b], this.ctx.font = a.fontStyle + " " + a.fontWeight + " " + a.fontSize + "px " + a.fontFamily, m = this.ctx.measureText(m), m.width > p && (x = c, p = m.width)
                            } c = 0;
                        for (c = this.intervalStartPosition < this.viewportMinimum ? 1 : 0; c < this._labels.length; c++)
                            if (!this._labels[c].breaksLabelType) {
                                ...
                                if (l(this.options.labelAngle) && isNaN(this.options.labelAngle) && 0 !== this.options.labelAngle)
                                    if (this.sessionVariables.labelMaxHeight = 0 === this.labelAngle ? f : Math.min((b - h * Math.cos(Math.PI / 180 * Math.abs(this.labelAngle))) / Math.sin(Math.PI / 180 * Math.abs(this.labelAngle)), b), m = (k - (t + a.fontSize / 2) * Math.cos(Math.PI / 180 * Math.abs(-25))) / Math.sin(Math.PI / 180 * Math.abs(-25)), !l(this.options.labelWrap)) this.labelWrap ? l(this.options.labelMaxWidth) ? (this.sessionVariables.labelMaxWidth = Math.min(Math.max(h, p), m), this.sessionVariables.labelWrap = this.labelWrap, d && w.width + d.width >> 0 > 2 * h && (this.sessionVariables.labelAngle = -25)) : (this.sessionVariables.labelWrap = this.labelWrap, this.sessionVariables.labelMaxWidth = this.options.labelMaxWidth, this.sessionVariables.labelAngle = this.sessionVariables.labelMaxWidth > h ? -25 : this.sessionVariables.labelAngle) : l(this.options.labelMaxWidth) ? (this.sessionVariables.labelWrap = this.labelWrap, this.sessionVariables.labelMaxHeight = f, this.sessionVariables.labelMaxWidth = h, d && w.width + d.width >> 0 > 2 * h && (this.sessionVariables.labelAngle = -25, this.sessionVariables.labelMaxWidth = m)) : (this.sessionVariables.labelAngle = this.sessionVariables.labelMaxWidth > h ? -25 : this.sessionVariables.labelAngle, this.sessionVariables.labelMaxWidth = this.options.labelMaxWidth, this.sessionVariables.labelMaxHeight = f, this.sessionVariables.labelWrap = this.labelWrap);
                                    else {
                                        if (l(this.options.labelWrap))
                                            if (!l(this.options.labelMaxWidth)) this.options.labelMaxWidth < h ? (this.sessionVariables.labelMaxWidth = this.options.labelMaxWidth, this.sessionVariables.labelMaxHeight = b) : (this.sessionVariables.labelAngle = -25, this.sessionVariables.labelMaxWidth = this.options.labelMaxWidth, this.sessionVariables.labelMaxHeight = f);
                                            else if (!l(d))
                                            if (b = w.width + d.width >> 0, g = this.labelFontSize, p < h) b - 2 * h > n && (n = b - 2 * h, b >= 2 * h && b < 2.2 * h ? (this.sessionVariables.labelMaxWidth = h, l(this.options.labelFontSize) && 12 < g && (g = Math.floor(12 / 13 * g), a.measureText()), this.sessionVariables.labelFontSize = l(this.options.labelFontSize) ? g : this.options.labelFontSize, this.sessionVariables.labelAngle = this.labelAngle) : b >= 2.2 * h && b < 2.8 * h ? (this.sessionVariables.labelAngle = -25, this.sessionVariables.labelMaxWidth = m, this.sessionVariables.labelFontSize = g) : b >= 2.8 * h && b < 3.2 * h ? (this.sessionVariables.labelMaxWidth = Math.max(h, p), this.sessionVariables.labelWrap = !0, l(this.options.labelFontSize) && 12 < this.labelFontSize && (this.labelFontSize = Math.floor(12 / 13 * this.labelFontSize), a.measureText()), this.sessionVariables.labelFontSize = l(this.options.labelFontSize) ? g : this.options.labelFontSize, this.sessionVariables.labelAngle = this.labelAngle) : b >= 3.2 * h && b < 3.6 * h ? (this.sessionVariables.labelAngle = -25, this.sessionVariables.labelWrap = !0, this.sessionVariables.labelMaxWidth = m, this.sessionVariables.labelFontSize = this.labelFontSize) : b > 3.6 * h && b < 5 * h ? (l(this.options.labelFontSize) && 12 < g && (g = Math.floor(12 / 13 * g), a.measureText()), this.sessionVariables.labelFontSize = l(this.options.labelFontSize) ? g : this.options.labelFontSize, this.sessionVariables.labelWrap = !0, this.sessionVariables.labelAngle = -25, this.sessionVariables.labelMaxWidth = m) : b > 5 * h && (this.sessionVariables.labelWrap = !0, this.sessionVariables.labelMaxWidth = h, this.sessionVariables.labelFontSize = g, this.sessionVariables.labelMaxHeight = f, this.sessionVariables.labelAngle = this.labelAngle));
                                            else if (x === c && (0 === x && p + this._labels[x + 1].textBlock.measureText().width - 2 * h > n || x === this._labels.length - 1 && p + this._labels[x - 1].textBlock.measureText().width - 2 * h > n || 0 < x && x < this._labels.length - 1 && p + this._labels[x + 1].textBlock.measureText().width - 2 * h > n && p + this._labels[x - 1].textBlock.measureText().width - 2 * h > n)) n = 0 === x ? p + this._labels[x + 1].textBlock.measureText().width - 2 * h : p + this._labels[x - 1].textBlock.measureText().width - 2 * h, this.sessionVariables.labelFontSize = l(this.options.labelFontSize) ? g : this.options.labelFontSize, this.sessionVariables.labelWrap = !0, this.sessionVariables.labelAngle = -25, this.sessionVariables.labelMaxWidth = m;
                                        else if (0 === n)
                                            for (this.sessionVariables.labelFontSize = l(this.options.labelFontSize) ? g : this.options.labelFontSize, this.sessionVariables.labelWrap = !0, b = 0; b < this._labels.length; b++) a = this._labels[b].textBlock, a.maxWidth = this.sessionVariables.labelMaxWidth = Math.min(Math.max(h, p), m), w = a.measureText(), b < this._labels.length - 1 && (g = b + 1, d = this._labels[g].textBlock, d.maxWidth = this.sessionVariables.labelMaxWidth = Math.min(Math.max(h, p), m), d = d.measureText(), w.width + d.width >> 0 > 2 * h && (this.sessionVariables.labelAngle = -25))
                                    }
                                else(this.sessionVariables.labelAngle = this.labelAngle, this.sessionVariables.labelMaxHeight = 0 === this.labelAngle ? f : Math.min((b - h * Math.cos(Math.PI / 180 * Math.abs(this.labelAngle))) / Math.sin(Math.PI / 180 * Math.abs(this.labelAngle)), b), m = 0 != this.labelAngle ? (k - (t + a.fontSize / 2) * Math.cos(Math.PI / 180 * Math.abs(this.labelAngle))) / Math.sin(Math.PI / 180 * Math.abs(this.labelAngle)) : h, this.sessionVariables.labelMaxHeight = this.labelWrap ? (k - m * Math.sin(Math.PI / 180 * Math.abs(this.labelAngle))) / Math.cos(Math.PI / 180 * Math.abs(this.labelAngle)) : 1.5 * this.labelFontSize, l(this.options.labelWrap)) ? l(this.options.labelWrap) && (this.labelWrap && !l(this.options.labelMaxWidth) ? (this.sessionVariables.labelWrap = this.labelWrap, this.sessionVariables.labelMaxWidth = this.options.labelMaxWidth ? this.options.labelMaxWidth : m, this.sessionVariables.labelMaxHeight = f) : (this.sessionVariables.labelAngle = this.labelAngle, this.sessionVariables.labelMaxWidth = m, this.sessionVariables.labelMaxHeight = b < 0.9 * u ? 0.9 * u : b, this.sessionVariables.labelWrap = this.labelWrap)) : (this.options.labelWrap ? (this.sessionVariables.labelWrap = this.labelWrap, this.sessionVariables.labelMaxWidth = this.options.labelMaxWidth ? this.options.labelMaxWidth : m) : (l(this.options.labelMaxWidth), this.sessionVariables.labelMaxWidth = this.options.labelMaxWidth ? this.options.labelMaxWidth : m, this.sessionVariables.labelWrap = this.labelWrap), this.sessionVariables.labelMaxHeight = f)
                        ...
                        for (c = 0; c < this._labels.length; c++) a = this._labels[c].textBlock, a.maxWidth = this.labelMaxWidth = l(this.options.labelMaxWidth) ? l(this.sessionVariables.labelMaxWidth) ? this.sessionVariables.labelMaxWidth = h : this.sessionVariables.labelMaxWidth : this.options.labelMaxWidth, a.fontSize = this.labelFontSize = l(this.options.labelFontSize) ? l(this.sessionVariables.labelFontSize) ? this.sessionVariables.labelFontSize = this.labelFontSize : this.sessionVariables.labelFontSize : this.options.labelFontSize, a.angle = this.labelAngle = l(this.options.labelAngle) ? l(this.sessionVariables.labelAngle) ? this.sessionVariables.labelAngle = this.labelAngle : this.sessionVariables.labelAngle : this.labelAngle, a.wrap = this.labelWrap = l(this.options.labelWrap) ? l(this.sessionVariables.labelWrap) ? this.sessionVariables.labelWrap = this.labelWrap : this.sessionVariables.labelWrap : this.options.labelWrap, a.maxHeight = l(this.sessionVariables.labelMaxHeight) ? this.sessionVariables.labelMaxHeight = f : this.sessionVariables.labelMaxHeight, a.measureText();
            else if ("left" === this._position || "right" === this._position)
                if (h = l(this.options.labelMaxWidth) ? 0.3 * this.chart.width >> 0 : this.options.labelMaxWidth, f = "undefined" === typeof this.options.labelWrap || this.labelWrap ? 0.3 * this.chart.height >> 0 : 1.5 * this.labelFontSize, !this.chart.panEnabled && 1 <= this._labels.length) {
                    this.sessionVariables.labelFontSize = this.labelFontSize;
                    this.sessionVariables.labelMaxWidth = h;
                    this.sessionVariables.labelMaxHeight = f;
                    ...
                    for (c = 0; c < this._labels.length; c++)
                        if (!this._labels[c].breaksLabelType) {
                            ...
                            Math.cos(Math.PI / 180 * Math.abs(this.labelAngle));
                            Math.sin(Math.PI / 180 * Math.abs(this.labelAngle));
                            l(this.options.labelAngle) && isNaN(this.options.labelAngle) && 0 !== this.options.labelAngle ? l(this.options.labelWrap) ? l(this.options.labelWrap) && (l(this.options.labelMaxWidth) ? l(d) || (u = w.height + d.height >> 0, u - 2 * f > p && (p = u - 2 * f, u >= 2 * f && u < 2.4 * f ? (l(this.options.labelFontSize) && 12 < this.labelFontSize && (this.labelFontSize = Math.floor(12 / 13 * this.labelFontSize), a.measureText()), this.sessionVariables.labelMaxHeight = f, this.sessionVariables.labelFontSize = l(this.options.labelFontSize) ? this.labelFontSize : this.options.labelFontSize) : u >= 2.4 * f && u < 2.8 * f ? (this.sessionVariables.labelMaxHeight = b, this.sessionVariables.labelFontSize = this.labelFontSize, this.sessionVariables.labelWrap = !0) : u >= 2.8 * f && u < 3.2 * f ? (this.sessionVariables.labelMaxHeight = f, this.sessionVariables.labelWrap = !0, l(this.options.labelFontSize) && 12 < this.labelFontSize && (this.labelFontSize = Math.floor(12 / 13 * this.labelFontSize), a.measureText()), this.sessionVariables.labelFontSize = l(this.options.labelFontSize) ? this.labelFontSize : this.options.labelFontSize, this.sessionVariables.labelAngle = l(this.sessionVariables.labelAngle) ? 0 : this.sessionVariables.labelAngle) : u >= 3.2 * f && u < 3.6 * f ? (this.sessionVariables.labelMaxHeight = b, this.sessionVariables.labelWrap = !0, this.sessionVariables.labelFontSize = this.labelFontSize) : u > 3.6 * f && u < 10 * f ? (l(this.options.labelFontSize) && 12 < this.labelFontSize && (this.labelFontSize = Math.floor(12 / 13 * this.labelFontSize), a.measureText()), this.sessionVariables.labelFontSize = l(this.options.labelFontSize) ? this.labelFontSize : this.options.labelFontSize, this.sessionVariables.labelMaxWidth = h, this.sessionVariables.labelMaxHeight = f, this.sessionVariables.labelAngle = l(this.sessionVariables.labelAngle) ? 0 : this.sessionVariables.labelAngle) : u > 10 * f && u < 50 * f && (l(this.options.labelFontSize) && 12 < this.labelFontSize && (this.labelFontSize = Math.floor(12 / 13 * this.labelFontSize), a.measureText()), this.sessionVariables.labelFontSize = l(this.options.labelFontSize) ? this.labelFontSize : this.options.labelFontSize, this.sessionVariables.labelMaxHeight = f, this.sessionVariables.labelMaxWidth = h, this.sessionVariables.labelAngle = l(this.sessionVariables.labelAngle) ? 0 : this.sessionVariables.labelAngle))) : (this.sessionVariables.labelMaxHeight = f, this.sessionVariables.labelMaxWidth = this.options.labelMaxWidth ? this.options.labelMaxWidth : this.sessionVariables.labelMaxWidth)) : (this.sessionVariables.labelMaxWidth = this.labelWrap ? this.options.labelMaxWidth ? this.options.labelMaxWidth : this.sessionVariables.labelMaxWidth : this.labelMaxWidth ? this.options.labelMaxWidth ? this.options.labelMaxWidth : this.sessionVariables.labelMaxWidth : h, this.sessionVariables.labelMaxHeight = f) : (this.sessionVariables.labelAngle = this.labelAngle, this.sessionVariables.labelMaxWidth = 0 === this.labelAngle ? h : Math.min((b - f * Math.sin(Math.PI / 180 * Math.abs(this.labelAngle))) / Math.cos(Math.PI / 180 * Math.abs(this.labelAngle)), f), l(this.options.labelWrap)) ? l(this.options.labelWrap) && (this.labelWrap && !l(this.options.labelMaxWidth) ? (this.sessionVariables.labelMaxWidth = this.options.labelMaxWidth ? this.options.labelMaxWidth : this.sessionVariables.labelMaxWidth, this.sessionVariables.labelWrap = this.labelWrap, this.sessionVariables.labelMaxHeight = b) : (this.sessionVariables.labelMaxWidth = this.options.labelMaxWidth ? this.options.labelMaxWidth : h, this.sessionVariables.labelMaxHeight = 0 === this.labelAngle ? f : b, l(this.options.labelMaxWidth) && (this.sessionVariables.labelAngle = this.labelAngle))) : this.options.labelWrap ? (this.sessionVariables.labelMaxHeight = 0 === this.labelAngle ? f : b, this.sessionVariables.labelWrap = this.labelWrap, this.sessionVariables.labelMaxWidth = h) : (this.sessionVariables.labelMaxHeight = f, l(this.options.labelMaxWidth), this.sessionVariables.labelMaxWidth = this.options.labelMaxWidth ? this.options.labelMaxWidth : this.sessionVariables.labelMaxWidth, this.sessionVariables.labelWrap = this.labelWrap)
                        } for (b = 0; b < this._labels.length; b++) a = this._labels[b].textBlock, a.maxWidth = this.labelMaxWidth = this.sessionVariables.labelMaxWidth, a.fontSize = this.labelFontSize = this.sessionVariables.labelFontSize, a.angle = this.labelAngle = this.sessionVariables.labelAngle, a.wrap = this.labelWrap = this.sessionVariables.labelWrap, a.maxHeight = this.sessionVariables.labelMaxHeight, a.measureText()
                } else
                    for (l(this.chart.stockChart) || this.chart.isNavigator || (this.sessionVariables.labelMaxHeight = f), c = 0; c < this._labels.length; c++) a = this._labels[c].textBlock, a.maxWidth = this.labelMaxWidth = l(this.options.labelMaxWidth) ? l(this.sessionVariables.labelMaxWidth) ? this.sessionVariables.labelMaxWidth = h : this.sessionVariables.labelMaxWidth : this.options.labelMaxWidth, a.fontSize = this.labelFontSize = l(this.options.labelFontSize) ? l(this.sessionVariables.labelFontSize) ? this.sessionVariables.labelFontSize = this.labelFontSize : this.sessionVariables.labelFontSize : this.options.labelFontSize, a.angle = this.labelAngle = l(this.options.labelAngle) ? l(this.sessionVariables.labelAngle) ? this.sessionVariables.labelAngle = this.labelAngle : this.sessionVariables.labelAngle : this.labelAngle, a.wrap = this.labelWrap = l(this.options.labelWrap) ? l(this.sessionVariables.labelWrap) ? this.sessionVariables.labelWrap = this.labelWrap : this.sessionVariables.labelWrap : this.options.labelWrap, a.maxHeight = l(this.sessionVariables.labelMaxHeight) ? this.sessionVariables.labelMaxHeight = f : this.sessionVariables.labelMaxHeight, a.measureText();
        ...
        A.setLayout = function(a, d, c, b, e, h) {
            var f, u, r, k, m = a[0] ? a[0].chart : d[0].chart,
            ...
            for (g = 0; g < p.length; g++)
                if (p[g] && p[g].scaleBreaks && p[g].scaleBreaks._appliedBreaks.length)
                    for (var t = p[g].scaleBreaks._appliedBreaks, x = 0; x < t.length && !(t[x].startValue > p[g].viewportMaximum); x++) t[x].endValue < p[g].viewportMinimum || (l(p[g].scaleBreaks.firstBreakIndex) && (p[g].scaleBreaks.firstBreakIndex = x), t[x].startValue >= p[g].viewPortMinimum && (p[g].scaleBreaks.lastBreakIndex = x));
            for (var y = x = 0, s = 0, w = 0, v = 0, A = 0, z = 0, B, G, I = u = 0, J, L, M, t = J = L = M = !1, g = 0; g < p.length; g++) p[g] && p[g].title && (p[g]._titleTextBlock = new ka(p[g].ctx, {
                text: p[g].title,
            ...
            if ("normal" === e) {
                for (var w = [], v = [], A = [], z = [], R = [], S = [], N = [], Q = []; 4 > x;) {
                    var F = 0,
                        ...
                        aa = 0;
                    if (c && 0 < c.length)
                        for (A = [], g = O = 0; g < c.length; g++) A.push(Math.ceil(c[g] ? c[g].createLabelsAndCalculateWidth() : 0)), O += A[g], P += c[g] && !m.isNavigator ? c[g].margin : 0;
                    else A.push(Math.ceil(c[0] ? c[0].createLabelsAndCalculateWidth() : 0));
                    N.push(A);
                    if (b && 0 < b.length)
                        for (z = [], g = aa = 0; g < b.length; g++) z.push(Math.ceil(b[g] ? b[g].createLabelsAndCalculateWidth() : 0)), aa += z[g], $ += b[g] ? b[g].margin : 0;
                    else z.push(Math.ceil(b[0] ? b[0].createLabelsAndCalculateWidth() : 0));
                    Q.push(z);
                    f = Math.round(h.x1 + O + P);
                    r = Math.round(h.x2 - aa - $ > m.width - n ? m.width - n : h.x2 - aa - $);
                    if (a && 0 < a.length)
                        for (w = [], g = X = 0; g < a.length; g++) a[g] && (a[g].lineCoordinates = {}), a[g].lineCoordinates.width = Math.abs(r - f), a[g].title && (a[g]._titleTextBlock.maxWidth = 0 < a[g].titleMaxWidth && a[g].titleMaxWidth < a[g].lineCoordinates.width ? a[g].titleMaxWidth : a[g].lineCoordinates.width), w.push(Math.ceil(a[g] ? a[g].createLabelsAndCalculateHeight() : 0)), X += w[g], e += a[g] && !m.isNavigator ? a[g].margin : 0;
                    else w.push(Math.ceil(a[0] ? a[0].createLabelsAndCalculateHeight() : 0));
                    R.push(w);
                    if (d && 0 < d.length)
                        for (v = [], g = Z = 0; g < d.length; g++) d[g] && (d[g].lineCoordinates = {}), d[g].lineCoordinates.width = Math.abs(r - f), d[g].title && (d[g]._titleTextBlock.maxWidth = 0 < d[g].titleMaxWidth && d[g].titleMaxWidth < d[g].lineCoordinates.width ? d[g].titleMaxWidth : d[g].lineCoordinates.width), v.push(Math.ceil(d[g] ? d[g].createLabelsAndCalculateHeight() : 0)), Z += v[g], Y += d[g] && !m.isNavigator ? d[g].margin : 0;
                    else v.push(Math.ceil(d[0] ? d[0].createLabelsAndCalculateHeight() : 0));
                    S.push(v);
                    if (a && 0 < a.length)
                        for (g = 0; g < a.length; g++) a[g] && (a[g].lineCoordinates.x1 = f, r = Math.round(h.x2 - aa - $ > m.width - n ? m.width - n : h.x2 - aa - $), a[g]._labels && 1 < a[g]._labels.length && (u = k = 0, k = a[g]._labels[1], u = "dateTime" === a[g].valueType ? a[g]._labels[a[g]._labels.length - 2] : a[g]._labels[a[g]._labels.length - 1], y = k.textBlock.width * Math.cos(Math.PI / 180 * Math.abs(k.textBlock.angle)) + (k.textBlock.height - u.textBlock.fontSize / 2) * Math.sin(Math.PI / 180 * Math.abs(k.textBlock.angle)), s = u.textBlock.width * Math.cos(Math.PI / 180 * Math.abs(u.textBlock.angle)) + (u.textBlock.height - u.textBlock.fontSize / 2) * Math.sin(Math.PI / 180 * Math.abs(u.textBlock.angle))), !a[g] || (!a[g].labelAutoFit || l(B) || l(G) || m.isNavigator || m.stockChart) || (u = 0, 0 < a[g].labelAngle ? G + s > r && (a[g].convertPixelToValue(G) >= a[g].viewportMinimum && a[g].convertPixelToValue(G) <= a[g].viewportMaximum) && (u += 0 < a[g].labelAngle ? G + s - r - aa : 0) : 0 > a[g].labelAngle ? B - y < f && B - y < a[g].viewportMinimum && (I = f - (P + a[g].tickLength + A + B - y + a[g].labelFontSize / 2)) : 0 === a[g].labelAngle && (G + s > r && (a[g].convertPixelToValue(G) >= a[g].viewportMinimum && a[g].convertPixelToValue(G) <= a[g].viewportMaximum) && (u = G + s / 2 - r - aa), B - y < f && B - y < a[g].viewportMinimum && (I = f - P - a[g].tickLength - A - B + y / 2)), a[g].viewportMaximum === a[g].maximum && a[g].viewportMinimum === a[g].minimum && 0 < a[g].labelAngle && 0 < u ? r -= u : a[g].viewportMaximum === a[g].maximum && a[g].viewportMinimum === a[g].minimum && 0 > a[g].labelAngle && 0 < I ? f += I : a[g].viewportMaximum === a[g].maximum && a[g].viewportMinimum === a[g].minimum && 0 === a[g].labelAngle && (0 < I && (f += I), 0 < u && (r -= u))), m.panEnabled ? X = l(m.sessionVariables.axisX.height) || m.stockChart ? m.sessionVariables.axisX.height = X : m.sessionVariables.axisX.height : m.sessionVariables.axisX.height = X, u = Math.round(h.y2 - X - e + F), k = Math.round(h.y2), a[g].lineCoordinates.x2 = r, a[g].lineCoordinates.width = r - f, a[g].lineCoordinates.y1 = u, a[g].lineCoordinates.y2 = u, "inside" === a[g].labelPlacement && 0 < g && (a[g].lineCoordinates.y1 = a[0].lineCoordinates.y2 + F + (a[g].labelEffectiveHeight || 0), a[g].lineCoordinates.y2 = a[g].lineCoordinates.y1 + a[g].lineThickness / 2), "inside" === a[g].tickPlacement && 0 < g && (a[g].lineCoordinates.y1 += a[g].tickLength, a[g].lineCoordinates.y2 = a[g].lineCoordinates.y1 + a[g].lineThickness / 2), a[g].bounds = {
                            x1: f,
                            y1: u,
                            x2: r,
                            y2: k - (X + e - w[g] - F),
                            width: r - f
                        }, a[g].bounds.height = a[g].bounds.y2 - a[g].bounds.y1), F += w[g] + a[g].margin;
                    if (d && 0 < d.length)
                        for (g = 0; g < d.length; g++) d[g].lineCoordinates.x1 = Math.round(h.x1 + O + P), d[g].lineCoordinates.x2 = r ? r : Math.round(h.x2 - aa - $ > m.width - n ? m.width - n : h.x2 - aa - $), d[g].lineCoordinates.width = Math.abs(r - f), d[g]._labels && 1 < d[g]._labels.length && (k = d[g]._labels[1], u = "dateTime" === d[g].valueType ? d[g]._labels[d[g]._labels.length - 2] : d[g]._labels[d[g]._labels.length - 1], y = k.textBlock.width * Math.cos(Math.PI / 180 * Math.abs(k.textBlock.angle)) + (k.textBlock.height - u.textBlock.fontSize / 2) * Math.sin(Math.PI / 180 * Math.abs(k.textBlock.angle)), s = u.textBlock.width * Math.cos(Math.PI / 180 * Math.abs(u.textBlock.angle)) + (u.textBlock.height - u.textBlock.fontSize / 2) * Math.sin(Math.PI / 180 * Math.abs(u.textBlock.angle))), m.panEnabled ? Z = l(m.sessionVariables.axisX2.height) || m.stockChart ? m.sessionVariables.axisX2.height = Z : m.sessionVariables.axisX2.height : m.sessionVariables.axisX2.height = Z, u = Math.round(h.y1), k = d[g].lineCoordinates.y1 = u + Z + Y - T, d[g].lineCoordinates.y2 = u, "inside" === d[g].labelPlacement && 0 < g && (d[g].lineCoordinates.y1 = d[0].lineCoordinates.y1 - T - (d[g].labelEffectiveHeight || 0) - 5), "inside" === d[g].tickPlacement && 0 < g && (d[g].lineCoordinates.y1 -= d[g].tickLength), d[g].bounds = {
                            x1: f,
                            y1: u + (Z + Y - ("inside" === d[g].labelPlacement && 0 === g ? v[g] - 5 : v[g]) - T),
                            x2: r,
                            y2: k,
                            width: r - f
                        }, d[g].bounds.height = d[g].bounds.y2 - d[g].bounds.y1, T += ("inside" === d[g].labelPlacement && 0 === g ? v[g] - 5 : v[g]) + d[g].margin;
                    if (c && 0 < c.length)
                        for (g = 0; g < c.length; g++) P = m.isNavigator ? 0 : 10, c[g] && (f = Math.round(a[0] ? a[0].lineCoordinates.x1 : d[0].lineCoordinates.x1), P = c[g]._labels && 0 < c[g]._labels.length ? c[g]._labels[c[g]._labels.length - 1].textBlock.height / 2 : n, u = Math.round(h.y1 + Z + Y < Math.max(P, n) ? Math.max(P, n) : h.y1 + Z + Y), r = Math.round(a[0] ? a[0].lineCoordinates.x1 : d[0].lineCoordinates.x1), P = 0 < a.length ? 0 : c[g]._labels && 0 < c[g]._labels.length ? c[g]._labels[0].textBlock.height / 2 : n, k = Math.round(h.y2 - X - e - P), c[g].lineCoordinates = {
                            x1: f - U,
                            y1: u,
                            x2: r - U,
                            y2: k,
                            height: Math.abs(k - u)
                        }, "inside" === c[g].labelPlacement && 0 < g && (c[g].lineCoordinates.x1 = c[0].lineCoordinates.x1 - U - (c[g].labelEffectiveWidth || 0) - 5, c[g].lineCoordinates.x2 = c[g].lineCoordinates.x1 + c[g].lineThickness / 2), "inside" === c[g].tickPlacement && 0 < g && (c[g].lineCoordinates.x1 -= c[g].tickLength, c[g].lineCoordinates.x2 = c[g].lineCoordinates.x1 + c[g].lineThickness / 2), c[g].bounds = {
                            x1: f - (("inside" === c[g].labelPlacement && 0 === g ? A[g] - 5 : A[g]) + U),
                            y1: u,
                            x2: r - U,
                            y2: k,
                            height: k - u
                        }, c[g].bounds.width = c[g].bounds.x2 - c[g].bounds.x1, c[g].title && (c[g]._titleTextBlock.maxWidth = 0 < c[g].titleMaxWidth && c[g].titleMaxWidth < c[g].lineCoordinates.height ? c[g].titleMaxWidth : c[g].lineCoordinates.height), U += ("inside" === c[g].labelPlacement && 0 === g ? A[g] - 5 : A[g]) + c[g].margin);
                    if (b && 0 < b.length)
                        for (g = 0; g < b.length; g++) b[g] && (f = Math.round(a[0] ? a[0].lineCoordinates.x2 : d[0].lineCoordinates.x2), r = Math.round(f), P = b[g]._labels && 0 < b[g]._labels.length ? b[g]._labels[b[g]._labels.length - 1].textBlock.height / 2 : 0, u = Math.round(h.y1 + Z + Y < Math.max(P, n) ? Math.max(P, n) : h.y1 + Z + Y), P = 0 < a.length ? 0 : b[g]._labels && 0 < b[g]._labels.length ? b[g]._labels[0].textBlock.height / 2 : 0, k = Math.round(h.y2 - (X + e + P)), b[g].lineCoordinates = {
                            x1: f + V,
                            y1: u,
                            x2: f + V,
                            y2: k,
                            height: Math.abs(k - u)
                        }, "inside" === b[g].labelPlacement && 0 < g && (b[g].lineCoordinates.x1 = b[0].lineCoordinates.x2 + V + (b[g].labelEffectiveWidth || 0) + 5, b[g].lineCoordinates.x2 = b[g].lineCoordinates.x1 + b[g].lineThickness / 2), "inside" === b[g].tickPlacement && 0 < g && (b[g].lineCoordinates.x1 += b[g].tickLength, b[g].lineCoordinates.x2 = b[g].lineCoordinates.x1 + b[g].lineThickness / 2), b[g].bounds = {
                            x1: f + V,
                            y1: u,
                            x2: r + (("inside" === b[g].labelPlacement && 0 === g ? z[g] - 5 : z[g]) + V),
                            y2: k,
                            height: k - u
                        }, b[g].bounds.width = b[g].bounds.x2 - b[g].bounds.x1, b[g].title && (b[g]._titleTextBlock.maxWidth = 0 < b[g].titleMaxWidth && b[g].titleMaxWidth < b[g].lineCoordinates.height ? b[g].titleMaxWidth : b[g].lineCoordinates.height), V += ("inside" === b[g].labelPlacement && 0 === g ? z[g] - 5 : z[g]) + b[g].margin);
                    if (a && 0 < a.length)
                        for (g = 0; g < a.length; g++) a[g] && (a[g].calculateValueToPixelConversionParameters(), a[g].calculateBreaksSizeInValues(), a[g]._labels && 1 < a[g]._labels.length && (B = (a[g].logarithmic ? Math.log(a[g]._labels[1].position / a[g].viewportMinimum) / a[g].conversionParameters.lnLogarithmBase : a[g]._labels[1].position - a[g].viewportMinimum) * Math.abs(a[g].conversionParameters.pixelPerUnit) + a[g].lineCoordinates.x1, f = a[g]._labels[a[g]._labels.length - ("dateTime" === a[g].valueType ? 2 : 1)].position, f = a[g].getApparentDifference(a[g].viewportMinimum, f), G = a[g].logarithmic ? (1 < f ? Math.log(f) / a[g].conversionParameters.lnLogarithmBase * Math.abs(a[g].conversionParameters.pixelPerUnit) : 0) + a[g].lineCoordinates.x1 : (0 < f ? f * Math.abs(a[g].conversionParameters.pixelPerUnit) : 0) + a[g].lineCoordinates.x1));
                    if (d && 0 < d.length)
                        for (g = 0; g < d.length; g++) d[g].calculateValueToPixelConversionParameters(), d[g].calculateBreaksSizeInValues(), d[g]._labels && 1 < d[g]._labels.length && (B = (d[g].logarithmic ? Math.log(d[g]._labels[1].position / d[g].viewportMinimum) / d[g].conversionParameters.lnLogarithmBase : d[g]._labels[1].position - d[g].viewportMinimum) * Math.abs(d[g].conversionParameters.pixelPerUnit) + d[g].lineCoordinates.x1, f = d[g]._labels[d[g]._labels.length - ("dateTime" === d[g].valueType ? 2 : 1)].position, f = d[g].getApparentDifference(d[g].viewportMinimum, f), G = d[g].logarithmic ? (1 < f ? Math.log(f) / d[g].conversionParameters.lnLogarithmBase * Math.abs(d[g].conversionParameters.pixelPerUnit) : 0) + d[g].lineCoordinates.x1 : (0 < f ? f * Math.abs(d[g].conversionParameters.pixelPerUnit) : 0) + d[g].lineCoordinates.x1);
                    for (g = 0; g < p.length; g++) "axisY" === p[g].type && (p[g].calculateValueToPixelConversionParameters(), p[g].calculateBreaksSizeInValues());
                    if (0 < x) {
                        if (a && 0 < a.length)
                            for (g = 0; g < a.length; g++) t = R[x - 1][g] === R[x][g] ? !0 : !1;
                        else t = !0;
                        if (d && 0 < d.length)
                            for (g = 0; g < d.length; g++) J = S[x - 1][g] === S[x][g] ? !0 : !1;
                        else J = !0;
                        if (c && 0 < c.length)
                            for (g = 0; g < c.length; g++) L = N[x - 1][g] === N[x][g] ? !0 : !1;
                        else L = !0;
                        if (b && 0 < b.length)
                            for (g = 0; g < b.length; g++) M = Q[x - 1][g] === Q[x][g] ? !0 : !1;
                        else M = !0
                    }
                    if (t && J && L && M) break;
                    x++
                ...
                R = [];
                for (S = []; 4 > x;) {
                    X = V = U = $ = P = Y = e = Q = N = F = Z = 0;
                    if (a && 0 < a.length)
                        for (I = [], g = V = 0; g < a.length; g++) I.push(Math.ceil(a[g] ? a[g].createLabelsAndCalculateWidth() : 0)), V += I[g], e += a[g] && !m.isNavigator ? a[g].margin : 0;
                    else I.push(Math.ceil(a[0] ? a[0].createLabelsAndCalculateWidth() : 0));
                    R.push(I);
                    if (d && 0 < d.length)
                        for (y = [], g = X = 0; g < d.length; g++) y.push(Math.ceil(d[g] ? d[g].createLabelsAndCalculateWidth() : 0)), X += y[g], Y += d[g] ? d[g].margin : 0;
                    else y.push(Math.ceil(d[0] ? d[0].createLabelsAndCalculateWidth() : 0));
                    S.push(y);
                    if (c && 0 < c.length)
                        for (g = 0; g < c.length; g++) c[g].lineCoordinates = {}, f = Math.round(h.x1 + V + e), r = Math.round(h.x2 - X - Y > m.width - 10 ? m.width - 10 : h.x2 - X - Y), c[g].labelAutoFit && !l(w) && (0 < !a.length && (f = 0 > c[g].labelAngle ? Math.max(f, w) : 0 === c[g].labelAngle ? Math.max(f, w / 2) : f), 0 < !d.length && (r = 0 < c[g].labelAngle ? r - v / 2 : 0 === c[g].labelAngle ? r - v / 2 : r)), c[g].lineCoordinates.x1 = f, c[g].lineCoordinates.x2 = r, c[g].lineCoordinates.width = Math.abs(r - f), c[g].title && (c[g]._titleTextBlock.maxWidth = 0 < c[g].titleMaxWidth && c[g].titleMaxWidth < c[g].lineCoordinates.width ? c[g].titleMaxWidth : c[g].lineCoordinates.width);
                    if (b && 0 < b.length)
                        for (g = 0; g < b.length; g++) b[g].lineCoordinates = {}, f = Math.round(h.x1 + V + e), r = Math.round(h.x2 - X - Y > b[g].chart.width - 10 ? b[g].chart.width - 10 : h.x2 - X - Y), b[g] && b[g].labelAutoFit && !l(A) && (0 < !a.length && (f = 0 < b[g].labelAngle ? Math.max(f, A) : 0 === b[g].labelAngle ? Math.max(f, A / 2) : f), 0 < !d.length && (r -= z / 2)), b[g].lineCoordinates.x1 = f, b[g].lineCoordinates.x2 = r, b[g].lineCoordinates.width = Math.abs(r - f), b[g].title && (b[g]._titleTextBlock.maxWidth = 0 < b[g].titleMaxWidth && b[g].titleMaxWidth < b[g].lineCoordinates.width ? b[g].titleMaxWidth : b[g].lineCoordinates.width);
                    if (c && 0 < c.length)
                        for (n = [], g = U = 0; g < c.length; g++) n.push(Math.ceil(c[g] ? c[g].createLabelsAndCalculateHeight() : 0)), U += n[g] + c[g].margin, P += c[g].margin;
                    else n.push(Math.ceil(c[0] ? c[0].createLabelsAndCalculateHeight() : 0));
                    G.push(n);
                    if (b && 0 < b.length)
                        for (B = [], g = 0; g < b.length; g++) B.push(Math.ceil(b[g] ? b[g].createLabelsAndCalculateHeight() : 0)), $ += b[g].margin;
                    else B.push(Math.ceil(b[0] ? b[0].createLabelsAndCalculateHeight() : 0));
                    s.push(B);
                    if (c && 0 < c.length)
                        for (g = 0; g < c.length; g++) 0 < c[g]._labels.length && (k = c[g]._labels[0], u = c[g]._labels[c[g]._labels.length - 1], w = k.textBlock.width * Math.cos(Math.PI / 180 * Math.abs(k.textBlock.angle)) + (k.textBlock.height - u.textBlock.fontSize / 2) * Math.sin(Math.PI / 180 * Math.abs(k.textBlock.angle)), v = u.textBlock.width * Math.cos(Math.PI / 180 * Math.abs(u.textBlock.angle)) + (u.textBlock.height - u.textBlock.fontSize / 2) * Math.sin(Math.PI / 180 * Math.abs(u.textBlock.angle)));
                    if (b && 0 < b.length)
                        for (g = 0; g < b.length; g++) b[g] && 0 < b[g]._labels.length && (k = b[g]._labels[0], u = b[g]._labels[b[g]._labels.length - 1], A = k.textBlock.width * Math.cos(Math.PI / 180 * Math.abs(k.textBlock.angle)) + (k.textBlock.height - u.textBlock.fontSize / 2) * Math.sin(Math.PI / 180 * Math.abs(k.textBlock.angle)), z = u.textBlock.width * Math.cos(Math.PI / 180 * Math.abs(u.textBlock.angle)) + (u.textBlock.height - u.textBlock.fontSize / 2) * Math.sin(Math.PI / 180 * Math.abs(u.textBlock.angle)));
                    if (m.panEnabled)
                        for (g = 0; g < c.length; g++) n[g] = l(m.sessionVariables.axisY[g].height) ? m.sessionVariables.axisY[g].height = n[g] : m.sessionVariables.axisY[g].height;
                    else
                        for (g = 0; g < c.length; g++) m.sessionVariables.axisY[g].height = n[g];
                    if (c && 0 < c.length)
                        for (g = c.length - 1; 0 <= g; g--) u = Math.round(h.y2), k = Math.round(h.y2 > c[g].chart.height ? c[g].chart.height : h.y2), c[g].lineCoordinates.y1 = u - (n[g] + c[g].margin + Z), c[g].lineCoordinates.y2 = u - (n[g] + c[g].margin + Z), "inside" === c[g].labelPlacement && 0 < g && (c[g].lineCoordinates.y1 = c[g].lineCoordinates.y1 + n[g] - (c[g]._titleTextBlock ? c[g]._titleTextBlock.height : 0) - c[g].tickLength - (c[g].stripLineLabelEffectiveHeight || 0) - 5, c[g].lineCoordinates.y2 = c[g].lineCoordinates.y1 + c[g].lineThickness / 2), "inside" === c[g].tickPlacement && 0 < g && (c[g].lineCoordinates.y1 += c[g].tickLength, c[g].lineCoordinates.y2 = c[g].lineCoordinates.y1 + c[g].lineThickness / 2), c[g].bounds = {
                            x1: f,
                            y1: u - (n[g] + Z + c[g].margin),
                            x2: r,
                            y2: k - (Z + c[g].margin),
                            width: r - f,
                            height: n[g]
                        }, c[g].title && (c[g]._titleTextBlock.maxWidth = 0 < c[g].titleMaxWidth && c[g].titleMaxWidth < c[g].lineCoordinates.width ? c[g].titleMaxWidth : c[g].lineCoordinates.width), Z += n[g] + c[g].margin;
                    if (b && 0 < b.length)
                        for (g = b.length - 1; 0 <= g; g--) b[g] && (u = Math.round(h.y1), k = Math.round(h.y1 + (B[g] + b[g].margin + F)), b[g].lineCoordinates.y1 = k, b[g].lineCoordinates.y2 = k, "inside" === b[g].labelPlacement && 0 < g && (b[g].lineCoordinates.y1 = k - B[g] + (b[g]._titleTextBlock ? b[g]._titleTextBlock.height : 0) + b[g].tickLength + (b[g].stripLineLabelEffectiveHeight || 0), b[g].lineCoordinates.y2 = b[g].lineCoordinates.y1 - b[g].lineThickness / 2), "inside" === b[g].tickPlacement && 0 < g && (b[g].lineCoordinates.y1 -= b[g].tickLength, b[g].lineCoordinates.y2 = b[g].lineCoordinates.y1 - b[g].lineThickness / 2), b[g].bounds = {
                            x1: f,
                            y1: u + (b[g].margin + F),
                            x2: r,
                            y2: k,
                            width: r - f
                        }, b[g].bounds.height = b[g].bounds.y2 - b[g].bounds.y1, b[g].title && (b[g]._titleTextBlock.maxWidth = 0 < b[g].titleMaxWidth && b[g].titleMaxWidth < b[g].lineCoordinates.width ? b[g].titleMaxWidth : b[g].lineCoordinates.width), F += B[g] + b[g].margin);
                    if (a && 0 < a.length)
                        for (g = 0; g < a.length; g++) {
                            P = a[g]._labels && 0 < a[g]._labels.length ? a[g]._labels[0].textBlock.fontSize / 2 : 0;
                            f = Math.round(h.x1 + e);
                            ...
                            k = c && 0 < c.length ? Math.round(c[0] ? c[0].lineCoordinates.y1 : h.y2 - U > m.height - Math.max(P, 10) ? m.height - Math.max(P, 10) : h.y2 - U) : h.y2 > m.height - Math.max(P, 10) ? m.height - Math.max(P, 10) : h.y2;
                            if (c && 0 < c.length)
                                for (P = 0; P < c.length; P++) c[P] && c[P].labelAutoFit && (r = c[P].lineCoordinates.x1, f = 0 > c[P].labelAngle || 0 === c[P].labelAngle ? r - V : f);
                            if (b && 0 < b.length)
                                for (P = 0; P < b.length; P++) b[P] && b[P].labelAutoFit && (r = b[P].lineCoordinates.x1, f = r - V);
                            a[g].lineCoordinates = {
                                x1: r - N,
                                y1: u,
                                x2: r - N,
                            ...
                            "inside" === a[g].labelPlacement && 0 < g && (a[g].lineCoordinates.x1 = a[g].lineCoordinates.x1 - (I[g] - (a[g]._titleTextBlock ? a[g]._titleTextBlock.height : 0)) + a[g].tickLength + (a[g].stripLineLabelEffectiveWidth || 0), a[g].lineCoordinates.x2 = a[g].lineCoordinates.x1 + a[g].lineThickness / 2);
                    ...
                    if (d && 0 < d.length)
                        for (g = 0; g < d.length; g++) {
                            P = d[g]._labels && 0 < d[g]._labels.length ? d[g]._labels[0].textBlock.fontSize / 2 : 0;
                            f = Math.round(h.x1 - e);
                            u = b && 0 < b.length ? Math.round(b[0] ? b[0].lineCoordinates.y2 : h.y1 < Math.max(P, 10) ? Math.max(P, 10) : h.y1) : h.y1 < Math.max(P, 10) ? Math.max(P, 10) : h.y1;
                            r = Math.round(h.x2 - X - Y);
                            k = c && 0 < c.length ? Math.round(c[0] ? c[0].lineCoordinates.y1 : h.y2 - U > m.height - Math.max(P, 10) ? m.height - Math.max(P, 10) : h.y2 - U) : h.y2 > m.height - Math.max(P, 10) ? m.height - Math.max(P, 10) : h.y2;
                            if (c && 0 < c.length)
                                for (P = 0; P < c.length; P++) c[P] && c[P].labelAutoFit && (r = 0 > c[P].labelAngle ? Math.max(r, w) : 0 === c[P].labelAngle ? Math.max(r, w / 2) : r, f = 0 > c[P].labelAngle || 0 === c[P].labelAngle ? r - X : f);
                            if (b && 0 < b.length)
                                for (P = 0; P < b.length; P++) b[P] && b[P].labelAutoFit && (r = b[P].lineCoordinates.x2, f = r - X);
                            d[g].lineCoordinates = {
                                x1: r + Q,
                                y1: u,
                                x2: r + Q,
                            ...
                            "inside" === d[g].labelPlacement && 0 < g && (d[g].lineCoordinates.x1 = d[g].lineCoordinates.x1 + (y[g] - (d[g]._titleTextBlock ? d[g]._titleTextBlock.height : 0) - 2) - d[g].tickLength - (d[g].stripLineLabelEffectiveWidth || 0), d[g].lineCoordinates.x2 = d[g].lineCoordinates.x1 + d[g].lineThickness / 2);
                    ...
                    if (0 < x) {
                        ...
                        if (c && 0 < c.length)
                            for (g = 0; g < c.length; g++) L = G[x - 1][g] === G[x][g] ? !0 : !1;
                        else L = !0;
                        if (b && 0 < b.length)
                            for (g = 0; g < b.length; g++) M = s[x - 1][g] === s[x][g] ? !0 : !1;
                        else M = !0
                    }
                    if (t && J && L && M) break;
                    x++
        ...
        A.render = function(a, d, c, b, e) {
            ...
            if (d && 0 < d.length)
                for (f = 0; f < d.length; f++) d[f].renderLabelsTicksAndTitle();
            h.restore();
            if (c && 0 < c.length)
            ...
            h.clip();
            if (a && 0 < a.length)
                for (f = 0; f < a.length; f++) a[f].renderStripLinesOfThicknessType("value");
            if (d && 0 < d.length)
                for (f = 0; f < d.length; f++) d[f].renderStripLinesOfThicknessType("value");
            if (c && 0 < c.length)
                for (f = 0; f < c.length; f++) c[f].renderStripLinesOfThicknessType("value");
            if (b && 0 < b.length)
                for (f = 0; f < b.length; f++) b[f].renderStripLinesOfThicknessType("value");
            if (a && 0 < a.length)
                for (f = 0; f < a.length; f++) a[f].renderInterlacedColors();
            if (d && 0 < d.length)
                for (f = 0; f < d.length; f++) d[f].renderInterlacedColors();
            if (c && 0 < c.length)
            ...
            h.restore();
            if (a && 0 < a.length)
                for (f = 0; f < a.length; f++) a[f].renderGrid(), r && (a[f].createMask(), a[f].renderBreaksBackground());
            if (d && 0 < d.length)
                for (f = 0; f < d.length; f++) d[f].renderGrid(), r && (d[f].createMask(), d[f].renderBreaksBackground());
            if (c && 0 < c.length)
                for (f = 0; f < c.length; f++) c[f].renderGrid(), r && (c[f].createMask(), c[f].renderBreaksBackground());
            if (b && 0 < b.length)
                for (f = 0; f < b.length; f++) b[f].renderGrid(), r && (b[f].createMask(), b[f].renderBreaksBackground());
            if (a && 0 < a.length)
                for (f = 0; f < a.length; f++) a[f].renderAxisLine();
            if (d && 0 < d.length)
                for (f = 0; f < d.length; f++) d[f].renderAxisLine();
            if (c && 0 < c.length)
            ...
            h = !1;
            if (a && 0 < a.length)
                for (f = 0; f < a.length; f++) a[f].renderStripLinesOfThicknessType("pixel"), a[f].crosshair && a[f].crosshair.enabled && (h = !0, e.clearedOverlayedCanvas = a[f].type);
            if (d && 0 < d.length)
                for (f = 0; f < d.length; f++) d[f].renderStripLinesOfThicknessType("pixel"), d[f].crosshair && d[f].crosshair.enabled && (h = !0, e.clearedOverlayedCanvas = d[f].type);
            if (c && 0 < c.length)
                for (f = 0; f < c.length; f++) c[f].renderStripLinesOfThicknessType("pixel"), c[f].crosshair && c[f].crosshair.enabled && (h = !0, e.clearedOverlayedCanvas = c[f].type);
            if (b && 0 < b.length)
                for (f = 0; f < b.length; f++) b[f].renderStripLinesOfThicknessType("pixel"), b[f].crosshair && b[f].crosshair.enabled && (h = !0, e.clearedOverlayedCanvas = b[f].type);
        ...
        A.prototype.renderLabelsTicksAndTitle = function() {
                ...
                if ("bottom" === this._position || "top" === this._position)
                    if (this.logarithmic && !this.equidistantInterval && this.labelAutoFit) {
                        for (var c = [], e = 0 !== this.labelAngle && 360 !== this.labelAngle ? 1 : 1.2, f, l = this.viewportMaximum, r = this.lineCoordinates.width / Math.log(this.range), k = this._labels.length - 1; 0 <= k; k--) {
                            ...
                            n.position > this.viewportMaximum || !(k === this._labels.length - 1 || f < Math.log(l / n.position) * r / e) || (c.push(n), l = n.position, f = n.textBlock.width * Math.abs(Math.cos(Math.PI / 180 * this.labelAngle)) + n.textBlock.height * Math.abs(Math.sin(Math.PI / 180 * this.labelAngle)))
                        }
                        this._labels = c
                    } else {
                        for (k = 0; k < this._labels.length; k++) n = this._labels[k], n.position < this.viewportMinimum || (f = n.textBlock.width * Math.abs(Math.cos(Math.PI / 180 * this.labelAngle)) + n.textBlock.height * Math.abs(Math.sin(Math.PI / 180 * this.labelAngle)), c += f);
            ...
            if ("bottom" === this._position) {
                for (k = 0; k < this._labels.length; k++) n = this._labels[k], n.position < this.viewportMinimum || n.position > this.viewportMaximum || (p = this.getPixelCoordinatesOnAxis(n.position), this.tickThickness && "inside" != this.tickPlacement && (this.ctx.lineWidth = this.tickThickness, this.ctx.strokeStyle = this.tickColor, b = 1 === this.ctx.lineWidth % 2 ? (p.x << 0) + 0.5 : p.x << 0, this.ctx.beginPath(), this.ctx.moveTo(b, p.y << 0), this.ctx.lineTo(b, p.y + this.tickLength << 0), this.ctx.stroke()), d && 0 !== h++ % 2 && this.labelAutoFit || (0 === n.textBlock.angle ? (p.x -= n.textBlock.width / 2, p.y = "inside" === this.labelPlacement ? p.y - (("inside" === this.tickPlacement ? this.tickLength : 0) + n.textBlock.height - n.textBlock.fontSize / 2) : p.y + ("inside" === this.tickPlacement ? 0 : this.tickLength) + n.textBlock.fontSize / 2 + 5) : 0 > this.labelAngle ? (p.x -= "inside" === this.labelPlacement ? 0 : n.textBlock.width * Math.cos(Math.PI / 180 * this.labelAngle), p.y = "inside" === this.labelPlacement ? p.y - ("inside" === this.tickPlacement ? this.tickLength : 0) - (n.textBlock.height - n.textBlock.fontSize / 2) * Math.cos(Math.PI / 180 * this.labelAngle) : p.y + ("inside" === this.tickPlacement ? 0 : this.tickLength) + 5 + Math.abs(n.textBlock.width * Math.sin(Math.PI / 180 * this.labelAngle) - n.textBlock.fontSize / 2 * Math.cos(Math.PI / 180 * this.labelAngle))) : (p.x -= "inside" === this.labelPlacement ? n.textBlock.width * Math.cos(Math.PI / 180 * this.labelAngle) : 0, p.y = "inside" === this.labelPlacement ? p.y - ("inside" === this.tickPlacement ? this.tickLength : 0) - n.textBlock.width * Math.sin(Math.PI / 180 * this.labelAngle) - (n.textBlock.height - n.textBlock.fontSize / 2) * Math.cos(Math.PI / 180 * this.labelAngle) : p.y + ("inside" === this.tickPlacement ? 0 : this.tickLength) + 5 + Math.abs(n.textBlock.fontSize / 2 * Math.cos(Math.PI / 180 * this.labelAngle))), n.textBlock.x = p.x, n.textBlock.y = p.y));
            ...
            if ("inside" === this.labelPlacement) this.chart.addEventListener("dataAnimationIterationEnd", function() {
                for (k = 0; k < a._labels.length; k++) n = a._labels[k], n.position < a.viewportMinimum || (n.position > a.viewportMaximum || d && 0 !== h++ % 2 && a.labelAutoFit) || (a.ctx.save(), a.ctx.beginPath(), n.textBlock.render(!0), a.ctx.restore())
            }, this);
            else
                for (k = 0; k < this._labels.length; k++) n = this._labels[k], n.position < this.viewportMinimum || (n.position > this.viewportMaximum || d && 0 !== h++ % 2 && this.labelAutoFit) || n.textBlock.render(!0)
        };
        ...
        A.prototype.renderStripLinesOfThicknessType = function(a) {
            if (this.stripLines && 0 < this.stripLines.length && a) {
                ...
                if (!k) {
                    ...
                    this.ctx.clip();
                    for (e = 0; e < r.length; e++) n = r[e], n.showOnTop ? f || (f = !0, this.chart.addEventListener("dataAnimationIterationEnd", function() {
                        this.ctx.save();
                        this.ctx.beginPath();
                        this.ctx.rect(this.chart.plotArea.x1, this.chart.plotArea.y1, this.chart.plotArea.width, this.chart.plotArea.height);
                        this.ctx.clip();
                    ...
                    for (e = 0; e < t.length; e++) c = t[e], c.stripLine.showOnTop ? b || (b = !0, this.chart.addEventListener("dataAnimationIterationEnd", function() {
                        for (h = 0; h < t.length; h++) c = t[h], "inside" === c.stripLine.labelPlacement && c.stripLine.showOnTop && (d.ctx.save(), d.ctx.beginPath(), d.ctx.rect(d.chart.plotArea.x1, d.chart.plotArea.y1, d.chart.plotArea.width, d.chart.plotArea.height), d.ctx.clip(), c.textBlock.render(!0), d.ctx.restore())
                    }, c.textBlock)) : "inside" === c.stripLine.labelPlacement && c.textBlock.render(!0);
                    this.ctx.restore();
                    k = !0
                }
                if (k)
                    for (b = !1, e = 0; e < t.length; e++) c = t[e], "outside" === c.stripLine.labelPlacement && c.textBlock.render(!0)
            }
        };
            ...
            if ("bottom" === this._position || "top" === this._position) {
                if (this.lineThickness) {
                    ...
                    if (this.scaleBreaks && !l(this.scaleBreaks.firstBreakIndex))
                        if (l(this.scaleBreaks.lastBreakIndex)) e = this.scaleBreaks._appliedBreaks[this.scaleBreaks.firstBreakIndex].endPixel + b;
                            ...
                            for (var u = this.scaleBreaks.firstBreakIndex; u <= this.scaleBreaks.lastBreakIndex; u++) d.moveTo(e, f), d.lineTo(this.scaleBreaks._appliedBreaks[u].startPixel + c, f), e = this.scaleBreaks._appliedBreaks[u].endPixel + b;
                ...
                if (this.scaleBreaks && !l(this.scaleBreaks.firstBreakIndex))
                    if (l(this.scaleBreaks.lastBreakIndex)) e = this.scaleBreaks._appliedBreaks[this.scaleBreaks.firstBreakIndex].endPixel + c;
                        ...
                        for (u = this.scaleBreaks.firstBreakIndex; u <= this.scaleBreaks.lastBreakIndex; u++) d.moveTo(f, e), d.lineTo(f, this.scaleBreaks._appliedBreaks[u].startPixel + b), e = this.scaleBreaks._appliedBreaks[u].endPixel + c;
        ...
        A.prototype.calculateAxisParameters = function() {
            if (this.logarithmic) this.calculateLogarithmicAxisParameters();
                ...
                } else "axisY" === this.type && (e = null !== this.viewportMinimum ? this.viewportMinimum : this.dataInfo.viewPortMin, h = null !== this.viewportMaximum ? this.viewportMaximum : this.dataInfo.viewPortMax, isFinite(e) || isFinite(h) ? isFinite(e) ? isFinite(h) || (h = e) : e = h : (h = "undefined" === typeof this.options.interval ? -Infinity : this.options.interval, e = "undefined" !== typeof this.options.interval || isFinite(this.dataInfo.minDiff) ? 0 : Infinity), 0 === e && 0 === h ? (h += 9, e = 0) : 0 === h - e ? (b = Math.min(Math.abs(0.01 * Math.abs(h)), 5), h += b, e -= b) : e > h ? (b = Math.min(0.01 * Math.abs(this.getApparentDifference(h, e, null, !0)), 5), 0 <= h ? e = h - b : h = isFinite(e) ? e + b : 0) : (b = Math.min(0.01 * Math.abs(this.getApparentDifference(e, h, null, !0)), 0.05), 0 !== h && (h += b), 0 !== e && (e -= b)), f = Infinity !== this.dataInfo.minDiff ? this.dataInfo.minDiff : 1 < h - e ? 0.5 * Math.abs(h - e) : 1, this.includeZero && (null === this.viewportMinimum || isNaN(this.viewportMinimum)) && 0 < e && (e = 0), this.includeZero && (null === this.viewportMaximum || isNaN(this.viewportMaximum)) && 0 > h && (h = 0));
                ...
                if (null === this.minimum || null === this.maximum)
                    if ("axisX" === this.type ? (e = null !== this.minimum ? this.minimum : this.dataInfo.min, h = null !== this.maximum ? this.maximum : this.dataInfo.max, 0 === h - e && (b = "undefined" === typeof this.options.interval ? 0.4 : this.options.interval, h += b, e -= b), f = Infinity !== this.dataInfo.minDiff ? this.dataInfo.minDiff : 1 < h - e ? 0.5 * Math.abs(h - e) : 1) : "axisY" === this.type && (e = null !== this.minimum ? this.minimum : this.dataInfo.min, h = null !== this.maximum ? this.maximum : this.dataInfo.max, isFinite(e) || isFinite(h) ? 0 === e && 0 === h ? (h += 9, e = 0) : 0 === h - e ? (b = Math.min(Math.abs(0.01 * Math.abs(h)), 5), h += b, e -= b) : e > h ? (b = Math.min(0.01 * Math.abs(this.getApparentDifference(h, e, null, !0)), 5), 0 <= h ? e = h - b : h = isFinite(e) ? e + b : 0) : (b = Math.min(0.01 * Math.abs(this.getApparentDifference(e, h, null, !0)), 0.05), 0 !== h && (h += b), 0 !== e && (e -= b)) : (h = "undefined" === typeof this.options.interval ? -Infinity : this.options.interval, e = "undefined" !== typeof this.options.interval || isFinite(this.dataInfo.minDiff) ? 0 : Infinity), f = Infinity !== this.dataInfo.minDiff ? this.dataInfo.minDiff : 1 < h - e ? 0.5 * Math.abs(h - e) : 1, this.includeZero && (null === this.minimum || isNaN(this.minimum)) && 0 < e && (e = 0), this.includeZero && (null === this.maximum || isNaN(this.maximum)) && 0 > h && (h = 0)), Math.abs(this.getApparentDifference(e, h, null, !0)), "axisX" === this.type && c) {
                        this.valueType = "dateTime";
                        if (null === this.minimum || isNaN(this.minimum)) this.minimum = e - f / 2, this.minimum = Math.min(this.minimum, null === this.sessionVariables.viewportMinimum || isNaN(this.sessionVariables.viewportMinimum) ? Infinity : this.sessionVariables.viewportMinimum);
                        if (null === this.maximum || isNaN(this.maximum)) this.maximum = h + f / 2, this.maximum = Math.max(this.maximum, null === this.sessionVariables.viewportMaximum || isNaN(this.sessionVariables.viewportMaximum) ? -Infinity : this.sessionVariables.viewportMaximum)
                    } else this.intervalType = this.valueType = "number", null === this.minimum && (this.minimum = "axisX" === this.type ? e - f / 2 : Math.floor(e / this.interval) * this.interval, this.minimum = Math.min(this.minimum, null === this.sessionVariables.viewportMinimum || isNaN(this.sessionVariables.viewportMinimum) ? Infinity : this.sessionVariables.viewportMinimum)), null === this.maximum && (this.maximum = "axisX" === this.type ? h + f / 2 : Math.ceil(h / this.interval) * this.interval, this.maximum = Math.max(this.maximum, null === this.sessionVariables.viewportMaximum || isNaN(this.sessionVariables.viewportMaximum) ? -Infinity : this.sessionVariables.viewportMaximum)), 0 === this.maximum && 0 === this.minimum && (0 === this.options.minimum ? this.maximum += 10 : 0 === this.options.maximum && (this.minimum -= 10));
        ...
        A.prototype.calculateLogarithmicAxisParameters = function() {
            ...
            if (this.scaleBreaks)
                for (f = 0; f < this.scaleBreaks._appliedBreaks.length; f++)
                    if ((!l(this.sessionVariables.newViewportMinimum) && this.sessionVariables.newViewportMinimum >= this.scaleBreaks._appliedBreaks[f].startValue || !l(this.options.minimum) && this.options.minimum >= this.scaleBreaks._appliedBreaks[f].startValue || !l(this.options.viewportMinimum) && this.viewportMinimum >= this.scaleBreaks._appliedBreaks[f].startValue) && (!l(this.sessionVariables.newViewportMaximum) && this.sessionVariables.newViewportMaximum <= this.scaleBreaks._appliedBreaks[f].endValue || !l(this.options.maximum) && this.options.maximum <= this.scaleBreaks._appliedBreaks[f].endValue || !l(this.options.viewportMaximum) && this.viewportMaximum <= this.scaleBreaks._appliedBreaks[f].endValue)) {
                        this.scaleBreaks._appliedBreaks.splice(f, 1);
                        break
                    }
            "axisX" === this.type ? (b = null !== this.viewportMinimum ? this.viewportMinimum : this.dataInfo.viewPortMin, e = null !== this.viewportMaximum ? this.viewportMaximum : this.dataInfo.viewPortMax, 1 === e / b && (f = Math.pow(this.logarithmBase, "undefined" === typeof this.options.interval ? 0.4 : this.options.interval), e *= f, b /= f), h = Infinity !== this.dataInfo.minDiff ? this.dataInfo.minDiff : e / b > this.logarithmBase ? e / b * Math.pow(this.logarithmBase, 0.5) : this.logarithmBase) : "axisY" === this.type && (b = null !== this.viewportMinimum ? this.viewportMinimum : this.dataInfo.viewPortMin, e = null !== this.viewportMaximum ? this.viewportMaximum : this.dataInfo.viewPortMax, 0 >= b && !isFinite(e) ? (e = "undefined" === typeof this.options.interval ? 0 : this.options.interval, b = 1) : 0 >= b ? b = e : isFinite(e) || (e = b), 1 === b && 1 === e ? (e *= this.logarithmBase - 1 / this.logarithmBase, b = 1) : 1 === e / b ? (f = Math.min(e * Math.pow(this.logarithmBase, 0.01), Math.pow(this.logarithmBase, 5)), e *= f, b /= f) : b > e ? (f = Math.min(b / e * Math.pow(this.logarithmBase, 0.01), Math.pow(this.logarithmBase, 5)), 1 <= e ? b = e / f : e = b * f) : (f = Math.min(e / b * Math.pow(this.logarithmBase, 0.01), Math.pow(this.logarithmBase, 0.04)), 1 !== e && (e *= f), 1 !== b && (b /= f)), h = Infinity !== this.dataInfo.minDiff ? this.dataInfo.minDiff : e / b > this.logarithmBase ? e / b * Math.pow(this.logarithmBase, 0.5) : this.logarithmBase, this.includeZero && (null === this.viewportMinimum || isNaN(this.viewportMinimum)) && 1 < b && (b = 1), this.includeZero && (null === this.viewportMaximum || isNaN(this.viewportMaximum)) && 1 > e && (e = 1));
            ...
            if (!this.valueFormatString && (this.valueFormatString = "#,##0.##", 1 > this.viewportMinimum)) {
                ...
                if (2 < d)
                    for (f = 0; f < d - 2; f++) this.valueFormatString += "#"
            }
        };
        ...
        fa.prototype.render = function(a) {
            if (0 !== this.spacing || 0 !== this.options.lineThickness && ("undefined" !== typeof this.options.lineThickness || 0 !== this.parent.lineThickness)) {
                ...
                if ("bottom" === this.scaleBreaks.parent._position || "top" === this.scaleBreaks.parent._position)
                    if (b = 1 === n % 2 ? (b.x << 0) + 0.5 : b.x << 0, f = 1 === n % 2 ? (e.x << 0) + 0.5 : e.x << 0, "top" === this.scaleBreaks.parent._position ? (e = this.chart.plotArea.y1, l = this.chart.plotArea.y2 + n / 2 + 0.5 << 0) : (e = this.chart.plotArea.y2, l = this.chart.plotArea.y1 - n / 2 + 0.5 << 0, a *= -1), this.bounds = {
                            x1: b - n / 2,
                            y1: e,
                            x2: f + n / 2,
                            y2: l
                        }, this.ctx.moveTo(b, e), "straight" === this.type || "top" === this.scaleBreaks.parent._position && 0 >= a || "bottom" === this.scaleBreaks.parent._position && 0 <= a) this.ctx.lineTo(b, l), this.ctx.lineTo(f, l), this.ctx.lineTo(f, e);
                    ...
                    if (e = 1 === n % 2 ? (e.y << 0) + 0.5 : e.y << 0, l = 1 === n % 2 ? (b.y << 0) + 0.5 : b.y << 0, "left" === this.scaleBreaks.parent._position ? (b = this.chart.plotArea.x1, f = this.chart.plotArea.x2 + n / 2 + 0.5 << 0) : (b = this.chart.plotArea.x2, f = this.chart.plotArea.x1 - n / 2 + 0.5 << 0, a *= -1), this.bounds = {
                            x1: b,
                            y1: e - n / 2,
                            x2: f,
                            y2: l + n / 2
                        }, this.ctx.moveTo(b, e), "straight" === this.type || "left" === this.scaleBreaks.parent._position && 0 >= a || "right" === this.scaleBreaks.parent._position && 0 <= a) this.ctx.lineTo(f, e), this.ctx.lineTo(f, l), this.ctx.lineTo(b, l);
                    else if ("wavy" === this.type) {
                    r = b;
                    k = e;
                    h = 0.5;
        ...
        N.prototype.render = function() {
            ...
            if (0 < d) {
                ...
                if ("bottom" === this.parent._position || "top" === this.parent._position) e = h = 1 === this.ctx.lineWidth % 2 ? (a.x << 0) + 0.5 : a.x << 0, f = this.chart.plotArea.y1, l = this.chart.plotArea.y2, this.bounds = {
                    x1: e - d / 2,
                    y1: f,
                    x2: h + d / 2,
                    y2: l
                };
                else if ("left" === this.parent._position || "right" === this.parent._position) f = l = 1 === this.ctx.lineWidth % 2 ? (a.y << 0) + 0.5 : a.y << 0, e = this.chart.plotArea.x1, h = this.chart.plotArea.x2, this.bounds = {
                    x1: e,
                    y1: f - d / 2,
                    x2: h,
                    y2: l + d / 2
        ...
        Z.prototype.render = function(a, d, c) {
            ...
            if (this.snapToDataPoint) {
                ...
                if ("xySwapped" === this.chart.plotInfo.axisPlacement) {
                    var y = null;
                    if ("bottom" === this.parent._position || "top" === this.parent._position) x = this.parent.dataSeries[0].axisX.convertPixelToValue({
                        y: d
                    });
                    else if ("left" === this.parent._position || "right" === this.parent._position) x = this.parent.convertPixelToValue({
                        y: d
                    });
                    for (var s = 0; s < this.parent.dataSeries.length; s++)(y = this.parent.dataSeries[s].getDataPointAtX(x, !0)) && 0 <= y.index && (y.dataSeries = this.parent.dataSeries[s], null !== y.dataPoint.y && y.dataSeries.visible && m.push(y));
                    y = null;
                    ...
                    if ("bottom" === this.parent._position || "top" === this.parent._position) {
                        if ("rangeBar" === v.dataSeries.type || "error" === v.dataSeries.type) {
                            ...
                            }) : l(this.options.label) ? ha(l(c) ? v.dataPoint.y[s] : c, this.valueFormatString, this.chart._cultureInfo) : this.label
                        } else "stackedBar" === v.dataSeries.type ? (x = Math.abs(a - this.parent.convertValueToPixel(m[0].dataPoint.y)), cumulativeY = v.dataSeries.dataPointEOs[v.index].cumulativeY, r = 1 === g.lineWidth % 2 ? (this.parent.convertValueToPixel(cumulativeY) << 0) + 0.5 : this.parent.convertValueToPixel(cumulativeY) << 0, this.value = cumulativeY, k.text = this.labelFormatter ? this.labelFormatter({
                            chart: this.chart,
                            axis: this.parent.options,
                            crosshair: this.options,
                            value: cumulativeY
                        }) : l(this.options.label) ? ha(l(c) ? cumulativeY : c, this.valueFormatString, this.chart._cultureInfo) : this.label) : "stackedBar100" === v.dataSeries.type ? (x = Math.abs(a - this.parent.convertValueToPixel(m[0].dataPoint.y)), cumulativeY = v.dataSeries.dataPointEOs[v.index].cumulativeY, z = v.dataPoint.x.getTime ? v.dataPoint.x.getTime() : v.dataPoint.x, yPercent = 100 * (cumulativeY / v.dataSeries.plotUnit.dataPointYSums[z]), r = 1 === g.lineWidth % 2 ? (this.parent.convertValueToPixel(yPercent) << 0) + 0.5 : this.parent.convertValueToPixel(yPercent) << 0, this.value = yPercent, k.text = this.labelFormatter ? this.labelFormatter({
                            chart: this.chart,
                            axis: this.parent.options,
                            crosshair: this.options,
                            value: yPercent
                        }) : l(this.options.label) ? ha(l(c) ? yPercent : c, this.valueFormatString, this.chart._cultureInfo) : this.label) : (r = 1 === g.lineWidth % 2 ? (this.parent.convertValueToPixel(v.dataPoint.y) << 0) + 0.5 : this.parent.convertValueToPixel(v.dataPoint.y) << 0, this.value = v.dataPoint.y, k.text = this.labelFormatter ? this.labelFormatter({
                            chart: this.chart,
                            axis: this.parent.options,
                            crosshair: this.options,
                            value: v.dataPoint.y
                        }) : l(this.options.label) ? ha(l(c) ? v.dataPoint.y : c, this.valueFormatString, this.chart._cultureInfo) : this.label);
                        b = e = r;
                        ...
                        if (this.parent.labels)
                            ...
                            if ("axisX" === this.parent.type)
                                for (x = this.parent.convertPixelToValue({
                                        y: d
                                    }), y = null, s = 0; s < this.parent.dataSeries.length; s++)(y = this.parent.dataSeries[s].getDataPointAtX(x, !0)) && 0 <= y.index && (k.text = this.labelFormatter ? this.labelFormatter({
                                    chart: this.chart,
                                    axis: this.parent.options,
                                    crosshair: this.options,
                                    value: v.dataPoint.x
                            ...
                            crosshair: this.options,
                            value: v.dataPoint.x
                        }) : l(this.options.label) ? ha(v.dataPoint.x, this.valueFormatString, this.chart._cultureInfo) : this.label : this.labelFormatter ? this.labelFormatter({
                            chart: this.chart,
                            axis: this.parent.options,
                            crosshair: this.options,
                            value: v.dataPoint.x
                    ...
                    x = this.parent.convertPixelToValue({
                        x: a
                    });
                    for (s = 0; s < this.parent.dataSeries.length; s++)(y = this.parent.dataSeries[s].getDataPointAtX(x, !0)) && 0 <= y.index && (y.dataSeries = this.parent.dataSeries[s], null !== y.dataPoint.y && y.dataSeries.visible && m.push(y));
                    if (0 === m.length) return;
                    m.sort(function(a, b) {
                        return a.distance - b.distance
                    });
                    ...
                    !l(this.parent.dataSeries) && 0 < this.parent.dataSeries.length && (x = this.parent.dataSeries[0].axisX.convertPixelToValue({
                        x: a
                    }));
                    for (s = 0; s < this.parent.dataSeries.length; s++)(y = this.parent.dataSeries[s].getDataPointAtX(x, !0)) && 0 <= y.index && (y.dataSeries = this.parent.dataSeries[s], null !== y.dataPoint.y && y.dataSeries.visible && m.push(y));
                    if (0 === m.length) return;
                    ...
                    for (s = 0; s < m.length; s++) {
                        if ("rangeColumn" === m[s].dataSeries.type || "rangeArea" === m[s].dataSeries.type || "error" === m[s].dataSeries.type || "rangeSplineArea" === m[s].dataSeries.type || "candlestick" === m[s].dataSeries.type || "ohlc" === m[s].dataSeries.type || "boxAndWhisker" === m[s].dataSeries.type) {
                            if (m[s].dataPoint.y)
                                for (G = 0; G < m[s].dataPoint.y.length; G++) z = Math.abs(d - this.parent.convertValueToPixel(m[s].dataPoint.y[G])), z <= x && (x = z, y = s)
                        } else "stackedColumn" === m[s].dataSeries.type ? (b = m[s].dataSeries.dataPointEOs[m[s].index].cumulativeY, z = Math.abs(d - this.parent.convertValueToPixel(b)), z <= x && (x = z, y = s)) : "stackedArea" === m[s].dataSeries.type ? (b = m[s].dataSeries.dataPointEOs[m[s].index].cumulativeY, z = Math.abs(d - this.parent.convertValueToPixel(b)), z <= x && (x = z, y = s)) : "stackedColumn100" === m[s].dataSeries.type || "stackedArea100" === m[s].dataSeries.type ? (z = m[0].dataPoint.x.getTime ? m[0].dataPoint.x.getTime() : m[0].dataPoint.x, l(v) && (v = Math.abs(d - this.parent.convertValueToPixel(100 * (m[0].dataSeries.dataPointEOs[m[0].index].cumulativeY / m[0].dataSeries.plotUnit.dataPointYSums[z])))), "stackedColumn100" === m[s].dataSeries.type ? (t = m[s].dataSeries.dataPointEOs[m[s].index].cumulativeY, z = m[s].dataPoint.x.getTime ? m[s].dataPoint.x.getTime() : m[s].dataPoint.x, b = 100 * (t / m[s].dataSeries.plotUnit.dataPointYSums[z]), z = Math.abs(d - this.parent.convertValueToPixel(b)), z <= v && (v = z, y = s)) : "stackedArea100" === m[s].dataSeries.type && (t = m[s].dataSeries.dataPointEOs[m[s].index].cumulativeY, z = m[s].dataPoint.x.getTime ? m[s].dataPoint.x.getTime() : m[s].dataPoint.x, b = 100 * (t / m[s].dataSeries.plotUnit.dataPointYSums[z]), z = Math.abs(d - this.parent.convertValueToPixel(b)), z <= v && (v = z, y = s))) : "waterfall" === m[s].dataSeries.type ? (z = Math.abs(d - this.parent.convertValueToPixel(m[s].dataSeries.dataPointEOs[m[s].index].cumulativeSum)), z <= x && (v = x = z, y = s)) : (z = Math.abs(d - this.parent.convertValueToPixel(m[s].dataPoint.y)), z <= x && (x = z, y = s));
                        l(v) || (x = Math.min(x, v))
                    }
                    v = m[y];
                    s = 0;
                    if ("rangeColumn" === v.dataSeries.type || "rangeArea" === v.dataSeries.type || "error" === v.dataSeries.type || "rangeSplineArea" === v.dataSeries.type || "candlestick" === v.dataSeries.type || "ohlc" === v.dataSeries.type || "boxAndWhisker" === v.dataSeries.type) {
                        ...
                        this.value = v.dataPoint.y[s]
                    } else "stackedColumn" === v.dataSeries.type ? (b = v.dataSeries.dataPointEOs[v.index].cumulativeY, t = 1 === g.lineWidth % 2 ? (this.parent.convertValueToPixel(b) << 0) + 0.5 : this.parent.convertValueToPixel(b) << 0, k.text = this.labelFormatter ? this.labelFormatter({
                        chart: this.chart,
                        axis: this.parent.options,
                        crosshair: this.options,
                        value: b
                    }) : l(this.options.label) ? ha(l(c) ? b : c, this.valueFormatString, this.chart._cultureInfo) : this.label, this.value = b) : "stackedArea" === v.dataSeries.type ? (b = v.dataSeries.dataPointEOs[v.index].cumulativeY, t = 1 === g.lineWidth % 2 ? (this.parent.convertValueToPixel(b) << 0) + 0.5 : this.parent.convertValueToPixel(b) << 0, k.text = this.labelFormatter ? this.labelFormatter({
                        chart: this.chart,
                        axis: this.parent.options,
                        crosshair: this.options,
                        value: b
                    }) : l(this.options.label) ? ha(l(c) ? b : c, this.valueFormatString, this.chart._cultureInfo) : this.label, this.value = b) : "stackedColumn100" === v.dataSeries.type ? (t = v.dataSeries.dataPointEOs[v.index].cumulativeY, z = v.dataPoint.x.getTime ? v.dataPoint.x.getTime() : v.dataPoint.x, b = 100 * (t / v.dataSeries.plotUnit.dataPointYSums[z]), t = 1 === g.lineWidth % 2 ? (this.parent.convertValueToPixel(b) << 0) + 0.5 : this.parent.convertValueToPixel(b) << 0, k.text = this.labelFormatter ? this.labelFormatter({
                        chart: this.chart,
                        axis: this.parent.options,
                        crosshair: this.options,
                        value: b
                    }) : l(this.options.label) ? ha(l(c) ? b : c, this.valueFormatString, this.chart._cultureInfo) : this.label, this.value = b) : "stackedArea100" === v.dataSeries.type ? (t = v.dataSeries.dataPointEOs[v.index].cumulativeY, z = v.dataPoint.x.getTime ? v.dataPoint.x.getTime() : v.dataPoint.x, b = 100 * (t / v.dataSeries.plotUnit.dataPointYSums[z]), t = 1 === g.lineWidth % 2 ? (this.parent.convertValueToPixel(b) << 0) + 0.5 : this.parent.convertValueToPixel(b) << 0, k.text = this.labelFormatter ? this.labelFormatter({
                        chart: this.chart,
                        axis: this.parent.options,
                        crosshair: this.options,
                        value: b
                    }) : l(this.options.label) ? ha(l(c) ? b : c, this.valueFormatString, this.chart._cultureInfo) : this.label, this.value = b) : "waterfall" === v.dataSeries.type ? (t = 1 === g.lineWidth % 2 ? (this.parent.convertValueToPixel(v.dataSeries.dataPointEOs[v.index].cumulativeSum) << 0) + 0.5 : this.parent.convertValueToPixel(v.dataSeries.dataPointEOs[v.index].cumulativeSum) << 0, k.text = this.labelFormatter ? this.labelFormatter({
                        chart: this.chart,
                        axis: this.parent.options,
                        crosshair: this.options,
                        value: v.dataSeries.dataPointEOs[v.index].cumulativeSum
                    }) : l(this.options.label) ? ha(l(c) ? v.dataSeries.dataPointEOs[v.index].cumulativeSum : c, this.valueFormatString, this.chart._cultureInfo) : this.label, this.value = v.dataSeries.dataPointEOs[v.index].cumulativeSum) : (t = 1 === g.lineWidth % 2 ? (l(a) ? d : this.parent.convertValueToPixel(v.dataPoint.y) << 0) + 0.5 : l(a) ? d : this.parent.convertValueToPixel(v.dataPoint.y) << 0, k.text = this.labelFormatter ? this.labelFormatter({
                        chart: this.chart,
                        axis: this.parent.options,
                        crosshair: this.options,
                        value: l(c) ? v.dataPoint.y : c
                    }) : l(this.options.label) ? ha(l(c) ? v.dataPoint.y : c, this.valueFormatString, this.chart._cultureInfo) : this.label, this.value = v.dataPoint.y);
                    h = f = t;
                    b = this.chart.plotArea.x1;
                    e = this.chart.plotArea.x2;
                    this.bounds = {
                ...
                m = null;
                g.globalAlpha = n;
                if ("bottom" === this.parent._position || "top" === this.parent._position) "top" === this.parent._position && k.y - k.fontSize / 2 < this.chart.bounds.y1 && (k.y = this.chart.bounds.y1 + k.fontSize / 2), "bottom" === this.parent._position && this.parent.lineCoordinates.y2 - k.fontSize / 2 + k.measureText().height > this.chart.bounds.y2 && (k.y = this.chart.bounds.y2 - k.height + k.fontSize / 2 + 2), this.value >= Math.min(this.parent.viewportMinimum, this.parent.viewportMaximum) && this.value <= Math.max(this.parent.viewportMinimum, this.parent.viewportMaximum) && 0 < p && (g.moveTo(b, h), g.lineTo(e, f), g.stroke(), this._hidden = !1);
                if ("left" === this.parent._position || "right" === this.parent._position) "left" === this.parent._position && k.x < this.chart.bounds.x1 && (k.x = this.chart.bounds.x1), "right" === this.parent._position && k.x + k.measureText().width > this.chart.bounds.x2 && (k.x = this.chart.bounds.x2 - k.measureText().width), this.value >= Math.min(this.parent.viewportMinimum, this.parent.viewportMaximum) && this.value <= Math.max(this.parent.viewportMinimum, this.parent.viewportMaximum) && 0 < p && (g.moveTo(b, h), g.lineTo(e, f), g.stroke(), this._hidden = !1)
            } else {
                if ("bottom" === this.parent._position || "top" === this.parent._position) b = e = r = 1 === g.lineWidth % 2 ? (a << 0) + 0.5 : a << 0, h = this.chart.plotArea.y1, f = this.chart.plotArea.y2, this.bounds = {
                    x1: b - p / 2,
                    y1: h,
                    x2: e + p / 2,
                    y2: f
                };
                else if ("left" === this.parent._position || "right" === this.parent._position) h = f = t = 1 === g.lineWidth % 2 ? (d << 0) + 0.5 : d << 0, b = this.chart.plotArea.x1, e = this.chart.plotArea.x2, this.bounds = {
                    x1: b,
                    y1: h - p / 2,
                    x2: e,
                    y2: f + p / 2
        ...
        $.prototype.mouseMoveHandler = function(a, d) {
            this._lastUpdated && 4 > (new Date).getTime() - this._lastUpdated || (this._lastUpdated = (new Date).getTime(), this.chart.resetOverlayedCanvas(), this._updateToolTip(a, d), this.enabled && this._updatedEventParameters && !isNaN(this._prevX) && !isNaN(this._prevY) && this.container && this.container.style && this.dispatchEvent("none" === this.container.style.display ? "hidden" : "updated", this._updatedEventParameters, this))
        };
                ...
                if (this.shared && this.enabled && "none" !== this.chart.plotInfo.axisPlacement) {
                    ...
                    if (this.chart.axisX)
                        for (var w = 0; w < this.chart.axisX.length; w++) {
                            for (var f = "xySwapped" === this.chart.plotInfo.axisPlacement ? this.chart.axisX[w].convertPixelToValue({
                                    y: d
                                }) : this.chart.axisX[w].convertPixelToValue({
                                    x: a
                                }), k = null, b = 0; b < this.chart.axisX[w].dataSeries.length; b++)(k = this.chart.axisX[w].dataSeries[b].getDataPointAtX(f, c)) && 0 <= k.index && (k.dataSeries = this.chart.axisX[w].dataSeries[b], null !== k.dataPoint.y && k.dataSeries.visible && t.push(k));
                            k = null
                        }
                    if (this.chart.axisX2)
                        for (w = 0; w < this.chart.axisX2.length; w++) {
                            f = "xySwapped" === this.chart.plotInfo.axisPlacement ? this.chart.axisX2[w].convertPixelToValue({
                                y: d
                            }) : this.chart.axisX2[w].convertPixelToValue({
                                x: a
                            });
                            k = null;
                            for (b = 0; b < this.chart.axisX2[w].dataSeries.length; b++)(k = this.chart.axisX2[w].dataSeries[b].getDataPointAtX(f, c)) && 0 <= k.index && (k.dataSeries = this.chart.axisX2[w].dataSeries[b], null !== k.dataPoint.y && k.dataSeries.visible && t.push(k));
                            k = null
                        }
                    ...
                    if (0 <= this.currentSeriesIndex) {
                        ...
                        k = {};
                        if (0 <= this.currentDataPointIndex) b = e.dataPoints[this.currentDataPointIndex], k.dataSeries = e, k.dataPoint = b, k.index = this.currentDataPointIndex, k.distance = Math.abs(b.x - f), "waterfall" === e.type && (k.cumulativeSumYStartValue = e.dataPointEOs[this.currentDataPointIndex].cumulativeSumYStartValue, k.cumulativeSum = e.dataPointEOs[this.currentDataPointIndex].cumulativeSum);
                        else if (this.enabled && e && ("line" === e.type || "stepLine" === e.type || "spline" === e.type || "area" === e.type || "stepArea" === e.type || "splineArea" === e.type || "stackedArea" === e.type || "stackedArea100" === e.type || "rangeArea" === e.type || "rangeSplineArea" === e.type || "candlestick" === e.type || "ohlc" === e.type || "boxAndWhisker" === e.type)) f = e.axisX.convertPixelToValue({
                            x: a
                        }), k = e.getDataPointAtX(f, c), l(k) || (k.dataSeries = e, this.currentDataPointIndex = k.index, b = k.dataPoint);
                        else {
                        ...
                        if (!l(k) && !l(k.dataPoint) && !l(k.dataPoint.y))
                            if (k.dataSeries.axisY)
                                ...
                                } else "column" === e.type || "bar" === e.type ? 0 > k.dataPoint.y ? 0 > k.dataSeries.axisY.viewportMinimum && k.dataSeries.axisY.viewportMaximum >= k.dataPoint.y && h.push(k) : k.dataSeries.axisY.viewportMinimum <= k.dataPoint.y && 0 <= k.dataSeries.axisY.viewportMaximum && h.push(k) : "bubble" === e.type ? (c = this.chart._eventManager.objectMap[e.dataPointIds[k.index]].size / 2, k.dataPoint.y >= k.dataSeries.axisY.viewportMinimum - c && k.dataPoint.y <= k.dataSeries.axisY.viewportMaximum + c && h.push(k)) : "waterfall" === e.type ? (c = 0, k.cumulativeSumYStartValue < k.dataSeries.axisY.viewportMinimum ? c-- : k.cumulativeSumYStartValue > k.dataSeries.axisY.viewportMaximum && c++, k.cumulativeSum < k.dataSeries.axisY.viewportMinimum ? c-- : k.cumulativeSum > k.dataSeries.axisY.viewportMaximum && c++, 2 > c && -2 < c && h.push(k)) : (0 <= k.dataSeries.type.indexOf("100") || "stackedColumn" === e.type || "stackedBar" === e.type || "stackedArea" === e.type || k.dataPoint.y >= k.dataSeries.axisY.viewportMinimum && k.dataPoint.y <= k.dataSeries.axisY.viewportMaximum) && h.push(k);
                        else h.push(k)
                    }
                }
                if (0 < h.length) {
            ...
            for (c = 0; c < a.length; c++) {
                ...
                if ((e = this.chart._eventManager.objectMap[e.dataSeries.dataPointIds[e.index]]) && e.objectType && "dataPoint" === e.objectType) {
                    var b = this.chart.data[e.dataSeriesIndex],
                        ...
                        f = e.dataPointIndex;
                    !1 === h.highlightEnabled || !0 !== b.highlightEnabled && !0 !== h.highlightEnabled || ("line" === b.type || "stepLine" === b.type || "spline" === b.type || "scatter" === b.type || "area" === b.type || "stepArea" === b.type || "splineArea" === b.type || "stackedArea" === b.type || "stackedArea100" === b.type || "rangeArea" === b.type || "rangeSplineArea" === b.type ? (h = b.getMarkerProperties(f, e.x1, e.y1, this.chart.overlaidCanvasCtx), h.size = Math.max(1.5 * h.size << 0, 10), h.borderColor = h.borderColor || "#FFFFFF", h.borderThickness = h.borderThickness || Math.ceil(0.1 * h.size), aa.drawMarkers([h]), "undefined" !== typeof e.y2 && (h = b.getMarkerProperties(f, e.x1, e.y2, this.chart.overlaidCanvasCtx), h.size = Math.max(1.5 * h.size << 0, 10), h.borderColor = h.borderColor || "#FFFFFF", h.borderThickness = h.borderThickness || Math.ceil(0.1 * h.size), aa.drawMarkers([h]))) : "bubble" === b.type ? (h = b.getMarkerProperties(f, e.x1, e.y1, this.chart.overlaidCanvasCtx), h.size = e.size, h.color = "white", h.borderColor = "white", d.globalAlpha = 0.3, aa.drawMarkers([h]), d.globalAlpha = 1) : "column" === b.type || "stackedColumn" === b.type || "stackedColumn100" === b.type || "bar" === b.type || "rangeBar" === b.type || "stackedBar" === b.type || "stackedBar100" === b.type || "rangeColumn" === b.type || "waterfall" === b.type ? da(d, e.x1, e.y1, e.x2, e.y2, "white", 0, null, !1, !1, !1, !1, 0.3) : "pie" === b.type || "doughnut" === b.type ? X(d, e.center, e.radius, "white", b.type, e.startAngle, e.endAngle, 0.3, e.percentInnerRadius) : "funnel" === b.type || "pyramid" === b.type ? pa(d, e.funnelSection, 0.3, "white") : "candlestick" === b.type ? (d.globalAlpha = 1, d.strokeStyle = e.color, d.lineWidth = 2 * e.borderThickness, b = 0 === d.lineWidth % 2 ? 0 : 0.5, d.beginPath(), d.moveTo(e.x3 - b, Math.min(e.y2, e.y3)), d.lineTo(e.x3 - b, Math.min(e.y1, e.y4)), d.stroke(), d.beginPath(), d.moveTo(e.x3 - b, Math.max(e.y1, e.y4)), d.lineTo(e.x3 - b, Math.max(e.y2, e.y3)), d.stroke(), da(d, e.x1, Math.min(e.y1, e.y4), e.x2, Math.max(e.y1, e.y4), "transparent", 2 * e.borderThickness, e.color, !1, !1, !1, !1), d.globalAlpha = 1) : "ohlc" === b.type ? (d.globalAlpha = 1, d.strokeStyle = e.color, d.lineWidth = 2 * e.borderThickness, b = 0 === d.lineWidth % 2 ? 0 : 0.5, d.beginPath(), d.moveTo(e.x3 - b, e.y2), d.lineTo(e.x3 - b, e.y3), d.stroke(), d.beginPath(), d.moveTo(e.x3, e.y1), d.lineTo(e.x1, e.y1), d.stroke(), d.beginPath(), d.moveTo(e.x3, e.y4), d.lineTo(e.x2, e.y4), d.stroke(), d.globalAlpha = 1) : "boxAndWhisker" === b.type ? (d.save(), d.globalAlpha = 1, d.strokeStyle = e.stemColor, d.lineWidth = 2 * e.stemThickness, 0 < e.stemThickness && (d.beginPath(), d.moveTo(e.x3, e.y2 + e.borderThickness / 2), d.lineTo(e.x3, e.y1 + e.whiskerThickness / 2), d.stroke(), d.beginPath(), d.moveTo(e.x3, e.y4 - e.whiskerThickness / 2), d.lineTo(e.x3, e.y3 - e.borderThickness / 2), d.stroke()), d.beginPath(), da(d, e.x1, Math.max(e.y2, e.y3), e.x2, Math.min(e.y2, e.y3), "transparent", 2 * e.borderThickness, e.color, !1, !1, !1, !1), d.globalAlpha = 1, d.strokeStyle = e.whiskerColor, d.lineWidth = 2 * e.whiskerThickness, 0 < e.whiskerThickness && (d.beginPath(), d.moveTo(Math.floor(e.x3 - e.whiskerLength / 2), e.y4), d.lineTo(Math.ceil(e.x3 + e.whiskerLength / 2), e.y4), d.stroke(), d.beginPath(), d.moveTo(Math.floor(e.x3 - e.whiskerLength / 2), e.y1), d.lineTo(Math.ceil(e.x3 + e.whiskerLength / 2), e.y1), d.stroke()), d.globalAlpha = 1, d.strokeStyle = e.lineColor, d.lineWidth = 2 * e.lineThickness, 0 < e.lineThickness && (d.beginPath(), d.moveTo(e.x1, e.y5), d.lineTo(e.x2, e.y5), d.stroke()), d.restore(), d.globalAlpha = 1) : "error" === b.type && z(d, e.x1, e.y1, e.x2, e.y2, "white", e.whiskerProperties, e.stemProperties, e.isXYSwapped, 0.3))
                }
            }
            d.restore();
            d.globalAlpha = 1;
        ...
        $.prototype.showAtX = function(a, d) {
            ...
            if (this.shared)
                for (var q = 0; q < this.chart.data.length; q++) c = this.chart.data[q], (b = c.getDataPointAtX(a, !1)) && (b.dataPoint && !l(b.dataPoint.y) && c.visible) && (b.dataSeries = c, this.chart.data[d].axisX.convertValueToPixel(a) === c.axisX.convertValueToPixel(b.dataPoint.x) && f.push(b));
        ...
        ga.prototype.fireEvent = function(a, d, c) {
            if (a && d) {
                ...
                "mouseout" !== d ? f.cursor && f.cursor !== c.target.style.cursor && (c.target.style.cursor = f.cursor) : (c.target.style.cursor = this.chart.panEnabled ? "itemmouseout" !== e.mouseout || f.dockInsidePlotArea ? "move" : this.chart._defaultCursor : this.chart._defaultCursor, delete a.eventParameter, delete a.eventContext);
    ...
    w.version = "v3.10.16 GA";
    window.CanvasJS && (w && !window.CanvasJS.Chart) && (window.CanvasJS.Chart = w)
})(); /*  excanvas is used to support IE678 which do not implement HTML5 Canvas Element. You can safely remove the following excanvas code if you don't need to support older browsers.  Copyright 2006 Google Inc. https://code.google.com/p/explorercanvas/  Licensed under the Apache License, Version 2.0*/
document.createElement("canvas").getContext || function() {
    ...
    function T(a, b, c, g) {
        ...
        } else e instanceofI ? k && n && b.push("<g_vml_:fill", ' position="', -c.x / k * f * f, ",", -c.y / n * d * d, '"', ' type="tile"', ' src="', e.src_, '" />') : (e = G(a.fillStyle), b.push('<g_vml_:fill color="', e.color, '" opacity="', e.alpha * a.globalAlpha, '" />'))
    }
